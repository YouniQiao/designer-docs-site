...
[configuration](arkts-localization-configuration-c.md). For details about the matching rules, see
...
| [Resource](arkts-localization-resource-t.md) | Resource information, including the resource ID, application package name, and module name. Generally, you canuse $r to obtain the resource information. |
