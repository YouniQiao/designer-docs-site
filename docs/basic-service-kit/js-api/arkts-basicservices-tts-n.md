...
| [ENABLED_TTS_PLUGINS](arkts-basicservices-tts-con.md#enabled_tts_plugins) | Indicates the list of activated plug-in packages used for TTS. Multiple plug-in packages are separated byspaces. |
