...
| [AUTO_SCREEN_BRIGHTNESS](arkts-basicservices-display-con.md#auto_screen_brightness) | Specifies whether automatic screen brightness adjustment is enabled.&lt;p&gt;If the value is {@code 1}, automatic adjustment is enabled. If the value is {@code 0}, automaticadjustment is disabled. |
...
| [SCREEN_OFF_TIMEOUT](arkts-basicservices-display-con.md#screen_off_timeout) | Indicates the duration that the device waits before going to sleep after a period of inactivity, inmilliseconds. |
| [DEFAULT_SCREEN_ROTATION](arkts-basicservices-display-con.md#default_screen_rotation) | Indicates the screen rotation when no other policy is available.&lt;p&gt;This constant is invalid when auto-rotation is enabled. When auto-rotation is disabled, the followingvalues are available:&lt;ul&gt;&lt;li&gt;{@code 0} - The screen rotates 0 degrees.&lt;li&gt;{@code 1} - The screen rotates 90 degrees.&lt;li&gt;{@code 2} - The screen rotates 180 degrees.&lt;li&gt;{@code 3} - The screen rotates 270 degrees.&lt;/ul&gt; |
...
| [DISPLAY_INVERSION_STATUS](arkts-basicservices-display-con.md#display_inversion_status) | Specifies whether display color inversion is enabled.&lt;p&gt;If the value is {@code 1}, display color inversion is enabled. If the value is {@code 0}, display colorinversion is disabled. |
