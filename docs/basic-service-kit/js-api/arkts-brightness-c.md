...
| --- | --- | --- | --- |
| options | GetBrightnessModeOptions | No | 获取屏幕亮度模式的参数对象。可选，默认为空。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | GetBrightnessOptions | No | 获取屏幕亮度的参数对象。可选，默认为空。 |
...
设置屏幕是否保持常亮状态，开启常亮模式推荐在onShow()阶段调用。 注意： - 除Lite Wearable外，从API version 7开始不再维护，建议使用[window.setWindowKeepScreenOn()](docroot://reference/apis-arkui/arkts-apis-window-Window.md#setwindowkeepscreenon9)替代。 - 在Lite Wearable上，该接口仅能阻止系统无活动超时灭屏（自动），无法阻止用户主动操作（如盖屏）、常亮时刻结束等导致的灭屏。

**Since:** 3

**Deprecated since:** 7

**Substitute:** @ohos.window:Window.setWindowKeepScreenOn
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | SetKeepScreenOnOptions | No | 设置屏幕常亮的参数对象。可选，默认为空。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | SetBrightnessModeOptions | No | 设置屏幕亮度模式的参数对象。可选，默认为空。 |
...
**Substitute:** @ohos.brightness:brightness.setValue
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | SetBrightnessOptions | No | 设置屏幕亮度的参数对象。可选，默认为空。 |
