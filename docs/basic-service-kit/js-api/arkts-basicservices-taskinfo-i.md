...
Note: When
[request.agent.search](arkts-basicservices-search-f.md#search-2)
...
- Use [request.agent.show](arkts-basicservices-show-f.md#show-2)
and [request.agent.touch](arkts-basicservices-touch-f.md#touch-2)
to query the value.
