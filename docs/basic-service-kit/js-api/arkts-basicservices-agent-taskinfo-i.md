...
- Use [request.agent.show](arkts-basicservices-agent-show-f.md#show-1)and [request.agent.touch](arkts-basicservices-agent-touch-f.md#touch-1)to query the value.
