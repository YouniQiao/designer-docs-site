...
| --- | --- | --- | --- |
| progress | ProgressInfo | Yes | Defines the progress information. This information is reported only when  [ProgressIndicator]pasteboard.ProgressIndicator is set to NONE. |
