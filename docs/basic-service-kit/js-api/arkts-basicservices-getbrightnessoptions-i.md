...
Called when an API call is successful. **data** is a return value of the [BrightnessResponse](arkts-basicservices-brightnessresponse-i.md#brightnessresponse) type.
