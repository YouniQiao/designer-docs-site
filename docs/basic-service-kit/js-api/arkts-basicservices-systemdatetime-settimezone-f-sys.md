...
| --- | --- | --- | --- |
| timezone | string | Yes | System time zone to set. For details, see [Supported System Time Zones](docroot://reference/apis-basic-services-kit/js-apis-system-date-time-sys.md#supported-system-time-zones). |
