...
**Substitute:** pasteboard.PasteData.addRecord(mimeType:
...
**Substitute:** pasteboard.PasteData.getRecord(index:
...
**Substitute:** pasteboard.PasteData.hasType(mimeType:
...
**Substitute:** pasteboard.PasteData.removeRecord(index:
...
**Substitute:** pasteboard.PasteData.replaceRecord(index:
