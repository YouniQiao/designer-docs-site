...
| callback | AsyncCallback&lt;void> | Yes | 指示绑定结果回调。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | GetDomainAccessTokenOptions | Yes | 指示获取域访问令牌的选项。 |
| callback | AsyncCallback&lt;Uint8Array> | Yes | 指示结果回调。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | GetDomainAccountInfoPluginOptions | Yes | 指示域账号信息。 |
...
| --- | --- | --- | --- |
| domainAccountInfo | DomainAccountInfo | Yes | 指示域账号信息。 |
| callback | AsyncCallback&lt;AuthStatusInfo> | Yes | 指示查询结果回调。 |
...
| callback | AsyncCallback&lt;boolean> | Yes | 指示检查结果回调。true表示指定的域账号令牌是有效的；false表示指定的域账号令牌是无效的。 |
