...
screen is off. For details about the running lock types, see [RunningLockType](arkts-basicservices-runninglocktype-e.md).
...
| [isRunningLockTypeSupported](arkts-basicservices-isrunninglocktypesupported-f.md#isrunninglocktypesupported-1) | Checks whether a specified type of {@link RunningLock} is supported. This API uses an asynchronous callback toreturn the result. |
| [isRunningLockTypeSupported](arkts-basicservices-isrunninglocktypesupported-f.md#isrunninglocktypesupported-2) | Checks whether a specified type of {@link RunningLock} is supported. This API uses a promise to return theresult. |
