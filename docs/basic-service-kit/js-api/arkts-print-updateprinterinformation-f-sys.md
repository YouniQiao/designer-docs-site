...
更新系统中打印机的部分信息，使用Promise异步回调。当前仅允许更新[PrinterInformation]print.PrinterInformation的alias和options字段。

**Since:** 18

**Required permissions:** 

- API version18  to  23: ohos.permission.MANAGE_PRINT_JOB
...
| --- | --- | --- | --- |
| printerInformation | PrinterInformation | Yes | 表示待更新信息的打印机。 |
...
| 202 | not system application [since 18 - 23] |
