...
| --- | --- | --- | --- |
| accessoryHandle | USBAccessoryHandle | Yes | USB accessory handle, which is obtained through[openAccessory](arkts-basicservices-openaccessory-f.md#openaccessory-1). |
