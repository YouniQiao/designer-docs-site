...
| --- | --- | --- | --- |
| device | USBDevice | Yes | USB device. The **busNum** and **devAddress** parameters obtained by[usbManager.getDevices](arkts-basicservices-getdevices-f.md#getdevices-1) are used to determine a USB device. Other parameters are passed transparently. |
