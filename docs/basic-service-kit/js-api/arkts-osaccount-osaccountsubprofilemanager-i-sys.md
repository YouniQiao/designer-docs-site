...
| --- | --- | --- | --- |
| osAccountLocalId | int | Yes | 目标系统账号的本地标识符。  取值范围为全体整数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| osAccountLocalId | int | Yes | 目标系统账号的本地标识符。  取值范围为全体整数。  The value range is all integers. |
| subProfileId | int | Yes | 子身份资料的标识符。  取值范围为全体整数。  The value range is all integers. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| osAccountLocalId | int | Yes | 系统账号的本地标识符。  取值范围为全体整数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| subProfileId | int | Yes | 子身份资料的标识符  取值范围为全体整数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| subProfileId | int | Yes | 子身份资料的标识符  取值范围为全体整数。  The value should be an integer. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| osAccountLocalId | int | Yes | 系统账号的本地标识符。  取值范围为全体整数。  The value should be an integer. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;OsAccountSubProfileEventData> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| events | OsAccountSubProfileEvent[] | Yes | 要订阅的事件数组 |
| callback | Callback&lt;OsAccountSubProfileEventData> | Yes | 事件发生时调用的回调。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| osAccountLocalId | int | Yes | 系统账号的本地标识符。  取值范围为全体整数。  The value range is all integers. |
| subProfileId | int | Yes | 子身份资料的标识符。  取值范围为全体整数。  The value range is all integers. |
