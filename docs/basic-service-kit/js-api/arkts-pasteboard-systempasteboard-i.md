...
**Substitute:** pasteboard.SystemPasteboard.clearData(callback:
...
**Substitute:** pasteboard.SystemPasteboard.clearData()
...
- API version12 and later: ohos.permission.READ_PASTEBOARD
...
**Substitute:** pasteboard.SystemPasteboard.getData(callback:
...
**Substitute:** pasteboard.SystemPasteboard.getData()
...
**Substitute:** pasteboard.SystemPasteboard.hasData(callback:
...
**Substitute:** pasteboard.SystemPasteboard.hasData()
...
- API version14 and later: ohos.permission.MANAGE_PASTEBOARD_APP_SHARE_OPTION
...
**Substitute:** pasteboard.SystemPasteboard.setData(data:
