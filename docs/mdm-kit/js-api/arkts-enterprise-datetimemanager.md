...
| [isModifyDateTimeDisallowed](arkts-mdm-ismodifydatetimedisallowed-f-sys.md#ismodifydatetimedisallowed-1) | Queries whether the system time of a device can be modified. This API uses an asynchronous callback to return theresult. |
