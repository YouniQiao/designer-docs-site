...
| appIds | Array&lt;string&gt; | Yes | IDs of the applications to add.<br>**Note**: From API version 21 onwards, the[appId](../../../../quick-start/common-problem-of-application.md#what-is-appid) and[appIdentifier](../../../../quick-start/common-problem-of-application.md#what-is-appidentifier) of the app can bepassed. **appIdentifier** is recommended. In API version 20 and earlier versions, only **appId** can be passed. |
...
| [9200010](../errorcode-enterpriseDeviceManager.md#9200010-policy-conflict) | A conflict policy has been configured.<br>**Applicable version:** 21 |
