...
- [@ohos.enterprise.accountManager](arkts-enterprise-accountmanager.md)
  ...
  - [disallowAddLocalAccount(system api)](arkts-mdm-accountmanager-disallowaddlocalaccount-f-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.enterprise.adminManager](arkts-enterprise-adminmanager.md)<!--Del-->
  ...
  - [disableSuperAdmin(system api)](arkts-mdm-adminmanager-disablesuperadmin-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [getEnterpriseInfo(system api)](arkts-mdm-adminmanager-getenterpriseinfo-f-sys.md)<!--DelEnd--><!--Del-->
  - [getEnterpriseManagedTips(system api)](arkts-mdm-adminmanager-getenterprisemanagedtips-f-sys.md)<!--DelEnd--><!--Del-->
  - [getSuperAdmin(system api)](arkts-mdm-adminmanager-getsuperadmin-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [isSuperAdmin(system api)](arkts-mdm-adminmanager-issuperadmin-f-sys.md)<!--DelEnd--><!--Del-->
  - [replaceSuperAdmin(system api)](arkts-mdm-adminmanager-replacesuperadmin-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [setDelegatedPolicies(system api)](arkts-mdm-adminmanager-setdelegatedpolicies-f-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.enterprise.dateTimeManager](arkts-enterprise-datetimemanager.md)<!--Del-->
  - [disallowModifyDateTime(system api)](arkts-mdm-datetimemanager-disallowmodifydatetime-f-sys.md)<!--DelEnd--><!--Del-->
  - [isModifyDateTimeDisallowed(system api)](arkts-mdm-datetimemanager-ismodifydatetimedisallowed-f-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.enterprise.deviceControl](arkts-enterprise-devicecontrol.md)<!--Del-->
  ...
  - [reboot(system api)](arkts-mdm-devicecontrol-reboot-f-sys.md)<!--DelEnd--><!--Del-->
  - [resetFactory(system api)](arkts-mdm-devicecontrol-resetfactory-f-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.enterprise.deviceInfo](arkts-enterprise-deviceinfo.md)
  ...
  - [getDeviceName(system api)](arkts-mdm-deviceinfo-getdevicename-f-sys.md)<!--DelEnd--><!--Del-->
  - [getDeviceSerial(system api)](arkts-mdm-deviceinfo-getdeviceserial-f-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.enterprise.deviceSettings](arkts-enterprise-devicesettings.md)
  ...
  - [getPowerPolicy(system api)](arkts-mdm-devicesettings-getpowerpolicy-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [setPowerPolicy(system api)](arkts-mdm-devicesettings-setpowerpolicy-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [uninstallUserCertificate(system api)](arkts-mdm-devicesettings-uninstallusercertificate-f-sys.md)<!--DelEnd--><!--Del-->
  - [CertBlob(system api)](arkts-mdm-devicesettings-certblob-i-sys.md)<!--DelEnd--><!--Del-->
  - [PowerPolicy(system api)](arkts-mdm-devicesettings-powerpolicy-i-sys.md)<!--DelEnd--><!--Del-->
  - [PowerPolicyAction(system api)](arkts-mdm-devicesettings-powerpolicyaction-e-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.enterprise.restrictions](arkts-enterprise-restrictions.md)
  ...
  - [isFingerprintAuthDisabled(system api)](arkts-mdm-restrictions-isfingerprintauthdisabled-f-sys.md)<!--DelEnd--><!--Del-->
  - [isHdcDisabled(system api)](arkts-mdm-restrictions-ishdcdisabled-f-sys.md)<!--DelEnd--><!--Del-->
  - [isMicrophoneDisabled(system api)](arkts-mdm-restrictions-ismicrophonedisabled-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [setFingerprintAuthDisabled(system api)](arkts-mdm-restrictions-setfingerprintauthdisabled-f-sys.md)<!--DelEnd--><!--Del-->
  - [setHdcDisabled(system api)](arkts-mdm-restrictions-sethdcdisabled-f-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.enterprise.systemManager](arkts-enterprise-systemmanager.md)
  ...
  - [ErrorInfo(system api)](arkts-mdm-systemmanager-errorinfo-i.md)<!--DelEnd--><!--Del-->
  - [KeyEvent(system api)](arkts-mdm-systemmanager-keyevent-i.md)<!--DelEnd--><!--Del-->
  - [KeyEventPolicy(system api)](arkts-mdm-systemmanager-keyeventpolicy-i.md)<!--DelEnd--><!--Del-->
  - [KeyItem(system api)](arkts-mdm-systemmanager-keyitem-i.md)<!--DelEnd--><!--Del-->
  - [NotifyDescription(system api)](arkts-mdm-systemmanager-notifydescription-i.md)<!--DelEnd--><!--Del-->
  - [OtaUpdatePolicy(system api)](arkts-mdm-systemmanager-otaupdatepolicy-i.md)<!--DelEnd--><!--Del-->
  - [Package(system api)](arkts-mdm-systemmanager-package-i.md)<!--DelEnd--><!--Del-->
  - [PackageDescription(system api)](arkts-mdm-systemmanager-packagedescription-i.md)<!--DelEnd--><!--Del-->
  - [SystemUpdateInfo(system api)](arkts-mdm-systemmanager-systemupdateinfo-i.md)<!--DelEnd--><!--Del-->
  - [UpdatePackageInfo(system api)](arkts-mdm-systemmanager-updatepackageinfo-i.md)<!--DelEnd--><!--Del-->
  - [UpdateResult(system api)](arkts-mdm-systemmanager-updateresult-i.md)<!--DelEnd--><!--Del-->
  - [KeyAction(system api)](arkts-mdm-systemmanager-keyaction-e.md)<!--DelEnd--><!--Del-->
  - [KeyCode(system api)](arkts-mdm-systemmanager-keycode-e.md)<!--DelEnd--><!--Del-->
  - [KeyPolicy(system api)](arkts-mdm-systemmanager-keypolicy-e.md)<!--DelEnd--><!--Del-->
  - [NearLinkProtocol(system api)](arkts-mdm-systemmanager-nearlinkprotocol-e.md)<!--DelEnd--><!--Del-->
  - [PackageType(system api)](arkts-mdm-systemmanager-packagetype-e.md)<!--DelEnd--><!--Del-->
  - [PolicyType(system api)](arkts-mdm-systemmanager-policytype-e.md)<!--DelEnd--><!--Del-->
  - [UpdateStatus(system api)](arkts-mdm-systemmanager-updatestatus-e.md)<!--DelEnd-->
...
- [@ohos.enterprise.wifiManager](arkts-enterprise-wifimanager.md)
  ...
  - [setWifiDisabled(system api)](arkts-mdm-wifimanager-setwifidisabled-f-sys.md)<!--DelEnd--><!--Del-->
