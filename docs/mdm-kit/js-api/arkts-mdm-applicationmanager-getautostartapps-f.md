...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<Want> | List of the auto-start applications obtained. Since API version 24, the setting of whether the UI is hidden can be returned. |
