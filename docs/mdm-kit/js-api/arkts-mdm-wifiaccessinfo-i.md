...
This property is optional when the [addDisallowedWifiList](arkts-mdm-adddisallowedwifilist-f.md#adddisallowedwifilist-1) and
[removeDisallowedWifiList](arkts-mdm-removedisallowedwifilist-f.md#removedisallowedwifilist-1) APIs are called. The default value is an
empty string.

This property is optional (available since API version 21) when the
[addAllowedWifiList](arkts-mdm-addallowedwifilist-f.md#addallowedwifilist-1) and
[removeAllowedWifiList](arkts-mdm-removeallowedwifilist-f.md#removeallowedwifilist-1) APIs are called. The default value is an empty
