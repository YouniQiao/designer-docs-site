...
| usbDeviceIds | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<UsbDeviceId> | Yes | USB device IDs, which can be obtained through [getDevices](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-usbmanager-getdevices-f.md#getdevices-1). |
