...
| [onPublishFormCrossBundleControl](arkts-form-onpublishformcrossbundlecontrol-f-sys.md#onpublishformcrossbundlecontrol-1) | Subscribes to controls on cross-bundle widget addition to the home screen. This API uses an asynchronous callbackto return the result. |
