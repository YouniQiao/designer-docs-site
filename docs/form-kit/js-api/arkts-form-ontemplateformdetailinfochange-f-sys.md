...
| --- | --- | --- | --- |
| callback | formInfo.TemplateFormDetailInfoCallback | Yes | Callback function used to listen for changes inthe static configuration information of template widgets. |
