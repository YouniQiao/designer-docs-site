...
| callback | Callback&lt;formInfo.OverflowRequest> | Yes | Callback used by the widget host to process the animation  request. |
...
| callback | Callback&lt;formInfo.ChangeSceneAnimationStateRequest> | Yes | Callback function, which is used by the  widget host to process the state switching request. |
