...
| observerCallback | Callback&lt;formInfo.RunningFormInfo> | Yes | The callback is used to return the running  form info. |
...
| observerCallback | Callback&lt;Array&lt;formInfo.RunningFormInfo>> | Yes | The callback is used to return  the running form info. |
