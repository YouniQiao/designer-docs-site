...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| conditions | string | Yes | Condition used to filter the data obtained using  [groupBy]relationalStore.RdbPredicates.groupBy. This parameter cannot be empty and must be used with  [groupBy]relationalStore.RdbPredicates.groupBy. |
