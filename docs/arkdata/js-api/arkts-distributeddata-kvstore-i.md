...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#commit
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#delete
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| key | string | Yes | Key of the KV pair to delete. It cannot be empty, and the length cannot exceed  [MAX_KEY_LENGTH]distributedData.Constants. |
| callback | AsyncCallback&lt;void> | Yes | Callback used to return the result. |
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#deleteBatch
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#enableSync
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#off
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#on
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#put
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| key | string | Yes | Key of the KV pair to add. It cannot be empty, and the length cannot exceed  [MAX_KEY_LENGTH]distributedData.Constants. |
| value | Uint8Array \| string \| number \| boolean | Yes | Value of the KV pair to add. The value type can be Uint8Array,  number, string, or boolean. A value of the Uint8Array or string type cannot exceed  [MAX_VALUE_LENGTH]distributedData.Constants. |
| callback | AsyncCallback&lt;void> | Yes | Callback used to return the result. |
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#putBatch
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#rollback
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#setSyncRange
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#startTransaction
