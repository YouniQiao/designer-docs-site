...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | DataObserver | Yes | The observer of object data changed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | ProgressObserver | Yes | Observer to be registered. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | StatusObserver | Yes | The observer of object status changed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;RevokeSaveSuccessResponse> | Yes | Callback used to return  RevokeSaveSuccessResponse, which contains the session ID. |
...
| callback | AsyncCallback&lt;SaveSuccessResponse> | Yes | Callback used to return SaveSuccessResponse, which  contains information such as session ID, version, and device ID. |
...
- API version9  to  19: ohos.permission.DISTRIBUTED_DATASYNC
