...
| Name | Description |
| --- | --- |
| [KVManagerConfig](arkts-arkdata-kvmanagerconfig-i.md) | Represents the configuration of a **KVManager** instance, including the bundle name and user information of thecaller. |
...
| [ChangeNotification](arkts-arkdata-changenotification-i.md) | Defines the content of data change notifications, including inserted data, updated data, deleted data, and deviceID. |
