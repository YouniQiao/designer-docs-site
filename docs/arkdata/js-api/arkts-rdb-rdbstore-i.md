...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.batchInsert
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.beginTransaction
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.commit
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.delete
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.executeSql
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.insert
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.obtainDistributedTableName
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.off
...
| observer | Callback&lt;Array&lt;string>> | Yes | Data change observer registered. Array indicates the ID  of the peer device whose data in the database is changed. |
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.on
...
| event | 'dataChange' | Yes | Event to observe. The value is dataChange, which indicates a data change  event. |
| type | SubscribeType | Yes | Subscription type to register. |
| observer | Callback&lt;Array&lt;string>> | Yes | Observer that listens for the data changes in the RDB store.  Array indicates the ID of the peer device whose data in the database is changed. |
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.query
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.querySql
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.rollBack
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.setDistributedTables
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.sync
...
| callback | AsyncCallback&lt;Array&lt;[string, number]>> | Yes | Callback invoked to send the sync result to the  caller. string indicates the device ID. number indicates the sync status of that device. The  value 0 indicates a successful sync. Other values indicate a sync failure. |
...
**Substitute:** @ohos.data.relationalStore:relationalStore.RdbStore.update
