...
**Inheritance:** DeviceKVStoreextends: SingleKVStore.
...
| key | string | Yes | Key of the value to obtain. It cannot be empty or exceed  [MAX_KEY_LENGTH]distributedKVStore.Constants. |
| callback | AsyncCallback&lt;boolean \| string \| long \| double \| Uint8Array> | Yes | Callback used to return the value  obtained. |
