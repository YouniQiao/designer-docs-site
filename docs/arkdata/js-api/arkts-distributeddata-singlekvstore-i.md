...
**Inheritance:** SingleKVStoreextends: KVStore.
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#closeResultSet
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#get
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| key | string | Yes | Key of the value to obtain. It cannot be empty, and the length cannot exceed  [MAX_KEY_LENGTH]distributedData.Constants. |
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#getEntries
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#getResultSet
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#getResultSize
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#getSecurityLevel
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#removeDeviceData
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#setSyncParam
...
**Substitute:** ohos.data.distributedKVStore.SingleKVStore#sync
