...
| --- | --- | --- | --- |
| type | string | Yes | Type of the data to add. For details, see  [UniformDataType](arkts-uniformtypedescriptor-uniformdatatype-e.md#UniformDataType). |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | string | Yes | Type of the data to obtain. For details, see  [UniformDataType](arkts-uniformtypedescriptor-uniformdatatype-e.md#UniformDataType). |
