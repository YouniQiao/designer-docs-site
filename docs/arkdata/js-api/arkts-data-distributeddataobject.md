...
| Name | Description |
| --- | --- |
| [BindInfo](arkts-arkdata-bindinfo-i.md) | Represents the information about the joint asset in the RDB store to bind. Currently, only the RDB stores aresupported. |
| [DataObject](arkts-arkdata-dataobject-i.md) | Provides APIs for managing a distributed data object. Before using any API of this class, use create() to create aDataObject object. |
| [DistributedObject](arkts-arkdata-distributedobject-i.md) | Provides APIs for managing a distributed data object. Before using any API of this class, usecreateDistributedObject() to create a DistributedObject object. |
