...
The module provides APIs for image processing based on the [Sendable](docroot://arkts-utils/arkts-sendable.md)object. You can use the APIs to create a PixelMap object with specified properties or read pixels of an image (or even in a region of an image).
...
| [Region](arkts-image-sendableimage-region-i.md) | Describes the region information.It inherits from [lang.ISendable](docroot://arkts-utils/arkts-sendable.md#isendable). |
| [Size](arkts-image-sendableimage-size-i.md) | Describes the size of an image.It inherits from [lang.ISendable](docroot://arkts-utils/arkts-sendable.md#isendable). |
