...
**Inheritance:** Component3DAttributeextends: CommonMethod<Component3DAttribute>.
...
| --- | --- | --- | --- |
| uri | ResourceStr | Yes | 渲染管线配置文件的路径 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | Dimension | Yes | GPU渲染目标的高度，目标将上采样或下采样到视图高度. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | Dimension | Yes | GPU渲染目标的宽度，目标将上采样或下采样到视图宽度. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| uri | ResourceStr | Yes | 着色器所用纹理的路径 |
