...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [BarState](../arkts-apis/arkts-arkui-enums-barstate-e.md) | Yes | Scrollbar display mode for the inline style in the editing state.<br>Default value:**BarState.Auto** |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [CancelButtonOptions](arkts-arkui-search-cancelbuttonoptions-i.md) | Yes | Options of the cancel button on the right.<br>Default value:<br>{<br>style: CancelButtonStyle.INPUT<br>}<br>Default value on wearables: **28vp**<br>**Since:** 18 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| symbolOptions | [CancelButtonSymbolOptions](arkts-arkui-search-cancelbuttonsymboloptions-i.md) | Yes | Style of the cancel button on the right.<br>Default value:<br>{<br>style: CancelButtonStyle.INPUT<br>} |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [TextDecorationOptions](arkts-arkui-common-textdecorationoptions-i.md) | Yes | Text decorative line options.<br>Default value: {<br> type:TextDecorationType.None,<br> color: Color.Black,<br> style: TextDecorationStyle.SOLID,<br> thicknessScale: 1.0<br>} |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enabled | [Optional](arkts-arkui-optional-t.md)<boolean> | Yes | Whether to enable the autofill animation.<br>**true** to enable; **false** otherwise.<br>Default value: **true**<br>**NOTE**<br>When enabled, the animation takes effect only for text boxes where [InputType](arkts-arkui-text-input-inputtype-e.md) is set to **Password**, **NEW_PASSWORD**, or **NUMBER_PASSWORD**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [EnterKeyType](arkts-arkui-text-input-enterkeytype-e.md) | Yes | Type of the Enter key.<br>Default value: **EnterKeyType.Done** |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| strategy | [LineBreakStrategy](../arkts-apis/arkts-arkui-enums-linebreakstrategy-e.md) | Yes | Line break rule.<br>Default value: **LineBreakStrategy.GREEDY**<br>**NOTE**<br>This attribute takes effect only when the [inline style](../../../../ui/arkts-common-components-text-input.md#inline-style) is set. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [PasswordIcon](arkts-arkui-text-input-passwordicon-i.md) | Yes | Password icon to display at the end of the password text box.<br>By default, the system-provided icon is used.<br>The icon size is fixed at 24 vp (or 28 vp on wearables), regardless of the source image size. |
...
| options | [InputCounterOptions](arkts-arkui-common-inputcounteroptions-i.md) | No | Configuration options for the character counter. |
...
This API has effect only when the [input type](arkts-arkui-text-input-inputtype-e.md) is set to **Password**, **NEWPASSWORD**, or **NUMBERPASSWORD** mode. It does not work in other modes.
...
You can use the [align](arkts-arkui-common-commonmethod-c.md#align-1) attribute to control the vertical position of a text paragraph. In this component, the **align** attribute cannot be used to control the horizontal position of a text paragraph.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [InputType](arkts-arkui-text-input-inputtype-e.md) | Yes | Text box type.<br>Default value: **InputType.Normal** |
