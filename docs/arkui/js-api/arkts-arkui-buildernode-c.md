...
[@Builder](../../../../ui/state-management/arkts-builder.md) and hold the root node of the component tree. A
...
[RenderNode](arkts-arkui-rendernode-c.md) through the [getFrameNode](arkts-arkui-buildernode-c.md#getframenode-1) method of the
BuilderNode and the [getRenderNode](arkts-arkui-framenode-c.md#getrendernode-1) method of the
[FrameNode](arkts-arkui-framenode-c.md), avoid setting the attributes or operating the subnodes through APIs of
...
[build(builder: WrappedBuilder\<Args>, arg?: Object)](arkts-arkui-buildernode-c.md) API, this API can use the builder
...
Obtains the [FrameNode](arkts-arkui-framenode-c.md) from the BuilderNode. The FrameNode is generated only after the
...
> **DOWN** and **UP** [TouchType](../arkts-components/arkts-arkui-touchtype-e.md) states must be included for a touch event to prevent undefined
> behavior.
>
...
calling [getPositionToParent](arkts-arkui-framenode-c.md#getpositiontoparent-1) in the FrameNode. **OffsetB**
...
to the [build](arkts-arkui-buildernode-c.md) API. When updating a custom component, define the variables used in the component
as [@Prop](../../../../ui/state-management/arkts-prop.md) decorated properties.
