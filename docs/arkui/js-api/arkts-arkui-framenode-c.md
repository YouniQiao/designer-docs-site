...
| Error Code ID | Error Message |
| --- | --- |
| [100022](../errorcode-node.md#100022-crosslanguage-attribute-configuration-not-supported) | The FrameNode cannot be set whether to support cross-language common attributesetting. |
