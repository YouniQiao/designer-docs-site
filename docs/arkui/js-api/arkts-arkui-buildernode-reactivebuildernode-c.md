...
> [onTouch](../arkts-components/arkts-arkui-common-commonmethod-c.md#ontouch-1).  
>  
...
> event, for example, both **DOWN** and **UP** in [TouchType](arkts-arkui-enums-touchtype-e.md) of the touch event must be included  
