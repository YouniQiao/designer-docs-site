...
| Name | Description |
| --- | --- |
| [RotationChangeCallback](arkts-arkui-rotationchangecallback-t.md) | Describes a generic callback function for rotation event notifications. In this callback function, the parameter type is [RotationChangeInfo](arkts-arkui-rotationchangeinfo-i.md#rotationchangeinfo) , and the return value type is [RotationChangeResult](arkts-arkui-rotationchangeresult-i.md#rotationchangeresult) \\| void. |
