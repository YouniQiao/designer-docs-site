...
| --- | --- | --- | --- |
| lineHeight | LengthMetrics | Yes | Text line height options. If **value** of **LengthMetrics** is less than orequal to 0, the text line height is unlimited and automatically adapts to the font size. |
...
Text line height of the styled string. Unit: [vp](../../apis-ability-kit/arkts-apis/arkts-app-ability-common.md#common)
