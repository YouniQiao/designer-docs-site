...
| --- | --- | --- | --- |
| anchorInfo | WindowAnchorInfo | No |  |
| attachOptions | SubWindowAttachOptions | No |  |
...
| deathCallback | Callback&lt;void> | Yes | 目标窗口销毁监听。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| winX | int | Yes | 表示以当前窗口左上角为原点的x轴方向偏移量，单位为px。值为正表示在原点右侧，  值为负表示在原点左侧。该参数应为整数，非整数输入将向下取整。 |
| winY | int | Yes | 表示以当前窗口左上角为原点的y轴方向偏移量，单位为px。值为正表示在原点下方，  值为负表示在原点上方。该参数应为整数，非整数输入将向下取整。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| from | RotationInfoType | Yes | 待转换的值的类型。 |
| to | RotationInfoType | Yes | 目标值的类型。 |
| value | int | Yes | 待转换的值。该参数为整数，浮点数输入将向下取整，取值范围为[0, 3]，范围外为非法参数（抛出错误码  [401](docroot://reference/errorcode-universal.md#401-参数检查失败)）。 |
...
| options | SubWindowOptions | Yes | 子窗口参数。decorEnabled为true时，子窗口为非  [沉浸式布局](docroot://windowmanager/window-terminology.md#沉浸式布局)；decorEnabled为false时，子窗口为沉浸式布局。 |
...
**Substitute:** window.Window.destroyWindow(callback:
...
**Substitute:** window.Window.destroyWindow()
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enable | boolean | Yes | 是否允许拖拽。 true表示允许，false表示不允许。 |
...
**Substitute:** window.Window.getWindowAvoidArea
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | AvoidAreaType | Yes | 表示避让区类型。 |
| callback | AsyncCallback&lt;AvoidArea> | Yes | 回调函数。返回窗口内容避让区域。 |
...
**Substitute:** window.Window.getWindowColorSpace
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;ColorSpace> | Yes | 回调函数。当获取成功，err为undefined，data为当前色域模式。 |
...
**Substitute:** window.Window.getWindowProperties
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;WindowProperties> | Yes | 回调函数。返回当前窗口属性。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| transitionType | WindowTransitionType | Yes | 本次转场动画场景。当前只支持销毁场景。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| globalDisplayX | int | Yes | 表示以当前窗口左上角为原点的x轴方向偏移量，单位为px。值为正表示在原点右侧，  值为负表示在原点左侧。该参数应为整数，非整数输入将向下取整。 |
| globalDisplayY | int | Yes | 表示以当前窗口左上角为原点的y轴方向偏移量，单位为px。  值为正表示在原点下方，值为负表示在原点上方。该参数应为整数，非整数输入将向下取整。 |
...
**Substitute:** window.Window.isWindowShowing
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;boolean> | Yes | 回调函数。返回true表示当前窗口已显示，返回false表示当前窗口未显示。 |
...
**Substitute:** window.Window.isWindowSupportWideGamut()
...
**Substitute:** window.Window.isWindowSupportWideGamut(callback:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;boolean> | Yes | 回调函数。返回true表示当前窗口支持广色域模式，返回false表示当前窗口不支持广色域模式。 |
...
**Substitute:** window.Window.setUIContent(path:
...
| --- | --- | --- | --- |
| name | string | Yes | 命名路由页面的名称。 |
| storage | LocalStorage | No | 页面级UI状态存储单元，这里用于为加载到窗口的页面内容传递状态属性，默认值为空。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| presentation | MaximizePresentation | No | set window presentation when maximize. [since 12 - 19] |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| presentation | MaximizePresentation | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| maximizeOptions | MaximizeOptions | No |  |
...
**Substitute:** window.Window.moveWindowTo(x:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | int | Yes | 窗口在x轴方向移动到的坐标位置，单位为px，值为正表示在原点右侧，值为负表示在原点左侧。该参数仅支持整数输入，浮点数输入将向下取整。 |
| y | int | Yes | 窗口在y轴方向移动到的坐标位置，单位为px，值为正表示在原点下方，值为负表示在原点上方。该参数仅支持整数输入，浮点数输入将向下取整。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | int | Yes | 窗口在x轴方向移动到的坐标位置，单位为px，值为正表示位置在x轴右侧；值为负表示位置在x轴左侧；  值为0表示位置在x轴坐标原点。该参数仅支持整数输入，浮点数输入将向下取整。 |
| y | int | Yes | 窗口在y轴方向移动到的坐标位置，单位为px，值为正表示位置在y轴下侧；值为负表示位置在y轴上侧；  值为0表示位置在y轴坐标原点。该参数仅支持整数输入，浮点数输入将向下取整。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | int | Yes | 窗口在x轴方向移动的值，值为正表示右移，单位为px，该参数应该为整数，非整数输入将向下取整。 |
| y | int | Yes | 窗口在y轴方向移动的值，值为正表示下移，单位为px，该参数应该为整数，非整数输入将向下取整。 |
| moveConfiguration | MoveConfiguration | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | int | Yes | 表示以屏幕左上角为起点，窗口在x轴方向移动的值，单位为px。值为正表示右移，值为负表示左移。  该参数仅支持整数输入，浮点数输入将向下取整。 |
| y | int | Yes | 表示以屏幕左上角为起点，窗口在y轴方向移动的值，单位为px。值为正表示下移，值为负表示上移。  该参数仅支持整数输入，浮点数输入将向下取整。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | int | Yes | 表示以目标屏幕左上角为起点，窗口在x轴方向移动的值，单位为px。值为正表示右移，值为负表示左移。  该参数应该为整数，非整数输入将向下取整。 |
| y | int | Yes | 表示以目标屏幕左上角为起点，窗口在y轴方向移动的值，单位为px。值为正表示下移，值为负表示上移。  该参数应该为整数，非整数输入将向下取整。 |
| moveConfiguration | MoveConfiguration | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | int | Yes | 表示以主屏幕左上角为起点，窗口在x轴方向移动的值，单位为px。值为正表示右移，值为负表示左移。  该参数应该为整数，非整数输入将向下取整。 |
| y | int | Yes | 表示以主屏幕左上角为起点，窗口在y轴方向移动的值，单位为px。值为正表示下移，值为负表示上移。  该参数应该为整数，非整数输入将向下取整。 |
...
| callback | RotationChangeCallback&lt;RotationChangeInfo, RotationChangeResult \| void> | No |  |
...
| callback | Callback&lt;boolean> | No | 回调函数。若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口安全限制变化的监听。 |
...
| callback | Callback&lt;FrameMetrics> | No |  |
...
| callback | Callback&lt;OcclusionState> | No |  |
...
**Substitute:** window.Window.off(type:
...
| callback | Callback&lt;AvoidArea> | No | 回调函数。返回当前避让区。若传入参数，则关闭该监听。若未传入参数，则关闭所有系统避让区变化的监听。 |
...
| callback | Callback&lt;AvoidAreaOptions> | No | 回调函数。返回当前避让区以及避让区类型。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有系统避让区变化的监听  。 [since 12 - 19] |
...
| callback | Callback&lt;KeyboardInfo> | No |  |
...
| callback | Callback&lt;void> | No | 回调函数。当点击事件发生在本窗口范围之外的回调。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有本窗口区域范围外的点击事件的监听。 |
...
| callback | Callback&lt;boolean> | No | 回调函数。当本窗口可见状态发生变化时的回调。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有本窗口可见状态变化事件的回调  。 [since 11 - 11] |
...
| callback | Callback&lt;void> | No | 回调函数，当本窗口在指定超时时间内无交互事件时的回调。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有本窗口在指定超时时间内无交互事件的监听。 |
...
| callback | Callback&lt;ScreenshotEventType> | No |  |
...
| callback | Callback&lt;void> | No | 回调函数。当点击事件发生在模态窗口目标窗口的回调。若传入参数，则关闭该监听。若未传入参数，则关闭所有模态窗口目标窗口的点击事件的监听。 |
...
| callback | Callback&lt;WindowEventType> | No | 回调函数。返回当前的窗口生命周期状态。若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口生命周期变化的监听。 |
...
| callback | Callback&lt;WindowStatusType> | No |  |
...
| callback | Callback&lt;void> | No | 回调函数。当点击子窗口右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑的返回值决定当前子窗是否继续关闭，如果返回boolean  类型的true表示不关闭子窗，返回false或者其他非boolean类型表示关闭子窗。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有子窗口关闭的监听。 |
...
| callback | Callback&lt;void, Promise&lt;boolean>> | No | 回调函数。当点击窗口系统提供的右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑需要有  Promise类型的返回值。在返回的Promise函数里，执行resolve(true) 方法表示不关闭当前窗口，执行resolve(false) 方法或者reject方法均表示关闭当前窗口。 |
...
| callback | Callback&lt;TitleButtonRect> | No | 回调函数。返回当前标题栏上的最小化、最大化、关闭按钮矩形区域。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有标题栏上的最小  化、最大化、关闭按钮矩形区域变化的监听。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | RotationChangeCallback&lt;RotationChangeInfo, RotationChangeResult \| undefined> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;WindowEventType> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;TitleButtonRect> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;void, Promise&lt;boolean>> | No |  |
...
| --- | --- | --- | --- |
| type | 'rotationChange' | Yes | 监听事件，固定为'rotationChange'，即窗口旋转变化事件。 |
| callback | RotationChangeCallback&lt;RotationChangeInfo, RotationChangeResult \| void> | Yes | 回调函数。返回窗口旋转信息  [RotationChangeInfo](arkts-window-rotationchangeinfo-i.md#RotationChangeInfo)，应用返回当前窗口变化结果  [RotationChangeResult](arkts-window-rotationchangeresult-i.md#RotationChangeResult)。 |
...
| --- | --- | --- | --- |
| eventType | 'uiExtensionSecureLimitChange' | Yes | 监听事件，固定为'uiExtensionSecureLimitChange'，即窗口内uiExtension安全限制变  化事件。 |
| callback | Callback&lt;boolean> | Yes | 回调函数。当窗口内uiExtension安全限制变化时触发回调。当返回参数为true表示窗口内uiExtension开启了隐藏不安全窗口；当返回参  数为false表示窗口内uiExtension关闭了隐藏不安全窗口。若窗口内存在多个uiExtension，当返回参数为true表示窗口内至少一个uiExtension开启了隐藏不安全窗口；当返回参数为false表示窗  口内所有uiExtension关闭了隐藏不安全窗口。 |
...
| --- | --- | --- | --- |
| type | 'frameMetricsMeasured' | Yes | 监听事件类型，固定为'frameMetricsMeasured'，即窗口帧率指标变化事件。 |
| callback | Callback&lt;FrameMetrics> | Yes | 窗口帧率指标变化时的回调函数。详情见帧率指标  [FrameMetrics](arkts-window-framemetrics-i.md#FrameMetrics)。 |
...
| --- | --- | --- | --- |
| type | 'occlusionStateChanged' | Yes | 监听事件，固定为'occlusionStateChanged'，即窗口可见性变化事件。 |
| callback | Callback&lt;OcclusionState> | Yes | 窗口可见性变化时的回调函数。详情见[可见性状态](arkts-window-occlusionstate-e.md#OcclusionState)  。 |
...
| --- | --- | --- | --- |
| type | 'windowSizeChange' | Yes | 监听事件，固定为'windowSizeChange'，即窗口尺寸变化事件。 |
| callback | Callback&lt;Size> | Yes | 回调函数。返回当前的窗口尺寸。 |
...
**Substitute:** window.Window.on(type:
...
| --- | --- | --- | --- |
| type | 'systemAvoidAreaChange' | Yes | 监听事件，固定为'systemAvoidAreaChange'，即系统避让区变化事件。 |
| callback | Callback&lt;AvoidArea> | Yes | 回调函数。返回当前避让区。 |
...
| --- | --- | --- | --- |
| type | 'avoidAreaChange' | Yes | 监听事件，固定为'avoidAreaChange'，即系统避让区变化事件。 |
| callback | Callback&lt;AvoidAreaOptions> | Yes | 回调函数。返回当前避让区以及避让区类型。 [since 12] |
...
| --- | --- | --- | --- |
| type | 'keyboardHeightChange' | Yes | 监听事件，固定为'keyboardHeightChange'，即键盘高度变化事件。 |
| callback | Callback&lt;int> | Yes | 回调函数。返回当前的键盘高度。返回值为整数，单位为px。 |
...
| --- | --- | --- | --- |
| type | 'keyboardWillShow' | Yes | 监听事件，固定为'keyboardWillShow'，即固定态软键盘即将开始显示的事件。 |
| callback | Callback&lt;KeyboardInfo> | Yes | 回调函数。返回软键盘窗口信息。 |
...
| --- | --- | --- | --- |
| type | 'touchOutside' | Yes | 监听事件，固定为'touchOutside'，即本窗口范围外的点击事件。 |
| callback | Callback&lt;void> | Yes | 回调函数。当点击事件发生在本窗口范围之外的回调。 |
...
| --- | --- | --- | --- |
| type | 'displayIdChange' | Yes | 监听事件，固定为'displayIdChange'，即本窗口所处屏幕变化的事件。 |
| callback | Callback&lt;long> | Yes | 回调函数。当本窗口所处屏幕发生变化后的回调。回调函数返回number类型参数，表示窗口所处屏幕的displayId。 |
...
| --- | --- | --- | --- |
| type | 'windowVisibilityChange' | Yes | 监听事件，固定为'windowVisibilityChange'，即本窗口可见状态变化的事件。 |
| callback | Callback&lt;boolean> | Yes | 回调函数。当本窗口可见状态发生变化后的回调。回调函数返回boolean类型参数，当返回参数为true时表示窗口可见，否则表示窗口不可见。 |
...
| --- | --- | --- | --- |
| type | 'systemDensityChange' | Yes | 监听事件，固定为'systemDensityChange'，即本窗口所处屏幕的系统显示大小缩放系数变化的事件。 |
| callback | Callback&lt;double> | Yes | 回调函数。当本窗口所处屏幕的系统显示大小缩放系数发生变化后的回调。回调函数返回number类型参数，表示当前窗口所处屏幕的系统显示大小缩放系数。 |
...
| --- | --- | --- | --- |
| type | 'mainWindowFullScreenAcrossDisplaysChanged' | Yes | 监听事件，固定为'mainWindowFullScreenAcrossDisplaysChanged'  ，即本窗口的主窗口跨多块屏幕使用全屏模式显示的状态变化。 |
| callback | Callback&lt;boolean> | Yes | 回调函数。即本窗口的主窗口跨多块屏幕使用全屏模式显示的状态变化回调。true表示主窗口进入跨多块屏幕使用全屏模式显示状态，false表示主窗口退出  跨多块屏幕使用全屏模式显示状态。 |
...
| callback | Callback&lt;void> | Yes | 回调函数。当本窗口在指定超时时间内无交互事件时的回调。 |
...
| callback | Callback&lt;void> | Yes | 回调函数。发生截屏事件时的回调。 |
...
| callback | Callback&lt;ScreenshotEventType> | Yes | 回调函数。返回触发的截屏事件类型。 |
...
| callback | Callback&lt;void> | Yes | 回调函数。当点击或触摸事件发生在模态窗口所遮盖窗口的回调。 |
...
| --- | --- | --- | --- |
| type | 'windowEvent' | Yes | 监听事件，固定为'windowEvent'，即窗口生命周期变化事件。 |
| callback | Callback&lt;WindowEventType> | Yes | 回调函数。返回当前的窗口生命周期状态。 |
...
| --- | --- | --- | --- |
| type | 'windowStatusChange' | Yes | 监听事件，固定为'windowStatusChange'，即窗口模式变化事件。 |
| callback | Callback&lt;WindowStatusType> | Yes | 回调函数。返回当前的窗口模式。 |
...
| --- | --- | --- | --- |
| type | 'subWindowClose' | Yes | 监听事件，固定为'subWindowClose'，即子窗口关闭事件。 |
| callback | Callback&lt;void> | Yes | 回调函数。当点击子窗口右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑的返回值决定当前子窗是否继续关闭，如果返回boolean  类型的true表示不关闭子窗，返回false或者其他非boolean类型表示关闭子窗。 |
...
| --- | --- | --- | --- |
| type | 'windowWillClose' | Yes | 监听事件，固定为'windowWillClose'，即窗口关闭事件。 |
| callback | Callback&lt;void, Promise&lt;boolean>> | Yes | 回调函数。当点击窗口系统提供的右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑需要有  Promise类型的返回值。在返回的Promise函数里，执行resolve(true) 方法表示不关闭当前窗口，执行resolve(false) 方法或者reject方法均表示关闭当前窗口。 |
...
| --- | --- | --- | --- |
| type | 'windowHighlightChange' | Yes | 监听事件，固定为'windowHighlightChange'，即窗口激活态变化事件。 |
| callback | Callback&lt;boolean> | Yes | 回调函数。当本窗口的激活态发生变化时的回调。回调函数返回boolean类型参数。当返回参数为true表示激活态；false表示非激活态。 |
...
| --- | --- | --- | --- |
| type | 'windowTitleButtonRectChange' | Yes | 监听事件，固定为'windowTitleButtonRectChange'，即标题栏上的最小化、最大化、关闭按钮矩形区域变化事件。 |
| callback | Callback&lt;TitleButtonRect> | Yes | 回调函数。返回当前标题栏上的最小化、最大化、关闭按钮矩形区域。 |
...
| --- | --- | --- | --- |
| type | 'windowRectChange' | Yes | 监听事件，固定为'windowRectChange'，即窗口矩形变化事件。 |
| callback | Callback&lt;RectChangeOptions> | Yes | 回调函数。返回当前窗口矩形变化值及变化原因。 |
...
| --- | --- | --- | --- |
| type | 'freeWindowModeChange' | Yes | 监听事件，固定为'freeWindowModeChange'，即自由窗口模式变化事件。 |
| callback | Callback&lt;boolean> | Yes | 回调函数。返回当前窗口是否在自由窗口模式，true表示是自由窗口模式，false表示非自由窗口模式。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;boolean> | Yes | Callback used to return the result if the current device  is in free window mode. true - means in free window mode; false - means not in free window mode. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;KeyboardInfo> | Yes | Callback invoked when the keyboard hide animation is completed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;KeyboardInfo> | Yes | Callback invoked when the keyboard show animation is completed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;int> | Yes | Callback used to return the current keyboard height,  which is an integer, in px. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;KeyboardInfo> | Yes | Callback invoked before the keyboard hide animation start. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;KeyboardInfo> | Yes | Callback invoked before the keyboard show animation start. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | RotationChangeCallback&lt;RotationChangeInfo, RotationChangeResult \| undefined> | Yes | Register the callback function. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;void> | Yes | 回调函数。当点击子窗口右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑的返回值决定当前子窗是否继续关闭，如果返回boolean类型的true表示不关闭子窗，返回false或者其他非boolean类型表示关闭子窗。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;boolean> | Yes | Callback used to return the result whether the APP has uiextension secure limit. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;boolean> | Yes | Callback used to return the highlight status of the window. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;void, Promise&lt;boolean>> | Yes | 回调函数。当点击子窗口右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑的返回值决定当前子窗是否继续关闭，如果返回boolean类型的true表示不关闭子窗，返回false或者其他非boolean类型表示关闭子窗。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| opacity | double | Yes | 不透明度。该参数为浮点数，取值范围为[0.0, 1.0]。0.0表示完全透明，1.0表示完全不透明。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| windowId | int | Yes | 目标子窗口的id，通过[getWindowProperties](arkts-window-window-i.md#getWindowProperties)接  口获取到[properties](arkts-window-windowproperties-i.md#WindowProperties)后，再通过properties.id获取。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| windowId | int | Yes | 目标主窗口的id，该参数为整数，通过  [getWindowProperties](arkts-window-window-i.md#getWindowProperties)接口获取到  [properties](arkts-window-windowproperties-i.md#WindowProperties)后，再通过properties.id获取。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| snapshotAnimationConfig | WindowSnapshotAnimationConfig | Yes | 截图动画参数配置。 |
...
**Substitute:** window.Window.resize(width:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| width | number | Yes | 当前窗口的目标宽度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，负值为非法参数（抛出错误码  [401](docroot://reference/errorcode-universal.md#401-参数检查失败)）。 |
| height | number | Yes | 当前窗口的目标高度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，负值为非法参数（抛出错误码  [401](docroot://reference/errorcode-universal.md#401-参数检查失败)）。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| width | int | Yes | 当前窗口的目标宽度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，  负值为非法参数（抛出错误码401）。 |
| height | int | Yes | 当前窗口的目标高度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，  负值为非法参数（抛出错误码401）。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rotateOptions | RotateOptions | Yes | 旋转参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| scaleOptions | ScaleOptions | Yes | 缩放参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| radius | double | Yes | 表示窗口背景模糊的半径值。该参数为浮点数，单位为px，取值范围为[0.0, +∞)，取值为0.0表示关闭窗口背景模糊。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| blurStyle | BlurStyle | Yes | 表示窗口背景模糊类型。 |
...
**Substitute:** window.Window.setWindowBackgroundColor
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| radius | double | Yes | 表示窗口模糊的半径值。该参数为浮点数，单位为px，取值范围为[0, +∞)，取值为0.0时表示关闭窗口模糊。 |
...
**Substitute:** window.Window.setWindowBrightness(brightness:
...
**Substitute:** window.Window.setWindowColorSpace(colorSpace:ColorSpace)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| colorSpace | ColorSpace | Yes | 设置色域模式。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| cornerRadius | double | Yes | 表示窗口圆角的半径值。该参数为浮点数，单位为px，取值范围为[0.0, +∞)，取值为0.0时表示没有窗口圆角。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dectorStyle | DecorButtonStyle | Yes | 要设置的装饰栏按钮样式。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enabled | boolean | Yes | 是否响应手势返回事件。 true表示响应手势返回事件，触发onBackPress回调；false表示不响应手势返回事件，不触发onBackPress回调。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| keyFramePolicy | KeyFramePolicy | Yes | 用于设置拖拽的关键帧策略。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enabled | boolean | Yes | 是否支持获取三键导航类型的避让区域。 true表示支持，false表示不支持。 |
...
**Substitute:** window.Window.setWindowFocusable(isFocusable:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isFocusable | boolean | Yes | 点击时是否支持切换焦点窗口。true表示支持；false表示不支持。设置为false时，该窗口不支持绑定输入法和接收键盘事件，如需处理输入逻辑，建议参考  [不可获焦窗口中输入框与输入法交互指南](docroot://inputmethod/use-inputmethod-in-not-focusable-window.md)。 |
...
**Substitute:** window.Window.setWindowSystemBarEnable(names:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isFullScreen | boolean | Yes | 是否设为全屏布局（该全屏布局影响状态栏、三键导航栏显示）。true表示全屏；false表示非全屏。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enabled | boolean | Yes | 是否开启沉浸式布局。 true表示开启，false表示关闭。 |
...
**Substitute:** window.Window.setWindowKeepScreenOn(isKeepScreenOn:
...
**Substitute:** window.Window.setWindowLayoutFullScreen(isLayoutFullScreen:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isLayoutFullScreen | boolean | Yes | 窗口的布局是否为沉浸式布局（该沉浸式布局不影响状态栏、三键导航栏显示）。true表示沉浸式布局；  false表示非沉浸式布局。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| windowId | int | Yes | 父窗口id，该参数应为整数。推荐使用[getWindowProperties()]window.Window.getWindowProperties方法获取父  窗口id属性。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| orientation | Orientation | Yes | 窗口显示方向的属性。 |
...
| --- | --- | --- | --- |
| orientation | Orientation | Yes | 窗口显示方向的属性。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。该回调函数返回调用结果是否成功，非应用旋转动效结束。 |
...
**Substitute:** window.Window.setWindowPrivacyMode(isPrivacyMode:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| radius | double | Yes | 表示窗口边缘阴影的模糊半径。该参数为浮点数，单位为px，取值范围为[0.0, +∞)，取值为0.0时表示关闭窗口边缘阴影。 |
| color | string | No | 表示窗口边缘阴影的颜色，为十六进制RGB或ARGB颜色，不区分大小写，例如`#00FF00`或`#FF00FF00`，默认值为'#000000'。 |
| offsetX | double | No | 表示窗口边缘阴影的X轴的偏移量。该参数为浮点数，单位为px，默认值为0.0。 |
| offsetY | double | No | 表示窗口边缘阴影的Y轴的偏移量。该参数为浮点数，单位为px，默认值为0.0。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isSkip | boolean | Yes | 截屏、录屏或投屏是否忽略当前窗口，默认为false。 true表示忽略当前窗口，false表示不忽略当前窗口。 |
...
| enableAnimation | boolean | No | Whether using animation during this setting,  using animation if true or not using animation if false. [since 12] |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| color | ColorMetrics | Yes | 要设置的状态栏颜色值。 |
...
| modalityType | ModalityType | Yes | 子窗口模态类型。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| zLevel | int | Yes | 子窗口层级级别。默认值为0，取值范围为[-10000, 10000]，该参数仅支持整数输入，浮点数输入将向下取整。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| names | Array&lt;'status' \| 'navigation'> | Yes | 设置窗口全屏模式时状态栏和三键导航栏是否显示。 例如，需全部显示，该参  数设置为['status','navigation']；设置为[]，则不显示。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。 |
...
**Substitute:** window.Window.setWindowSystemBarProperties(systemBarProperties:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| systemBarProperties | SystemBarProperties | Yes | 三键导航栏、状态栏的属性。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isTitleHoverShown | boolean | No | 是否显示窗口标题栏。 true表示显示窗口标题栏；false表示不显示窗口标题栏。默认值是true。 |
| isDockHoverShown | boolean | No | 是否显示dock栏。 true表示显示dock栏；false表示不显示dock栏。默认值是true。 |
...
**Substitute:** window.Window.setWindowTouchable(isTouchable:
...
- API version26.0.0 and later: ohos.permission.SET_WINDOW_TOUCH_AREAS
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| color | string \| ColorMetrics | Yes | 需要设置的背景色，为十六进制RGB或ARGB颜色，不区分大小写，例如'#00FF00'或'#FF00FF00'。  从API version 18开始，此参数支持ColorMetrics类型。 [since 18] |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| brightness | double | Yes | 屏幕亮度值。该参数为浮点数，取值范围为[0.0, 1.0]或-1.0。1.0表示最亮，-1.0表示恢复成设置窗口亮度前的系统控制中心亮度。 |
...
- API version26.0.0 and later: ohos.permission.SET_WINDOW_ALPHA
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| cornerRadius | double | Yes | 表示窗口圆角的半径值。该参数为浮点数，单位为vp，取值范围为[0.0, +∞)，取值为0.0时表示没有窗口圆角。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| height | int | Yes | 设置的窗口标题栏高度，仅支持具有窗口标题栏的窗口。该参数为整数，浮点数输入将向下取整，取值范围为[37,112]，范围外为非法参数，单位为vp。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isEnabled | boolean | Yes | 是否使能延迟抬升。 true表示使能窗口延迟抬升；false表示不使能窗口延迟抬升。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| grayScale | double | Yes | 窗口灰阶。该参数为浮点数，取值范围为[0.0, 1.0]。0.0表示窗口图像无变化，1.0表示窗口图像完全转为灰度图像，0.0至1.0之间时效果呈线性变化。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isLayoutFullScreen | boolean | Yes | 窗口的布局是否为沉浸式布局（该沉浸式布局状态栏、三键导航栏仍然显示）。true表示沉浸式布局；  false表示非沉浸式布局。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| windowLimits | WindowLimits | Yes | 目标窗口的尺寸限制，单位为px或vp。 |
...
| --- | --- | --- | --- |
| windowLimits | WindowLimits | Yes | 目标窗口的尺寸限制，单位为px或vp。 |
| isForcible | boolean | Yes | 是否强制设置窗口的尺寸限制。 入参[windowLimits](arkts-window-windowlimits-i.md#WindowLimits)的单位为vp时  ：无论设置true还是false，都按照false处理，窗口宽高的最小值和最大值都取决于系统限制。 入参[windowLimits](arkts-window-windowlimits-i.md#WindowLimits)  的单位为px时：设置为true，表示窗口宽高最小值以系统限制值和40vp两者中的低数值为准，窗口宽高的最大值仍取决于系统限制；设置为false，表示窗口宽高的最小值和最大值都取决于系统限制。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| windowMask | Array&lt;Array&lt;long>> | Yes | 异形窗口的掩码，该参数仅支持宽高为窗口宽高、取值为整数0和整数1的二维数组输入，整数0代表所在像素透明，整数1代表所在像素不透明，宽高不符合  的二维数组或二维数组取值不为整数0和整数1的二维数组为非法参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| windowMask | Uint8Array | Yes | windowMask仅包含每像素alpha透明度值。  有效范围：0（完全透明）到255（完全不透明），大小必须等于(maskWidthmask Heights) |
| maskWidth | int | Yes | 掩码宽度（以像素为单位）。必须等于目标窗口宽度  取值范围为全体整数。 |
| maskHeight | int | Yes | 以像素为单位的遮罩高度。必须等于目标窗口高度  取值范围为全体整数。 |
...
| --- | --- | --- | --- |
| transitionType | WindowTransitionType | Yes | 本次转场动画场景。当前只支持销毁场景。 |
| animation | TransitionAnimation | Yes | 本次转场动画配置。 |
...
**Substitute:** window.Window.showWindow(callback:
...
**Substitute:** window.Window.showWindow()
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | ShowWindowOptions | Yes | 显示子窗口或系统窗口时的参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;image.PixelMap> | Yes | 回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| offsetX | int | Yes | 窗口移动时预期鼠标位置相对窗口左上角的x轴偏移量，单位为px，该参数仅支持整数输入，浮点数向下取整。负值为非法参数，大于窗口宽度为非法参数，窗口宽度可以在窗口属性  [WindowProperties](arkts-window-windowproperties-i.md#WindowProperties)中获取。 |
| offsetY | int | Yes | 窗口移动时预期鼠标位置相对窗口左上角的y轴偏移量，单位为px，该参数仅支持整数输入，浮点数向下取整。负值为非法参数，大于窗口高度为非法参数，窗口高度可以在窗口属性  [WindowProperties](arkts-window-windowproperties-i.md#WindowProperties)中获取。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| translateOptions | TranslateOptions | Yes | 平移参数，单位为px。 |
