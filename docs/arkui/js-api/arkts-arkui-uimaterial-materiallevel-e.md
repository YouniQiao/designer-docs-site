...
Enumerates the material levels, which indicate the computing power level of the device.Use [getGlobalMaterialLevel](arkts-arkui-uimaterial-getglobalmateriallevel-f.md#getglobalmateriallevel-1) to obtain the material level of the current device.
