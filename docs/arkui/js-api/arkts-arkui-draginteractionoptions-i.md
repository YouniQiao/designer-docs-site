...
parameter takes effect only for the [grid items](./gridItem) and [list items](./list_item) in the
...
[dragPreview](arkts-arkui-commonmethod-c.md#dragpreview-1) > PixelMap in
