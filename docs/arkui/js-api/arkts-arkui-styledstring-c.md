...
| --- | --- | --- | --- |
| value | string \| ImageAttachment \| CustomSpan | Yes | Text of the styled string.<br>**NOTE**<br>If thisparameter is of the ImageAttachment or CustomSpan type, the **styles** parameter has no effect.<br>To set**styles**, use methods such as [setStyle](arkts-arkui-mutablestyledstring-c.md#setstyle-1). |
...
detailed in [StyledStringKey](arkts-arkui-styledstringkey-e.md), include: **StyledStringKey.FONT**,
