...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | double | Yes | The target time in seconds  Unit: Seconds, The value must be greater than or equal to 0, The maximum value is the total duration of the  video. If the duration exceeds the maximum value, the system jumps to the end of the video. |
...
| --- | --- | --- | --- |
| value | double | Yes | The target time in seconds  Unit: Seconds, The value must be greater than or equal to 0, The maximum value is the total duration of the  video. If the duration exceeds the maximum value, the system jumps to the end of the video. |
| seekMode | SeekMode | Yes | The seek mode to use for time adjustment. |
