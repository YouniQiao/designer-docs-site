...
API [requestFocus](../arkts-apis/arkts-arkui-focuscontroller-c.md#requestfocus-1) in **FocusController**.
...
| Type | Description |
| --- | --- |
| boolean | Returns whether focus transfer is successfully requested for the target component. If thetarget component pointed to by the parameter exists, is mounted to the component tree, and is focusable,**true** is returned. Otherwise, **false** is returned. |
