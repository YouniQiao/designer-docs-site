...
**Substitute:** ohos.router.router#back
...
**Substitute:** ohos.router.router#clear
...
**Substitute:** ohos.router.router#hideAlertBeforeBackPage
...
**Substitute:** ohos.router.router#showAlertBeforeBackPage
...
**Substitute:** ohos.router.router#getLength
...
**Substitute:** ohos.router.router#getParams
...
**Substitute:** ohos.router.router#getState
...
**Substitute:** ohos.router.router#push
...
**Substitute:** ohos.router.router#replace
