...
2. The total offset returned by the [currentOffset](arkts-arkui-scroller-c.md#currentoffset-1)
or [offset](arkts-arkui-scroller-c.md#offset-1) API of [scroller](arkts-arkui-waterflowoptions-i.md)
...
3. If a jump action (for example, by calling [scrollToIndex](arkts-arkui-scroller-c.md#scrolltoindex-1)
without animation or [scrollEdge](arkts-arkui-scroller-c.md#scrolledge-1))
...
4. If the [scrollToIndex](arkts-arkui-scroller-c.md#scrolltoindex-1) API is called without animation
