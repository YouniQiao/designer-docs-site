...
Note: This API is supported since API version 9 and deprecated since API version 13. There is no alternative window type. To control the input method, call [Input method framework APIs](docroot://inputmethod/inputmethod-application-guide.md).
