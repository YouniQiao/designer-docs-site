...
> will be affected. The parameter list of its [onCreateMenu](../arkts-components/arkts-arkui-editmenuoptions-i.md#oncreatemenu-1) callback will not
...
> [TextMenuItemId](../arkts-components/arkts-arkui-textmenuitemid-c.md).
>
...
> first-level menu item **autoFill** (parent item) in [TextMenuItemId](../arkts-components/arkts-arkui-textmenuitemid-c.md) will simultaneously
