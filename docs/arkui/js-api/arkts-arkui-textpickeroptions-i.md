...
1. Single-column pickers: string[], [Resource](../../apis-localization-kit/arkts-apis/arkts-localization-resource-i.md),
...
[$$](../../../../ui/state-management/arkts-two-way-sync.md).
2. The [Resource](../../apis-localization-kit/arkts-apis/arkts-localization-resource-i.md) type is supported since API version 20.
...
4. Single-column pickers: [ResourceStr](arkts-arkui-resourcestr-t.md)
5. Multi-column pickers: [ResourceStr](arkts-arkui-resourcestr-t.md)[]
