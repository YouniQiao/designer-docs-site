...
**Inheritance:** RotationGestureHandlerextends: GestureHandler<RotationGestureHandler>.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | Callback&lt;void> | Yes | 旋转手势处理器取消回调。不返回手势事件信息。 |
...
设置旋转手势处理器取消回调。旋转手势处理器识别成功后，接收到触摸取消事件时触发回调。与 [onActionCancel](arkts-rotationgesturehandler-c.md#onActionCancel)相比，此接口返回手势事件信息。
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | Callback&lt;GestureEvent> | Yes | 旋转手势处理器取消回调。返回手势事件信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | Callback&lt;GestureEvent> | Yes | 旋转手势处理器结束回调。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | Callback&lt;GestureEvent> | Yes | 旋转手势处理器识别成功回调。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | Callback&lt;GestureEvent> | Yes | 旋转手势处理器更新回调。 |
