...
**Inheritance:** UIScrollableCommonEventextends: UICommonEvent.
...
| --- | --- | --- | --- |
| callback | Callback&lt;void> \| undefined | Yes | callback function, triggered when the  scrolling reaches the end position. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;void> \| undefined | Yes | callback function, triggered when the  scrolling reaches the start position. |
