...
| --- | --- | --- | --- |
| nodeParam | NodeParamV2 | No | Configuration information of the newly added node. |
...
| parentSubTitle | ResourceStr | Yes | secondaryTitle of parent node. |
| currentSubtitle | ResourceStr | Yes | secondaryTitle of current node. |
