...
| builder | [WrappedBuilder](../arkts-components/arkts-arkui-common-wrappedbuilder-c.md)<T> | Yes | Encapsulates the WrappedBuilder object of the @Builder function with parameters. |
