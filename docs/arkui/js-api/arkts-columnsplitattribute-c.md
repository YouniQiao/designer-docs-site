...
**Inheritance:** ColumnSplitAttributeextends: CommonMethod<ColumnSplitAttribute>.
...
| --- | --- | --- | --- |
| value | ColumnSplitDividerStyle \| null | Yes | 分割线的margin，即设置分割线与子组件的距离。 默认值：null。当设置为null时，分割线与子组件的距离为0vp。非法值：按默认值处理。 |
