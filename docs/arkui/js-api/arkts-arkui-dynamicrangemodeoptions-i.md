...
By default, the system snapshots in [STANDARD](ImageAttribute#dynamicRangeMode) mode. If the dynamic range
...
3. If the [color space](arkts-arkui-colormodeoptions-i.md) is set to **SRGB** or **DISPLAY_P3**, SDR is applied for the snapshot.
...
[SnapshotOptions](arkts-arkui-snapshotoptions-i.md) to **true** to ensure that the system can properly
