...
Unique ID of the **Navigation** component, which can be obtained through [queryNavigationInfo](../arkts-components/arkts-arkui-common-basecustomcomponent-c.md#querynavigationinfo-1).
