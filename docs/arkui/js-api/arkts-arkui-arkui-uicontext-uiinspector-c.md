...
| --- | --- | --- | --- |
| id | string | Yes | ID of the target component, set using the universal attributes [id](../arkts-components/arkts-arkui-common-commonmethod-c.md#id-1)or [key](../arkts-components/arkts-arkui-common-commonmethod-c.md#key-1). |
