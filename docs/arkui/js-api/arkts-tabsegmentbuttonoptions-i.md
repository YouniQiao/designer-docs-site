...
页签类分段按钮选项。继承自[TabSegmentButtonConstructionOptions](arkts-tabsegmentbuttonconstructionoptions-i.md#TabSegmentButtonConstructionOptions)。

**Inheritance:** TabSegmentButtonOptionsextends: TabSegmentButtonConstructionOptions.
