...
长按手势处理器配置参数。继承自[BaseHandlerOptions](arkts-basehandleroptions-i.md#BaseHandlerOptions)。

**Inheritance:** LongPressGestureHandlerOptionsextends: BaseHandlerOptions.
