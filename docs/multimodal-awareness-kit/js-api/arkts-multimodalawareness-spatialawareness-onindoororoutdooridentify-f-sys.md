...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-common-callback-i.md)<DoorPositionResponse> | Yes | Callback for identification inside and outside the door. |
