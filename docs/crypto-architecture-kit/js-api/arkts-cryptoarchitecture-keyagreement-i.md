...
| callback | AsyncCallback&lt;DataBlob&gt; | Yes | Callback used to return the result. If the operation is successful,**err** is **undefined**, and **data** is the shared key obtained. Otherwise, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| Promise&lt;DataBlob&gt; | Promise used to return the shared key of key agreement. |
