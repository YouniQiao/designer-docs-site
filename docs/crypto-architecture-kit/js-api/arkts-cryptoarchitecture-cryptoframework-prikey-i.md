...
> **NOTE**  
>  
> The difference between [Key.getEncoded()](arkts-cryptoarchitecture-cryptoframework-key-i.md#getencoded-1) and this API is as follows:  
...
> [Key.getEncoded()](arkts-cryptoarchitecture-cryptoframework-key-i.md#getencoded-1).
...
| Type | Description |
| --- | --- |
| [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-cert-datablob-i.md) | ECC private key data obtained. |
...
| config | [KeyEncodingConfig](arkts-cryptoarchitecture-cryptoframework-keyencodingconfig-i.md) | Yes | Options (including the password and algorithm) for encoding the private key. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-lib-es5-promise-i.md)<Uint8Array> | Promise used to return the private key data of the specified key data type. |
...
| Type | Description |
| --- | --- |
| [Uint8Array](../../apis-na/arkts-apis/arkts-na-lib-es5-uint8array-i.md) | Private key data of the specified key data type. |
