...
[Cipher](arkts-cryptoarchitecture-cipher-i.md) instance.

Keys can be generated by a child class key generator. For details, see the child class description. The child
classes include [SymKey](arkts-cryptoarchitecture-symkey-i.md), [PubKey](arkts-cryptoarchitecture-pubkey-i.md), and
