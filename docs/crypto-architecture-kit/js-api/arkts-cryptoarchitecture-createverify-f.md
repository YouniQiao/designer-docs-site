...
| --- | --- | --- | --- |
| algName | string | Yes | Signing algorithm to use. Currently, RSA, ECC, DSA, SM2&lt;sup&gt;10+&lt;/sup&gt; and Ed25519&lt;sup&gt;11+&lt;/sup&gt; are supported. If RSA PKCS1 is used, you must set the digest. If RSA PSS is used, you must set thedigest and mask digest. When the RSA algorithm is used for signature verification, you can use **Recover** toverify and recover the signed data.<br>For details about the supported specifications, see[Signing and Signature Verification Overview and Algorithm Specifications](../../../../security/CryptoArchitectureKit/crypto-sign-sig-verify-overview.md). |
