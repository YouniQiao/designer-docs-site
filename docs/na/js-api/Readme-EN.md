...
- [@ohos.notification](arkts-notification.md)
  ...
  - [isBadgeDisplayed(system api)](arkts-notification-isbadgedisplayed-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [removeGroupByBundle(system api)](arkts-notification-removegroupbybundle-f-sys.md)<!--DelEnd--><!--Del-->
  - [removeAll(system api)](arkts-notification-removeall-f-sys.md)<!--DelEnd--><!--Del-->
  - [getSlotNumByBundle(system api)](arkts-notification-getslotnumbybundle-f-sys.md)<!--DelEnd--><!--Del-->
  - [unsubscribe(system api)](arkts-notification-unsubscribe-f-sys.md)<!--DelEnd-->
  ...
  - [enableNotification(system api)](arkts-notification-enablenotification-f-sys.md)<!--DelEnd-->
  - [cancelGroup](arkts-notification-cancelgroup-f.md)<!--Del-->
  - [setSlotByBundle(system api)](arkts-notification-setslotbybundle-f-sys.md)<!--DelEnd-->
  - [getSlots](arkts-notification-getslots-f.md)<!--Del-->
  - [getDoNotDisturbDate(system api)](arkts-notification-getdonotdisturbdate-f-sys.md)<!--DelEnd-->
  ...
  - [supportDoNotDisturbMode(system api)](arkts-notification-supportdonotdisturbmode-f-sys.md)<!--DelEnd-->
  - [isSupportTemplate](arkts-notification-issupporttemplate-f.md)<!--Del-->
  - [enableDistributed(system api)](arkts-notification-enabledistributed-f-sys.md)<!--DelEnd--><!--Del-->
  - [enableDistributedByBundle(system api)](arkts-notification-enabledistributedbybundle-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [getDeviceRemindType(system api)](arkts-notification-getdeviceremindtype-f-sys.md)<!--DelEnd-->
  - [publish](arkts-notification-publish-f.md)<!--Del-->
  - [publish(system api)](arkts-notification-publish-f-sys.md)<!--DelEnd-->
  - [isDistributedEnabled](arkts-notification-isdistributedenabled-f.md)<!--Del-->
  - [addSlots(system api)](arkts-notification-addslots-f-sys.md)<!--DelEnd--><!--Del-->
  - [isDistributedEnabledByBundle(system api)](arkts-notification-isdistributedenabledbybundle-f-sys.md)<!--DelEnd-->
  - [BundleOption](arkts-notification-bundleoption-i.md)<!--Del-->
  - [DoNotDisturbDate(system api)](arkts-notification-donotdisturbdate-i-sys.md)<!--DelEnd-->
  ...
  - [SourceType(system api)](arkts-notification-sourcetype-e-sys.md)<!--DelEnd-->
- [@ohos.notification](arkts-notification.md)
  - [cancel](arkts-notification-cancel-f.md)
  - [removeAllSlots](arkts-notification-removeallslots-f.md)
  - [requestEnableNotification](arkts-notification-requestenablenotification-f.md)
