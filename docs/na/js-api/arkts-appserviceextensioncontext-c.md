...
**Inheritance:** AppServiceExtensionContextextends: ExtensionContext.
...
| --- | --- | --- | --- |
| want | Want | Yes | Want类型参数，传入需要连接的Ability的信息，如Ability名称，Bundle名称等。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| connection | long | Yes | 在  [connectServiceExtensionAbility](../../apis-ability-kit/arkts-apis/arkts-appserviceextensioncontext-c.md#connectServiceExtensionAbility)中返回的连接id。 |
