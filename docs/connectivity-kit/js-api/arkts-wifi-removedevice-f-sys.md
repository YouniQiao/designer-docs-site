...
**Substitute:** ohos.wifiManager/wifiManager.removeDeviceConfig
...
| --- | --- | --- | --- |
| id | number | Yes | Indicates the ID of the Wi-Fi network,  which can be obtained using the {@link #addDeviceConfig} or {@link #getLinkedInfo} method. |
