...
**Substitute:** ohos.wifiManager/wifiManager.on#event:wifiStateChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:wifiConnectionChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:wifiScanStateChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:wifiRssiChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:hotspotStateChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:p2pStateChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:p2pConnectionChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:p2pDeviceChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:p2pPeerDeviceChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:p2pPersistentGroupChange
...
**Substitute:** ohos.wifiManager/wifiManager.on#event:p2pDiscoveryChange
