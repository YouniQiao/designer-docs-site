...
**Substitute:** ohos.bluetooth.connection/connection.on#event:bluetoothDeviceFind
...
**Substitute:** ohos.bluetooth.connection/connection.on#event:bondStateChange
...
**Substitute:** ohos.bluetooth.connection/connection.on#event:pinRequired
...
**Substitute:** ohos.bluetooth.access/access.on#event:stateChange
...
**Substitute:** ohos.bluetooth.socket/socket.on#event:sppRead
