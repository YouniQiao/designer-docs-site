...
| [onConnectionStateChanged](arkts-connectivity-onconnectionstatechanged-f.md#onconnectionstatechanged-1) | Subscribes to the connection state change event. |
| [onReadData](arkts-connectivity-onreaddata-f.md#onreaddata-1) | Subscribes to the event reported when data is read from the port. |
