...
**Inheritance:** HidDeviceProfileextends: BaseProfile.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;GetReportData> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;InterruptData> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;ProtocolData> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;SetReportData> | No |  |
...
| inQos | HidDeviceQos | Yes | Describe the In Quality of Service (QoS) settings  for the Bluetooth HID device application. |
| outQos | HidDeviceQos | Yes | Describe the Out Quality of Service (QoS) settings  for the Bluetooth HID device application. |
