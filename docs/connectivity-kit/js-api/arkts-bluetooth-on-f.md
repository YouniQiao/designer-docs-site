...
**Substitute:** ohos.bluetoothManager/bluetoothManager.on#event:bluetoothDeviceFind
...
**Substitute:** ohos.bluetoothManager/bluetoothManager.on#event:bondStateChange
...
| callback | Callback&lt;BondStateParam> | Yes | Callback used to listen for the bond state event,  {@link BondStateParam}. |
...
**Substitute:** ohos.bluetoothManager/bluetoothManager.on#event:pinRequired
...
**Substitute:** ohos.bluetoothManager/bluetoothManager.on#event:stateChange
...
| callback | Callback&lt;BluetoothState> | Yes | Callback used to listen for the Bluetooth state event. |
...
**Substitute:** ohos.bluetoothManager/bluetoothManager.on#event:sppRead
