...
| Name | Description |
| --- | --- |
| [GattClientDevice](arkts-connectivity-gattclientdevice-i-sys.md) | Manages GATT client. Before calling an Gatt client method, you must use {@link createGattClientDevice} to create anGattClientDevice instance. |
