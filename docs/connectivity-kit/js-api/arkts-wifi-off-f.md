...
**Substitute:** ohos.wifiManager/wifiManager.off#event:wifiStateChange
...
| callback | Callback&lt;number> | No | the callback of on, 0: inactive, 1: active, 2: activating, 3: de-activating |
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:wifiConnectionChange
...
| callback | Callback&lt;number> | No | the callback of on, 0: disconnected, 1: connected |
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:wifiScanStateChange
...
| callback | Callback&lt;number> | No | the callback of on, 0: scan fail, 1: scan success |
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:wifiRssiChange
...
| callback | Callback&lt;number> | No | the callback of on |
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:hotspotStateChange
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:p2pStateChange
...
| callback | Callback&lt;number> | No | the callback of on, 1: idle, 2: starting, 3:started, 4: closing, 5: closed |
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:p2pConnectionChange
...
| callback | Callback&lt;WifiP2pLinkedInfo> | No | the callback of on |
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:p2pDeviceChange
...
| callback | Callback&lt;WifiP2pDevice> | No | the callback of on |
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:p2pPeerDeviceChange
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:p2pPersistentGroupChange
...
| callback | Callback&lt;void> | No | the callback of on |
...
**Substitute:** ohos.wifiManager/wifiManager.off#event:p2pDiscoveryChange
