...
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;void> | Yes | callback回调，用于获取清除所有cookie是否成功。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| incognito | boolean | No | true表示清除隐私模式下Webview的所有内存cookies，false表示清除正常非隐私模式下的持久化cookies。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;void> | Yes | callback回调，用于获取清除所有会话cookie是否成功。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| url | string | Yes | 要设置的cookie所属的url。 |
| value | string | Yes | 要设置的cookie的值。 |
...
| url | string | Yes | 要设置的cookie所属的url。 |
| value | string | Yes | 要设置的cookie的值。 |
| incognito | boolean | Yes | true表示设置隐私模式下对应url的cookies，false表示设置正常非隐私模式下对应url的cookies。 |
| includeHttpOnly | boolean | Yes | true表示允许覆盖含有http-only的cookies，false表示不允许覆盖含有http-only的cookies。 |
...
| url | string | Yes | 要设置的cookie所属的url。 |
| value | string | Yes | 要设置的cookie的值。 |
| callback | AsyncCallback&lt;void> | Yes | callback回调，用于获取设置cookie的结果 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| url | string | Yes | 要设置的cookie所属的url，建议使用完整的url。 |
| value | string | Yes | 要设置的cookie的值。 |
| incognito | boolean | No | true表示设置隐私模式下对应url的cookies，false表示设置正常非隐私模式下对应url的cookies。 默认值：false。 传入  undefined或null会抛出异常错误码401。 |
...
**Substitute:** ohos.web.webview.WebCookieManager#clearAllCookiesSync
...
**Substitute:** ohos.web.webview.WebCookieManager#clearSessionCookieSync
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| incognito | boolean | No | true表示隐私模式下查询是否存在cookies，false表示正常非隐私模式下查询是否存在cookies。 默认值：false。 传入  undefined或null时返回undefined。 [since 11] |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| incognito | boolean | Yes | {@code true} 隐私模式下获取所有Cookie。 {@code false} 非隐私模式下获取所有Cookie。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| url | string | Yes | 要获取的cookie所属的url。 |
...
| --- | --- | --- | --- |
| url | string | Yes | 要获取的cookie所属的url。 |
| incognito | boolean | Yes | true表示获取隐私模式下webview的内存cookies，false表示正常非隐私模式下的cookies。 |
...
| --- | --- | --- | --- |
| url | string | Yes | 要获取的cookie所属的url。 |
| callback | AsyncCallback&lt;string> | Yes | 在获取到指定URL的Cookie之后调用。 |
...
| --- | --- | --- | --- |
| url | string | Yes | 要获取的cookie所属的url。 |
| incognito | boolean | No | true表示获取隐私模式下webview的内存cookies，false表示正常非隐私模式下的cookies。 |
...
**Substitute:** ohos.web.webview.WebCookieManager#fetchCookieSync
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| accept | boolean | Yes | 设置是否拥有发送和接收cookie的权限，默认为true，表示拥有发送和接收cookie的权限。false表示没有发送和接收cookie的权限。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| accept | boolean | Yes | 是否允许设置、获取第三方cookie。 true表示允许设置、获取第三方cookie，false表示不允许设置、获取第三方cookie。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;void> | Yes | callback回调，用于获取cookie是否成功保存。 |
...
**Substitute:** ohos.web.webview.WebCookieManager#configCookieSync
