...
| --- | --- | --- | --- |
| domainSuffixes | Array&lt;string> | Yes | 一组域名列表，如果网页URL与列表中的某个条目匹配，则该网页将被允许使用广告拦截功能。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| domainSuffixes | Array&lt;string> | Yes | 一组域名列表，如果网页URL与列表中的某个域名匹配，则该网页将被禁止使用广告拦截功能。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| domainSuffixes | Array&lt;string> | Yes | 需要从允许列表中移除的域名后缀列表。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| domainSuffixes | Array&lt;string> | Yes | 需要从禁止列表中移除的域名后缀列表。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rulesFile | string | Yes | 指定了符合easylist通用语法的规则文件路径，应用需要有此文件的读权限。 |
| replace | boolean | Yes | true表示强制替换掉内置的默认规则，false表示设置的自定义规则将与内置规则共同工作。 |
