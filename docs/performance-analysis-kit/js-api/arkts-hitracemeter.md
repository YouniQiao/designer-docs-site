...
> [finishTrace()](arkts-performanceanalysis-hitracemeter-finishtrace-f.md#finishtrace) and  
> [traceByValue()](arkts-performanceanalysis-hitracemeter-tracebyvalue-f.md#tracebyvalue) APIs. By default, the trace output  
> level is **COMMERCIAL**.  
>  
