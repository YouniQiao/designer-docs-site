...
| [disableGwpAsanGrayscale](arkts-performanceanalysis-disablegwpasangrayscale-f.md#disablegwpasangrayscale-1) | Disables GWP-ASan. This API is used to cancel the custom configuration and restore the default parameter [GwpAsanOptions](arkts-performanceanalysis-gwpasanoptions-i.md#gwpasanoptions). |
