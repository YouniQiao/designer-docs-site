...
**Substitute:** ohos.hiviewdfx.hiAppEvent/hiAppEvent#addWatcher
...
| callback | AsyncCallback&lt;Array&lt;FaultLogInfo>> | Yes | Callback used to return the fault information array.  value is the fault information array obtained. If value is undefined, an exception occurs during  the information retrieval. In this case, an error string will be returned. |
