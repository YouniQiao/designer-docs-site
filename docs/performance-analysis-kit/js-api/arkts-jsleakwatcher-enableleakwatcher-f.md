...
| callback | Callback&lt;Array&lt;string>> | Yes | Callback used to receive the memory-leaked object returned by the  jsLeakWatcher.enableLeakWatcher API. You need to input an array object in the callback. Index 0 is  the name of the leak list file, whose extension is .jsleaklist. Index 1 is the name of the VM memory  snapshot file, whose extension is .rawheap. |
...
| configs | LeakWatcherConfig | Yes | LeakWatcherConfig object, which contains multiple configurable properties  for memory leak monitoring. Note: If the parameter type in the object is set to null or a false value, the  default value is used. |
| callback | Callback&lt;Array&lt;string>> | Yes | Callback used to receive the memory-leaked object returned by the  jsLeakWatcher.enableLeakWatcher API. You need to input an array object in the callback. Index 0 is  the name of the leak list file, whose extension is .jsleaklist. Index 1 is the name of the VM memory  snapshot file, whose extension is .rawheap. |
