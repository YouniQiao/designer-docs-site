...
**Substitute:** ohos.hiTraceMeter.finishTrace
...
| --- | --- | --- | --- |
| name | string | Yes | Indicates the task name. It must be the same with the {@code name} of startTrace. |
| taskId | number | Yes | The unique id used to distinguish the tasks and must be the same with the .  {@code taskId} of startTrace. |
