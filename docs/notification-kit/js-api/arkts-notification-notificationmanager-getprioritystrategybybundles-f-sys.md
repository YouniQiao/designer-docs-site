...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-lib-es5-promise-i.md)<Map<BundleOption, number>> | Promise used to return the key-value pair set of the application notification priority strategies. |
