...
> **NOTE**  
> This API is supported since API version 7 and deprecated since API version 9.You are advised to use [notificationManager.BundleOption](arkts-notification-notificationcommondef-bundleoption-i.md) instead.
