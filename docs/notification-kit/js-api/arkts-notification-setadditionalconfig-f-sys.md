...
| --- | --- | --- | --- |
| key | string | Yes | Additional configuration key. Currently, only **RING_TRUSTLIST_PKG** is supported,indicating that the application supports[custom ringtone](arkts-notification-notificationrequest-i.md#notificationrequest). |
