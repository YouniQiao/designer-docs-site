...
| callback | Callback&lt;CallAttributeOptions> | No | Indicates the callback to unsubscribe from  the callDetailsChange event. |
...
| callback | Callback&lt;CallEventOptions> | No | Indicates the callback to unsubscribe from the callEventChange event. |
...
| callback | Callback&lt;DisconnectedDetails> | No | Indicates the callback used to cancel  the registration monitoring for obtaining the call end reason. |
...
| callback | Callback&lt;MmiCodeResults> | No | Indicates the callback used to cancel getting mmicode registered listening. |
...
| callback | Callback&lt;AudioDeviceCallbackInfo> | No | Indicates the callback for getting the result of Current AudioDevice. |
...
| callback | Callback&lt;string> | No | Indicates the callback for getting the result of post-dial string. |
...
| callback | Callback&lt;ImsCallModeInfo> | No | Indicates the callback to unsubscribe from  the imsCallModeChange event. |
...
| callback | Callback&lt;CallSessionEvent> | No | Indicates the callback to unsubscribe from  the CallSessionEvent event. |
...
| callback | Callback&lt;PeerDimensionsDetail> | No | Indicates the callback to unsubscribe from  peerDimensionsChange event. |
...
| callback | Callback&lt;CameraCapabilities> | No | Indicates the callback to unsubscribe from  cameraCapabilitiesChange event. |
