...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-common-callback-i.md)<ImsRegInfo> | No | Indicates the callback for getting an instance of the {@link ImsRegInfo} class. |
