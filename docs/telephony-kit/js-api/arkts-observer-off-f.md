...
| callback | Callback&lt;NetworkState> | No | Indicates the callback for getting  an instance of the {@code NetworkState} class. |
...
| callback | Callback&lt;Array&lt;SignalInformation>> | No | Indicates the callback to unsubscribe from  the signalInfoChange event. |
...
| callback | Callback&lt;DataConnectionStateInfo> | No | Indicates the callback to unsubscribe  from the cellularDataConnectionStateChange event. |
...
| callback | Callback&lt;DataFlowType> | No | Indicates the callback to unsubscribe from  the cellularDataFlowChange event. |
...
| callback | Callback&lt;CallStateInfo> | No | Indicates the callback to  unsubscribe from the callStateChange event. |
...
| callback | Callback&lt;TelCallState> | No |  |
