...
| callback | Callback&lt;CallAttributeOptions> | Yes | Indicates the callback for getting the result of call details. |
...
| callback | Callback&lt;CallEventOptions> | Yes | Indicates the callback for getting the call event id. |
...
| callback | Callback&lt;DisconnectedDetails> | Yes | Indicates the callback for getting the call disconnection reason. |
...
| callback | Callback&lt;MmiCodeResults> | Yes | Indicates the callback for getting the result of MMI code. |
...
| callback | Callback&lt;AudioDeviceCallbackInfo> | Yes | Indicates the callback for getting the result of Current AudioDevice. |
...
| callback | Callback&lt;string> | Yes | Indicates the callback for getting the result of post-dial string. |
...
| callback | Callback&lt;ImsCallModeInfo> | Yes | Indicates the callback for  getting the result of ImsCallModeInfo details. |
...
| callback | Callback&lt;CallSessionEvent> | Yes | Indicates the callback for  getting the result of CallSessionEvent. |
...
| callback | Callback&lt;PeerDimensionsDetail> | Yes | Indicates the callback for  getting the result of PeerDimensionsDetail details. |
...
| callback | Callback&lt;CameraCapabilities> | Yes | Indicates the callback for  getting the result of CameraCapabilities details. |
