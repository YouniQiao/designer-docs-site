...
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;boolean> | Yes | The callback of hasCall. Returns {@code true} if at least one call is  not in the {@link CallState#CALL_STATE_IDLE} state; returns {@code false} otherwise. |
