...
**Inheritance:** MediaAlbumChangeRequestimplements: MediaChangeRequest.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| name | string | Yes | Album name to set.  Value range:1-255  Album name parameter specifications:  The album name contains 1 to 255 characters.  Invalid English characters, including:  \ /: ? "'` \| {} []  It is not allowed to name only. or..  English characters are case insensitive.  The album name must be unique. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| displayLevel | int | Yes | The level of display interface for portrait albums, such as homepage and more pages |
