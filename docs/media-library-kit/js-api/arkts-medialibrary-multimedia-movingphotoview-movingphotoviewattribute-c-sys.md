...
| Type | Description |
| --- | --- |
| [MovingPhotoViewAttribute](arkts-medialibrary-multimedia-movingphotoview-movingphotoviewattribute-c-sys.md) | @throws { BusinessError } 202 - Non-system applications are not allowed to use system APIs. |
