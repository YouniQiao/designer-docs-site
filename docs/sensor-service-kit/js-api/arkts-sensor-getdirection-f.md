...
**Substitute:** sensor.getOrientation(rotationMatrix:
...
| callback | AsyncCallback&lt;Array&lt;number>> | Yes | Callback used to return the rotation angle around the z, x, and  y axes, in degrees. |
