...
**Substitute:** sensor.getAngleVariation(currentRotationMatrix:
...
| callback | AsyncCallback&lt;Array&lt;number>> | Yes | Callback used to return the angle change around the z, x, and y  axes, in degrees. |
