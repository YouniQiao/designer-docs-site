...
**Substitute:** vibrator.startVibration(effect:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| effectId | EffectId | Yes | Effect ID. The value is a string of a maximum of 64 characters. If the length  exceeds 64 characters, the first 64 characters are used. You are advised to check whether the effect ID is  supported. |
