...
| [off](arkts-input-off-f-sys.md#off-1) | Deregisters the listener for screen hopping status changes. This API uses an asynchronous callback to return theresult. |
