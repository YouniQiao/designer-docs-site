...
**Substitute:** inputMethodEngine.InputClient
...
**Substitute:** inputMethodEngine.InputClient.deleteBackward(length:
...
**Substitute:** inputMethodEngine.InputClient.deleteForward(length:
...
**Substitute:** inputMethodEngine.InputClient.getBackward(length:
...
**Substitute:** inputMethodEngine.InputClient.getEditorAttribute(callback:
...
**Substitute:** inputMethodEngine.InputClient.getForward(length:
...
**Substitute:** inputMethodEngine.InputClient.insertText(text:
...
**Substitute:** inputMethodEngine.InputClient.sendKeyFunction(action:
