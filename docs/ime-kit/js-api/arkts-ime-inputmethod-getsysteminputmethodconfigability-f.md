...
<a id="getsysteminputmethodconfigability"></a>
## getSystemInputMethodConfigAbility
...
| Type | Description |
| --- | --- |
| [ElementName](../../apis-ability-kit/arkts-apis/arkts-ability-bundlemanager-elementname-t.md) | the information of system input method config ability. |
