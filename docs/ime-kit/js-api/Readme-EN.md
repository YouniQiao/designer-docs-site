...
- [@ohos.inputMethod](arkts-inputmethod.md)
  ...
  - [getCurrentInputMethodSubtype(system api)](arkts-inputmethod-getcurrentinputmethodsubtype-f-sys.md)<!--DelEnd-->
  ...
  - [getCurrentInputMethod(system api)](arkts-inputmethod-getcurrentinputmethod-f-sys.md)<!--DelEnd-->
  - [getSetting](arkts-inputmethod-getsetting-f.md)
  - [switchInputMethod](arkts-inputmethod-switchinputmethod-f.md)<!--Del-->
  - [switchInputMethod(system api)](arkts-inputmethod-switchinputmethod-f-sys.md)<!--DelEnd-->
  - [offAttachmentDidFail](arkts-inputmethod-offattachmentdidfail-f.md)<!--Del-->
  - [switchInputMethodWithUserId(system api)](arkts-inputmethod-switchinputmethodwithuserid-f-sys.md)<!--DelEnd-->
  - [getSystemInputMethodConfigAbility](arkts-inputmethod-getsysteminputmethodconfigability-f.md)<!--Del-->
  - [getSystemInputMethodConfigAbility(system api)](arkts-inputmethod-getsysteminputmethodconfigability-f-sys.md)<!--DelEnd-->
  - [getDefaultInputMethod](arkts-inputmethod-getdefaultinputmethod-f.md)<!--Del-->
  - [getDefaultInputMethod(system api)](arkts-inputmethod-getdefaultinputmethod-f-sys.md)<!--DelEnd-->
  ...
  - [ImeChangeWithUserIdCallback(system api)](arkts-inputmethod-imechangewithuseridcallback-t-sys.md)<!--DelEnd-->
...
- [@ohos.inputMethodEngine](arkts-inputmethodengine.md)
  ...
  - [SizeUpdateCallback(system api)](arkts-inputmethodengine-sizeupdatecallback-t-sys.md)<!--DelEnd-->
  ...
  - [FluidLightMode(system api)](arkts-inputmethodengine-fluidlightmode-e-sys.md)<!--DelEnd-->
...
- [@ohos.inputMethodSystemPanelManager](arkts-inputmethodsystempanelmanager.md)<!--Del-->
  - [offSystemPrivateCommand(system api)](arkts-inputmethodsystempanelmanager-offsystemprivatecommand-f-sys.md)<!--DelEnd--><!--Del-->
  - [offSystemPanelStatusChange(system api)](arkts-inputmethodsystempanelmanager-offsystempanelstatuschange-f-sys.md)<!--DelEnd--><!--Del-->
  - [connectSystemChannel(system api)](arkts-inputmethodsystempanelmanager-connectsystemchannel-f-sys.md)<!--DelEnd--><!--Del-->
  - [sendPrivateCommand(system api)](arkts-inputmethodsystempanelmanager-sendprivatecommand-f-sys.md)<!--DelEnd--><!--Del-->
  - [onSystemPanelStatusChange(system api)](arkts-inputmethodsystempanelmanager-onsystempanelstatuschange-f-sys.md)<!--DelEnd--><!--Del-->
  - [onSystemPrivateCommand(system api)](arkts-inputmethodsystempanelmanager-onsystemprivatecommand-f-sys.md)<!--DelEnd--><!--Del-->
  - [SystemPanelStatus(system api)](arkts-inputmethodsystempanelmanager-systempanelstatus-i-sys.md)<!--DelEnd--><!--Del-->
  - [CommandDataType(system api)](arkts-inputmethodsystempanelmanager-commanddatatype-t-sys.md)<!--DelEnd--><!--Del-->
  - [InputMethodInputType(system api)](arkts-inputmethodsystempanelmanager-inputmethodinputtype-e-sys.md)<!--DelEnd-->