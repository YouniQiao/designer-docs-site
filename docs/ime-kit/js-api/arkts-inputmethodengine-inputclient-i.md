...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;EditorAttribute \| null> | Yes | the callback of getEditorAttribute. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;int> | Yes | Callback used to return the result. If the text index is obtained,  err is undefined; otherwise, err is an error object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| direction | int | Yes | Direction in which the cursor moves.  - 1: upward.  - 2: downward.  - 3: leftward.  - 4: rightward. which cannot be less than 0. |
...
| callback | Callback&lt;AttachOptions> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;AttachOptions> | Yes | the callback called when the attach options changed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| action | int | Yes | Action of the function key.  - 0: invalid key.  - 1: confirm key (Enter key). |
| callback | AsyncCallback&lt;boolean> | Yes | Callback used to return the result. If the operation is successful,  err is undefined and data is true. Otherwise, err is an error object. |
