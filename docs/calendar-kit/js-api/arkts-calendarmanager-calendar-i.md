...
- API version23 and later: ohos.permission.WRITE_CALENDAR or ohos.permission.WRITE_WHOLE_CALENDAR
...
**Atomic service API:** From API version 21 this API can be used in atomic services.
...
- API version23 and later: ohos.permission.READ_CALENDAR or ohos.permission.READ_WHOLE_CALENDAR
