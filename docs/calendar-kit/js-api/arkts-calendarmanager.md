...
| Name | Description |
| --- | --- |
| [getCalendarManager](arkts-calendar-calendarmanager-getcalendarmanager-f.md#getcalendarmanager-1) | Obtains a CalendarManager object based on the context. |
