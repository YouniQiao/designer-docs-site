...
| callback | AsyncCallback&lt;WebSocketOpenInfo> | No |  |
...
| callback | AsyncCallback&lt;CloseResult> | No | the callback used to return the result.  close indicates the close error code and reason indicates the error code description. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;OpenResult> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;WebSocketOpenInfo> | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;CloseResult> | No |  |
...
| --- | --- | --- | --- |
| type | 'close' | Yes | event indicating that a WebSocket connection has been closed. |
| callback | AsyncCallback&lt;CloseResult> | Yes | the callback used to return the result.  close indicates the close error code and reason indicates the error code description. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;OpenResult> | Yes | the callback used to return the result. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;WebSocketOpenInfo> | Yes | the callback used to return the result. |
