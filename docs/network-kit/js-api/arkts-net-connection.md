...
| [factoryReset](arkts-network-factoryreset-f-sys.md#factoryreset-1) | factory reset network settings To invoke this method, you must have the {@code ohos.permission.CONNECTIVITY_INTERNAL} permission. |
