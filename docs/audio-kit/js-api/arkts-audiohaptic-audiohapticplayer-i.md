...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;audio.InterruptEvent> | No | Callback used to listen for audio interrupt info. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;audio.InterruptEvent> | Yes | Callback used to listen for audio interrupt info. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | Callback&lt;void> | Yes | Callback used to listen for the playback end of stream. |
