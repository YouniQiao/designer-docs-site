...
| --- | --- | --- | --- |
| category | int | Yes | tone category. This parameter can be one of {@link TONE_CATEGORY_RINGTONE},  {@link TONE_CATEGORY_TEXT_MESSAGE}, {@link TONE_CATEGORY_NOTIFICATION}, {@link TONE_CATEGORY_ALARM}.  In addition, this parameter can be result of OR logical operator of these constants. |
