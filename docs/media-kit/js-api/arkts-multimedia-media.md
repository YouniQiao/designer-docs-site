...
| [createVideoRecorder](arkts-media-createvideorecorder-f-sys.md#createvideorecorder-1) | The maintenance of this interface has been stopped since version api 9. Please use AVRecorderCreates an VideoRecorder instance. |
| [createVideoRecorder](arkts-media-createvideorecorder-f-sys.md#createvideorecorder-2) | The maintenance of this interface has been stopped since version api 9. Please use AVRecorderCreates an VideoRecorder instance. |
...
| [AudioPlayer](arkts-media-audioplayer-i.md) | AudioPlayer is a class for audio playback management. It provides APIs to manage and play audio. Before calling anyAPI in AudioPlayer, you must use [createAudioPlayer()](arkts-media-createaudioplayer-f.md#createaudioplayer-1) to create an AudioPlayer instance. |
...
| [OnSeiMessageHandle](arkts-media-onseimessagehandle-t.md) | Describes the handle used to obtain SEI messages. This is used when in subscriptions to SEI message events, and thecallback returns detailed SEI information. |
