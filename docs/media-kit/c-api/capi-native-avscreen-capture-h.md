...
| Type | Description |
| -- | -- |
| [OH_NativeBuffer*](../ArkGraphics2D/capi-nativewindow-oh-nativebuffer.md) | OH_NativeBuffer object if the operation is successful. The application can call the APIs provided by the<br> OH_NativeBuffer object to obtain information such as the video buffer and resolution. |
