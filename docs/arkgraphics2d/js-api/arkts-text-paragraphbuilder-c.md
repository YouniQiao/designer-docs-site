...
| --- | --- | --- | --- |
| placeholderSpan | PlaceholderSpan | Yes | 定义了占位符的尺寸、对齐方式、基线类型以及基线偏移量。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| symbolId | int | Yes | 要设置的symbol码位，十六进制，当前支持的取值范围为：0xF0000-0xF0C97。可设置的symbol码位（即列表视图下的unicode值）请见  [主题图标库](https://developer.huawei.com/consumer/cn/design/harmonyos-symbol/)。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| paragraphStyle | ParagraphStyle | Yes | 段落样式。 |
| fontCollection | FontCollection | Yes | 字体集。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| textStyle | TextStyle | Yes | 包含了对文本的各种视觉属性的定义，如字体、字号、颜色、字重、字间距、行距、装饰（如下划线、删除线）、文本阴影等。 |
