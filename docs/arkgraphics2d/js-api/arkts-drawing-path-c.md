...
| startAngle | double | Yes | 弧的起始角度，单位为度，0度为x轴正方向，该参数为浮点数。 |
| sweepAngle | double | Yes | 扫描角度，单位为度。正数表示顺时针方向，负数表示逆时针方向，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | double | Yes | 表示圆心的x轴坐标，该参数为浮点数。 |
| y | double | Yes | 表示圆心的y轴坐标，该参数为浮点数。 |
| radius | double | Yes | 表示圆形的半径，该参数为浮点数，小于等于0时不会有任何效果。 |
| pathDirection | PathDirection | No | 表示路径方向，默认为顺时针方向。 |
...
| start | int | Yes | 表示椭圆初始点的索引，0，1，2，3分别对应椭圆的上端点，右端点，下端点，左端点，该参数为不小于0的整数，大于等于4时会对4取余。 |
| pathDirection | PathDirection | No | 表示路径方向，默认为顺时针方向。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | Path | Yes | 表示源路径对象。 |
| matrix | Matrix \| null | No | 表示矩阵对象，默认为单位矩阵。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| points | Array&lt;common2D.Point> | Yes | 坐标点数组。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rect | common2D.Rect | Yes | 向路径中添加的矩形轮廓。 |
| pathDirection | PathDirection | No | 表示路径方向，默认为顺时针方向。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| roundRect | RoundRect | Yes | 圆角矩形对象。 |
| pathDirection | PathDirection | No | 表示路径方向，默认为顺时针方向。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| acceptableError | number | Yes | 表示路径上每条线段的可接受误差。该参数为浮点数，不应小于0，当参数小于0时报错。 |
...
| Type | Description |
| --- | --- |
| Array&lt;double> | - Returns with the array containing point components.  There are three components for each point:  1. Fraction along the length of the path that the point resides [0.0, 1.0].  2. The x coordinate of the point.  3. The y coordinate of the point. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x1 | double | Yes | 矩形左上角的x坐标，该参数为浮点数。 |
| y1 | double | Yes | 矩形左上角的y坐标，该参数为浮点数。 |
| x2 | double | Yes | 矩形右下角的x坐标，该参数为浮点数。 |
| y2 | double | Yes | 矩形右下角的y坐标，该参数为浮点数。 |
| startDeg | double | Yes | 起始的角度。角度的起始方向（0°）为x轴正方向。 |
| sweepDeg | double | Yes | 扫描的度数，为正数时顺时针扫描，为负数时逆时针扫描。实际扫描的度数为该入参对360取模的结果。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| str | string | Yes | SVG格式的字符串，用于描述绘制路径。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| ctrlX | double | Yes | 控制点的x坐标，该参数为浮点数。 |
| ctrlY | double | Yes | 控制点的y坐标，该参数为浮点数。 |
| endX | double | Yes | 目标点的x坐标，该参数为浮点数。 |
| endY | double | Yes | 目标点的y坐标，该参数为浮点数。 |
| weight | double | Yes | 表示曲线权重，决定了曲线的形状。值越大，曲线越接近控制点。小于等于0时，效果与[lineTo]drawing.Path.lineTo相同；值为1时，效果与  [quadTo]drawing.Path.quadTo相同。该参数为浮点数。 |
...
判断指定坐标点是否被路径包含，判定是否被路径包含的规则参考[PathFillType](arkts-drawing-pathfilltype-e.md#PathFillType)。
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | double | Yes | x轴上坐标点，该参数必须为浮点数。 |
| y | double | Yes | y轴上坐标点，该参数必须为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| ctrlX1 | double | Yes | 第一个控制点的x坐标，该参数为浮点数。 |
| ctrlY1 | double | Yes | 第一个控制点的y坐标，该参数为浮点数。 |
| ctrlX2 | double | Yes | 第二个控制点的x坐标，该参数为浮点数。 |
| ctrlY2 | double | Yes | 第二个控制点的y坐标，该参数为浮点数。 |
| endX | double | Yes | 目标点的x坐标，该参数为浮点数。 |
| endY | double | Yes | 目标点的y坐标，该参数为浮点数。 |
...
| Type | Description |
| --- | --- |
| Array&lt;double> | 类型为浮点数（取值范围为非负数）。取值为0.0时，该控制点完全无效，曲线不经过此点，曲线实际由其余控制点定义。取值为1.0时，该控制点对应的曲线变为标准贝塞尔曲线，此时权重  不产生额外形变效果。取值大于1时，权重值越大，曲线越靠近该控制点；小于1.0但大于0.0时，曲线则相对远离该控制点。 |
...
| Type | Description |
| --- | --- |
| PathFillType | Returns the pathFillType. |
...
| --- | --- | --- | --- |
| forceClosed | boolean | Yes | 表示是否按照闭合路径测量，true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。 |
| distance | double | Yes | 表示与路径起始点的距离，小于0时会被视作0，大于路径长度时会被视作路径长度。该参数为浮点数。 |
| matrix | Matrix | Yes | 矩阵对象，用于存储得到的矩阵。 |
| flags | PathMeasureMatrixFlags | Yes | 矩阵信息维度枚举。 |
...
| Type | Description |
| --- | --- |
| PathIterator | Indicates the pointer to an pathIterator object. |
...
获取路径的点数据。 在路径（path）图元中，点数据以数值序列的形式存在，与动词verb指令一一对应，用来精确指定绘图操作的几何坐标位置。 点数据的主要类型包括： 终点坐标：与[moveTo]drawing.Path.moveTo、[lineTo]drawing.Path.lineTo等指令配合，定义线段或移动的目标位置。 控制点坐标：与曲线指令配合，用于定义贝塞尔曲线的形状（如三次曲线需要两个控制点和一个终点）。 闭合点：通常不单独提供坐标，由[close]drawing.Path.close指令隐式使用路径起点。
...
| --- | --- | --- | --- |
| forceClosed | boolean | Yes | 表示是否按照闭合路径测量，true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。 |
| start | double | Yes | 表示与路径起始点的距离，距离路径起始点start距离的位置即为截取路径片段的起始点，小于0时会被视作0，大于等于stop时会截取失败。该参数为浮点数。 |
| stop | double | Yes | 表示与路径起始点的距离，距离路径起始点stop距离的位置即为截取路径片段的终点，小于等于start时会截取失败，大于路径长度时会被视作路径长度。该参数为浮点数。 |
| startWithMoveTo | boolean | Yes | 表示是否在目标路径执行[moveTo]drawing.Path.moveTo移动到截取路径片段的起始点位置。true表示执行，false  表示不执行。 |
| dst | Path | Yes | 目标路径，截取成功时会将得到的路径片段追加到目标路径上，截取失败时不做改变。 |
...
获取路径的指令数据。 在路径（path）图元中，指令数据verb用于描述路径构造过程中的基本绘图动作。 指令数据以枚举的形式存在，每个取值对应一种几何操作类型，例如： [moveTo]drawing.Path.moveTo：将当前绘图点移至指定坐标，不产生线段。 [lineTo]drawing.Path.lineTo：从当前点向指定点绘制直线段。 [close]drawing.Path.close：将当前点与路径起点相连，形成封闭区域。
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| other | Path | Yes | 表示另一条路径对象。 |
| weight | double | Yes | 表示插值权重，必须在[0.0, 1.0]范围内。该参数为浮点数。 |
| interpolatedPath | Path | Yes | 表示用于存储插值结果的目标路径对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | double | Yes | 目标点的x轴坐标，该参数为浮点数。 |
| y | double | Yes | 目标点的y轴坐标，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | double | Yes | 起始点的x轴坐标，该参数为浮点数。 |
| y | double | Yes | 起始点的y轴坐标，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dx | number | Yes | x轴方向偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy | number | Yes | y轴方向偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | Path | Yes | 路径对象，用于与当前路径合并。 |
| pathOp | PathOp | Yes | 路径操作类型枚举。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| ctrlX | double | Yes | 控制点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| ctrlY | double | Yes | 控制点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| endX | double | Yes | 目标点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| endY | double | Yes | 目标点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| weight | double | Yes | 表示曲线的权重，决定了曲线的形状，越大越接近控制点。若小于等于0则等同于使用[rLineTo]drawing.Path.rLineTo添加一条到结束点的线段  ，若为1则等同于[rQuadTo]drawing.Path.rQuadTo，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| ctrlX1 | double | Yes | 第一个控制点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| ctrlY1 | double | Yes | 第一个控制点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| ctrlX2 | double | Yes | 第二个控制点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| ctrlY2 | double | Yes | 第二个控制点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| endX | double | Yes | 目标点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| endY | double | Yes | 目标点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dx | double | Yes | 目标点相对于当前路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy | double | Yes | 目标点相对于当前路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dx | double | Yes | 路径新起始点相对于当前路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy | double | Yes | 路径新起始点相对于当前路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dx1 | double | Yes | 控制点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy1 | double | Yes | 控制点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| dx2 | double | Yes | 目标点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy2 | double | Yes | 目标点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pathFillType | PathFillType | Yes | 表示路径填充规则。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | double | Yes | 指定点的x轴坐标，该参数为浮点数。0表示坐标原点，负数表示位于坐标原点左侧，正数表示位于坐标原点右侧。 |
| y | double | Yes | 指定点的y轴坐标，该参数为浮点数。0表示坐标原点，负数表示位于坐标原点上侧，正数表示位于坐标原点下侧。 |
