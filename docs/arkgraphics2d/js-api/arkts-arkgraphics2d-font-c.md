...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| glyphs | Array&lt;number&gt; | Yes | Glyph array, which can be generated by[textToGlyphs](arkts-arkgraphics2d-font-c.md#texttoglyphs-1). |
...
| byteLength | number | Yes | Length of the outline path, which is obtained based on the minimum value betweenthe passed value of **byteLength** and the actual text byte size. |
...
| byteLength | number | Yes | The length of the text in bytes.which is obtained based on the minimum value between the passed value of byteLength andthe actual text byte size. |
| x | number | Yes | X coordinate of the text in the drawing area, with the origin as the start point. |
| y | number | Yes | Y coordinate of the text in the drawing area, with the origin as the start point. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** means that the baselines are requested to be snapped topixels, and **false** means the opposite. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** means that the bitmaps are used, and **false** means theopposite. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** means that the bold effect is set, and **false** means theopposite. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** means that linear scaling is used, and **false** means theopposite. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** means that sub-pixel rendering is used, and **false** meansthe opposite. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** means that the theme font is followed, and **false** meansthe opposite. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isBaselineSnap | boolean | Yes | Check result. The value **true** means to request that baselines be snappedto pixels, and **false** means the opposite. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| edging | FontEdging | Yes | Font edging effect. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| isEmbeddedBitmaps | boolean | Yes | Whether to use bitmaps in the font. The value **true** means to usebitmaps in the font, and **false** means the opposite. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| hinting | FontHinting | Yes | Font hinting effect. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| skewX | number | Yes | Horizontal skew factor. A positive number means a skew to the left, and a negativenumber means a skew to the right. The value is a floating point number. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| typeface | Typeface | Yes | Typeface style (including attributes such as font name, weight, and italic). |
...
| glyphCount | number | No | Number of glyphs represented by the text. The value must be the same as thevalue obtained from [countText](arkts-arkgraphics2d-font-c.md#counttext-1). The default value is the number of charactersin the text string. The value is an integer. |
