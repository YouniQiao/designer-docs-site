...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| glyphs | Array&lt;number&gt; | Yes | Glyph array, which can be generated by [textToGlyphs](arkts-arkgraphics2d-drawing-font-c.md#texttoglyphs-1). |
...
<a id="gettextpathwithfallback"></a>
