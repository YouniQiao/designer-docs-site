...
| --- | --- | --- | --- |
| data | Pkcs12Data | Yes | PKCS #12 data object to be packed. |
| config | Pkcs12CreationConfig | Yes | Configuration for creating the PKCS #12 file. |

**Return value:**

| Type | Description |
| --- | --- |
| Promise&lt;Uint8Array&gt; | Promise used to return the PKCS #12 file created, in DER format. |
