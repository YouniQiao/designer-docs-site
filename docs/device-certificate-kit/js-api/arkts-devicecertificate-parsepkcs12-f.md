...
| config | Pkcs12ParsingConfig | Yes | Configuration for parsing the file. |

**Return value:**

| Type | Description |
| --- | --- |
| Pkcs12Data | Data parsed from the .p12 file. |
...
| password | string | Yes | PKCS #12 password. |

**Return value:**

| Type | Description |
| --- | --- |
| Promise&lt;Pkcs12Data&gt; | Promise used to return the certificate, private key, and other certificates parsedfrom the PKCS #12 file. The private key in the returned **Pkcs12Data** is encoded in PEM format. |
