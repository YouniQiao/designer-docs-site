...
| [createPkcs12](arkts-devicecertificate-createpkcs12-f.md#createpkcs12-1) | Creates PKCS #12 data. This API uses a promise to return the result. |
| [createPkcs12Sync](arkts-devicecertificate-createpkcs12sync-f.md#createpkcs12sync-1) | Creates PKCS #12 data. This API returns the result synchronously. |
...
| [parsePkcs12](arkts-devicecertificate-parsepkcs12-f.md#parsepkcs12-1) | Parses a .p12 file. |
| [parsePkcs12](arkts-devicecertificate-parsepkcs12-f.md#parsepkcs12-2) | Parses a PKCS #12 file. This API uses a promise to return the result. |
...
| [CmsGeneratorOptions](arkts-devicecertificate-cmsgeneratoroptions-i.md) | Represents the configuration for generating the CMS signing result. |
| [CmsKeyAgreeRecipientInfo](arkts-devicecertificate-cmskeyagreerecipientinfo-i.md) | Represents KeyAgree recipient information encapsulated in CMS data. |
| [CmsKeyTransRecipientInfo](arkts-devicecertificate-cmskeytransrecipientinfo-i.md) | Represents KeyTrans recipient information encapsulated in CMS data. |
| [CmsParser](arkts-devicecertificate-cmsparser-i.md) | Verifies and decapsulates signed and encapsulated messages in CMS format. &gt; **NOTE** &gt; &gt; PKCS #7 is a standard syntax for storing signed or encrypted data. CMS is an extension of PKCS #7. PKCS #7 &gt; supports data types including data, signature data, envelope data, signature and envelope data, message digest &gt; data, and encrypted data. It is often used to protect data integrity and confidentiality. |
| [CmsRecipientInfo](arkts-devicecertificate-cmsrecipientinfo-i.md) | Represents recipient information encapsulated in CMS data. &gt; **NOTE** &gt; &gt; At least one recipient needs to be set. |
...
| [EncodingBlob](arkts-devicecertificate-encodingblob-i.md) | Defines a certificate binary array in encoding format. |
| [GeneralName](arkts-devicecertificate-generalname-i.md) | Represents the CN information of a certificate. |
| [PbesParams](arkts-devicecertificate-pbesparams-i.md) | Enumerates PBES algorithm parameters. Currently, only PBES2 is supported. |
...
| [Pkcs12Data](arkts-devicecertificate-pkcs12data-i.md) | Represents data of the parsed PKCS #12 (.p12) file. |
| [Pkcs12ParsingConfig](arkts-devicecertificate-pkcs12parsingconfig-i.md) | Represents the configuration for parsing .p12 files. |
...
| [X509CRLEntry](arkts-devicecertificate-x509crlentry-i.md) | Provides APIs for operating on revoked certificates. |
...
| [X509Crl](arkts-devicecertificate-x509crl-i.md) | Provides APIs for X.509 certificate CRL operations. &gt; **NOTE** &gt; &gt; This API is supported since API version 9 and deprecated since API version 11. Use [X509CRL()](arkts-devicecertificate-x509crl-i.md#x509crl) &gt; instead. |
| [X509CrlEntry](arkts-devicecertificate-x509crlentry-i.md) | Provides APIs for operating on revoked certificates. &gt; **NOTE** &gt; &gt; This API is supported since API version 9 and deprecated since API version 11. Use &gt; [X509CRLEntry()](arkts-devicecertificate-x509crlentry-i.md#x509crlentry) instead. |
...
| [CertRevocationFlag](arkts-devicecertificate-certrevocationflag-e.md) | Enumerates the certificate revocation flag. |
...
| [CmsFormat](arkts-devicecertificate-cmsformat-e.md) | Enumerates the CMS signature formats. |
...
| [CmsRecipientEncryptionAlgorithm](arkts-devicecertificate-cmsrecipientencryptionalgorithm-e.md) | Enumerates the symmetric algorithms of the CMS recipient. |
...
| [EncodingBaseFormat](arkts-devicecertificate-encodingbaseformat-e.md) | Enumerates the CSR encoding formats. |
...
| [GeneralNameType](arkts-devicecertificate-generalnametype-e.md) | Enumerates the types of the common name (CN), which uniquely identifies the subject of the certificate. |
...
| [Pkcs12MacDigestAlgorithm](arkts-devicecertificate-pkcs12macdigestalgorithm-e.md) | Enumerates the PKCS #12 MAC digest algorithms. |
