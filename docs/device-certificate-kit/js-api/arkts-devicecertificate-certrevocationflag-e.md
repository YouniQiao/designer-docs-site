...
The crls parameter of [X509CertRevokedParams](arkts-devicecertificate-x509certrevokedparams-i.md) is used. If no matching CRL is found
and allowDownloadCrl of [X509CertRevokedParams](arkts-devicecertificate-x509certrevokedparams-i.md) is set to true, the CDP extension
...
If no matching OCSP response is found in [X509CertRevokedParams](arkts-devicecertificate-x509certrevokedparams-i.md) and
allowOcspCheckOnline of [X509CertRevokedParams](arkts-devicecertificate-x509certrevokedparams-i.md) is set to true, the system
