...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-lib-es5-promise-i.md)<HuksHandle> | Promise that returns **HuksResult**. The handle of the **HuksHandle** returns the handle generated by the initialization operation. |
