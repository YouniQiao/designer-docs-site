...
表示错误码的枚举以及对应的错误信息，错误码表示错误类型，错误信息展示错误详情。 关于错误码的具体信息，可在[通用错误码](docroot://reference/errorcode-universal.md)和 [HUKS错误码](docroot://reference/apis-universal-keystore-kit/errorcode-huks.md)中查看。
