...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-lib-es5-promise-i.md)<HuksSessionHandle> | Promise that returns **HuksSessionHandle**. The handle of **HuksSessionHandle** is the handle generated by **initSession**. |
