...
| params | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<HuksExternalCryptoParam> | No | Parameters to be passed during the operation.<br>You can specify [HUKS_EXT_CRYPTO_TAG_ABILITY_NAME](arkts-universalkeystore-huksexternalcrypto-huksexternalcryptotagtype-e.md) in the **params** parameter to unregister the corresponding **cryptoExtensionAbility** based on the bundle name,**providerName**, and **abilityName**.<br>If [HUKS_EXT_CRYPTO_TAG_ABILITY_NAME](arkts-universalkeystore-huksexternalcrypto-huksexternalcryptotagtype-e.md) is not specified in the **params** parameter or the **params** parameter is not passed, all providers under the corresponding **providerName** are unregistered. |
