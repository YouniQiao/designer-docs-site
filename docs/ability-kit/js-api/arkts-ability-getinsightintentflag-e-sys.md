...
Used to query all intent information (except entities) in [InsightIntentInfo](arkts-ability-insightintentinfo-i-sys.md#insightintentinfo). To query entities information, use **GET_ENTITY_INFO**.
...
Used to query brief intent information in [InsightIntentInfo](arkts-ability-insightintentinfo-i-sys.md#insightintentinfo).
...
Used to query [EntityInfo](arkts-ability-entityinfo-i-sys.md#entityinfo). It must be used together with **GET_FULL_INSIGHT_INTENT** or **GET_SUMMARY_INSIGHT_INTENT**. Example usage: `GET_FULL_INSIGHT_INTENT | GET_ENTITY_INFO`.
