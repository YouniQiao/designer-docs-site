...
**Inheritance:** UIAbilityContextextends: Context.
...
| --- | --- | --- | --- |
| abilityResult | AbilityResult | Yes | 包含目标方返回给拉起方的结果。 |
| requestCode | string | Yes | 通过  [startAbilityForResult]UIAbilityContext.startAbilityForResult(want: Want, callback: AsyncCallback)  或[openLink](arkts-uiabilitycontext-c.md#openLink)拉起目标方Ability且需要目标方返回结果时，系统生成的用于标识本次调用的requestCode。该值可以通过want中的  [CALLER_REQUEST_CODE]./../@ohos.app.ability.wantConstant:wantConstant字段获取。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 连接  [AppServiceExtensionAbility](docroot://reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md)  的Want信息。 |
| callback | ConnectOptions | Yes | ConnectOptions类型的回调函数，返回服务连接成功、连接失败、断开的信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 连接ServiceExtensionAbility的Want信息。 |
| options | ConnectOptions | Yes | 回调对象，返回服务连接成功、连接失败、断开的信息。 |
...
| accountId | int | Yes | 系统账号的账号ID，可以通过  [getOsAccountLocalId]./../@ohos.account.osAccount:osAccount.AccountManager.getOsAccountLocalId(callback: AsyncCallback)  接口获取。 |
| options | ConnectOptions | Yes | 与ServiceExtensionAbility建立连接后回调函数的实例。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 连接UIServiceExtensionAbility的必要信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| connection | long | Yes | 在  [connectAppServiceExtensionAbility](arkts-uiabilitycontext-c.md#connectAppServiceExtensionAbility)返回的连接id。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| connection | long | Yes | 连接的ServiceExtensionAbility的标识id，即  [connectServiceExtensionAbility](arkts-uiabilitycontext-c.md#connectServiceExtensionAbility)返回的connectionId。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| proxy | UIServiceProxy | Yes | [connectUIServiceExtensionAbility](arkts-uiabilitycontext-c.md#connectUIServiceExtensionAbility)执行返回的Proxy。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当通知系统UIAbility对应的窗口内容已经绘制完成的操作成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| result | AsyncCallback&lt;dialogRequest.RequestResult> | Yes | 回调函数，当启动一个支持模态弹框的ServiceExtensionAbility成功，err中code为0，  data为模态弹框请求结果；否则err会返回对应的错误码和错误信息。 |
...
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当拉起UIExtension成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | Want类型参数，传入需要启动的UIAbility的信息，校验bundleName、abilityName。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| localStorage | LocalStorage | Yes | 用于恢复window stage的存储数据。 |
...
| icon | image.PixelMap | Yes | 新的图标。建议图标大小为512px512px。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| colorMode | ConfigurationConstant.ColorMode | Yes | 设置颜色模式，包括: - COLOR_MODE_DARK：深色模式 - COLOR_MODE_LIGHT：浅色  模式 - COLOR_MODE_NOT_SET：不设置（跟随系统或应用） |
...
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当设置UIAbility任务的流转状态成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当设置当前UIAbility在任务中显示的图标成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当设置UIAbility在多任务界面中显示的名称成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| scenarios | int | Yes | 取值范围请参考[Scenarios]./../@ohos.app.ability.contextConstant:contextConstant.Scenarios。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 启动UIAbility的必要信息。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当接口调用成功，err中code为0，message为空字符串；否则err会返回对应的错误码和错误信息。 |
...
| --- | --- | --- | --- |
| want | Want | Yes | 启动UIAbility的必要信息。 |
| options | StartOptions | Yes | 启动UIAbility所携带的参数。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当接口调用成功，err中code为0，message为空字符串；否则err会返回对应的错误码和错误信息。 |
...
| --- | --- | --- | --- |
| want | Want | Yes | 启动UIAbility的Want信息。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当接口调用成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| --- | --- | --- | --- |
| want | Want | Yes | 启动UIAbility的Want信息。 |
| options | StartOptions | No | 启动UIAbility所携带的参数。 |
...
- API version9  to  10: ohos.permission.ABILITY_BACKGROUND_COMMUNICATION

- API version11 and later: ohos.permission.DISTRIBUTED_DATASYNC
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 传入需要启动的UIAbility信息，包含abilityName、moduleName、bundleName、deviceId、parameters（可选）。将parameters中的'  ohos.aafwk.param.callAbilityToForeground'配置为true可将UIAbility拉起到前台；否则表示将UIAbility拉起到后台。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 传入需要启动的UIAbility的信息，包含abilityName、moduleName、bundleName、deviceId(可选)、parameters(可选)，其中deviceId缺省或  为空表示启动本地UIAbility，parameters缺省或为空表示后台启动UIAbility。 |
| accountId | int | Yes | 系统账号的账号ID，-1表示当前活动用户，可以通过  [getOsAccountLocalId]./../@ohos.account.osAccount:osAccount.AccountManager.getOsAccountLocalId(callback: AsyncCallback)  接口获取。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | string | Yes | 启动的UIExtensionAbility类型，取值详见  [通过startAbilityByType接口拉起垂类面板](docroot://application-models/start-intent-panel.md#匹配规则)。 |
| wantParam | Record&lt;string, Object> | Yes | 表示扩展参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 启动Ability的必要信息。 |
| callback | AsyncCallback&lt;AbilityResult> | Yes | 回调函数，当接口调用成功，err中code为0，data为被拉起方退出时的结果码和数据；否则err会返回对应的错误码和错误信息。 |
...
| want | Want | Yes | 启动UIAbility的Want信息。 |
| accountId | int | Yes | 系统账号的账号ID，可以通过  [getOsAccountLocalId]@ohos.account.osAccount:osAccount.AccountManager.getOsAccountLocalId(callback: AsyncCallback)  接口获取。 |
| callback | AsyncCallback&lt;AbilityResult> | Yes | 回调函数，当接口调用成功，err中code为0，data为被拉起的UIAbility销毁时的结果码和数据；否则err会返回对应的错误码和错  误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 启动  [AppServiceExtensionAbility](docroot://reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md)  的Want信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 需要启动UIAbility的Want信息。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当接口调用成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 启动Ability的必要信息。只支持  [显式启动](docroot://application-models/explicit-implicit-want-mappings.md#显式want匹配原理)，不支持  [隐式启动](docroot://application-models/explicit-implicit-want-mappings.md#隐式want匹配原理)。 |
| specifiedFlag | string | Yes | UIAbility的ID。此ID不得与任何已运行的ID重复  - 开发者自定义的UIAbility标识。该标识不能与已启动的UIAbility标识相同，否则将返回错误。 说明： 当通过该接口拉起启动模式为  [specified](docroot://application-models/uiability-launch-type.md#specified启动模式)的UIAbility时，将不会触发  [onAcceptWant]./../@ohos.app.ability.AbilityStage:AbilityStage.onAcceptWant回调。 |
| options | StartOptions | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 启动UIServiceExtensionAbility的必要信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 停止  [AppServiceExtensionAbility](docroot://reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md)  的Want信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 停止ServiceExtensionAbility的Want信息。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当停止ServiceExtensionAbility的接口调用成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当销毁UIAbility自身成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| parameter | AbilityResult | Yes | 返回给startAbilityForResult?接口调用方的相关信息。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数，当销毁UIAbility自身成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| parameter | AbilityResult | Yes | 返回给startAbilityForResult?接口调用方的信息。 |
