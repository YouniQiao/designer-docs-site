...
Describes the information of the UIAbility bound to the [intent developed using a configuration file](docroot://application-models/insight-intent-config-development.md).
