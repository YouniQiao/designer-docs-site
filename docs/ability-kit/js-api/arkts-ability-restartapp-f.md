...
In API version 10, the ability specified by [setRestartWant](arkts-ability-setrestartwant-f.md#setrestartwant-1) is started. If no
...
This API can be used together with the APIs of [errorManager](arkts-app-ability-errormanager.md).
