...
How the Want object will be handled. The value is of the enumeration type [Flags](arkts-ability-flags-e.md#flags). A numeric value should be passed by default. For example, if the value is 0x00000001 (**wantConstant.Flags.FLAG_AUTH_READ_URI_PERMISSION**), the receiver is temporarily granted the permission to read the data pointed to by the URI.
