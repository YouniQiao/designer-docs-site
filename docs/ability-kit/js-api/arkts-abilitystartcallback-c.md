...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| parameter | AbilityResult | Yes | Result returned when  [terminateSelfWithResult]./UIExtensionContext:UIExtensionContext#terminateSelfWithResult(parameter: AbilityResult, callback: AsyncCallback)  is called to terminate the UIExtensionAbility. |
