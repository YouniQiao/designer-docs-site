...
| callback | AsyncCallback&lt;BundleInfo> | Yes | [回调函数](../../apis-basic-service-kit/arkts-apis/arkts-asynccallback-i.md#AsyncCallback)，当获取成功时，err为undefined，data为获取  到的应用信息；否则为错误对象。 |
