...
| --- | --- | --- | --- |
| monitor | AbilityMonitor | Yes | [AbilityMonitor]./application/AbilityMonitor:AbilityMonitor实例。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当添加AbilityMonitor实例成功，err为undefined，否则为错误对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| monitor | AbilityStageMonitor | Yes | [AbilityStageMonitor]./application/AbilityStageMonitor:AbilityStageMonitor 实例。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当添加一个用于监视指定AbilityStage的生命周期状态更改的AbilityStageMonitor对象成功，err为undefined，否则  为错误对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| monitor | InteropAbilityMonitor | Yes | InteropAbilityMonitor对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| ability | UIAbility | Yes | 指定Ability对象。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当调度指定Ability生命周期状态到Background状态成功，err为undefined，否则为错误对象。 |
...
| --- | --- | --- | --- |
| ability | UIAbility | Yes | 指定Ability对象。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当调度指定Ability生命周期状态到Foreground状态成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback&lt;ShellCmdResult> | Yes | 回调函数。当执行指定的shell命令成功，err为undefined，data为获取到的执行结果；否则为错误对象。 |
...
| --- | --- | --- | --- |
| cmd | string | Yes | shell命令字符串。 |
| timeoutSecs | long | Yes | 设定命令超时时间，单位秒（s）。 |
| callback | AsyncCallback&lt;ShellCmdResult> | Yes | 回调函数。当执行指定的shell命令成功，err为undefined，data为获取到的执行结果；否则为错误对象。 |
...
| code | long | Yes | 日志码。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当结束测试并打印日志信息到单元测试终端控制台成功，err为undefined，否则为错误对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;UIAbility> | Yes | 回调函数。当获取当前应用顶部Ability成功，err为undefined，data为获取到的Ability实例；否则为错误对象。 |
...
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当打印日志信息到单元测试终端控制台成功，err为undefined，否则为错误对象。 |
...
| --- | --- | --- | --- |
| monitor | AbilityMonitor | Yes | [AbilityMonitor]./application/AbilityMonitor:AbilityMonitor实例。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当删除已经添加的AbilityMonitor实例成功，err为undefined，否则为错误对象。 |
...
| --- | --- | --- | --- |
| monitor | AbilityStageMonitor | Yes | [AbilityStageMonitor]./application/AbilityStageMonitor:AbilityStageMonitor 实例。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当从应用程序内存中删除指定的AbilityStageMonitor对象成功，err为undefined，否则为错误对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mockList | Record&lt;string, string> | Yes | 模块mock替换关系的键值对象，其中key为待替换的目标路径，value为用于替换的mock实现文件的路径。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | Want | Yes | 启动Ability参数。 |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当启动指定Ability成功，err为undefined，否则为错误对象。 |
...
| --- | --- | --- | --- |
| monitor | AbilityMonitor | Yes | [AbilityMonitor]./application/AbilityMonitor:AbilityMonitor实例。 |
| callback | AsyncCallback&lt;UIAbility> | Yes | 回调函数。当等待与AbilityMonitor实例匹配的Ability到达OnCreate生命周期成功，err为undefined，data为获取  到的Ability实例，否则为错误对象。 |
...
| --- | --- | --- | --- |
| monitor | AbilityMonitor | Yes | [AbilityMonitor]./application/AbilityMonitor:AbilityMonitor实例。 |
| timeout | long | Yes | 最大等待时间，单位毫秒（ms），默认值为5000毫秒。 |
| callback | AsyncCallback&lt;UIAbility> | Yes | 表示指定的回调方法。 |
...
| --- | --- | --- | --- |
| monitor | AbilityStageMonitor | Yes | [AbilityStageMonitor]./application/AbilityStageMonitor:AbilityStageMonitor 实例。 |
| callback | AsyncCallback&lt;AbilityStage> | Yes | 回调函数。当等待并返回与给定AbilityStageMonitor中设置的条件匹配的AbilityStage对象的操作成功，err为  undefined，data为获取到的[AbilityStage]./../@ohos.app.ability.AbilityStage:AbilityStage对象；否则为错误对象。 |
...
| --- | --- | --- | --- |
| monitor | AbilityStageMonitor | Yes | [AbilityStageMonitor]./application/AbilityStageMonitor:AbilityStageMonitor 实例。 |
| timeout | long | Yes | 超时最大等待时间，单位毫秒（ms），默认值为5000毫秒。 |
| callback | AsyncCallback&lt;AbilityStage> | Yes | 回调函数。当等待并返回与给定AbilityStageMonitor中设置的条件匹配的AbilityStage对象的操作成功，err为  undefined，data为获取到的[AbilityStage]./../@ohos.app.ability.AbilityStage:AbilityStage对象；否则为错误对象。 |
