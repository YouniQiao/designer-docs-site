...
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;Array&lt;RecoverableApplicationInfo>> | Yes | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-asynccallback-i.md#AsyncCallback)，当获取成功时，err为undefined，data为获取到的所有可恢复的预置应用信息。 |
