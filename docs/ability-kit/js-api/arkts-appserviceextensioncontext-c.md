...
| callback | ConnectOptions | Yes | Callback used to return the information indicating that the connection is  successful, failed, or interrupted. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| connection | long | Yes | Connection ID returned by  [connectServiceExtensionAbility](arkts-appserviceextensioncontext-c.md#connectServiceExtensionAbility). |
