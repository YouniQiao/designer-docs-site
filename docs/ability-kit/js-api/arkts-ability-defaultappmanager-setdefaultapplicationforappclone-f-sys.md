...
| --- | --- | --- | --- |
| type | string | Yes | Type of the application. The value can be a value of [ApplicationType](arkts-ability-defaultappmanager-applicationtype-e.md),[MIMEType](docroot://database/uniform-data-type-list.md#generic-utds), or [UniformDataType](../../apis-arkdata/arkts-apis/arkts-arkdata-uniformtypedescriptor-uniformdatatype-e.md). |
...
| userId | number | No | User ID, which can be obtained by calling [getOsAccountLocalId](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-osaccount-accountmanager-i.md#getosaccountlocalid-1).<br>The default value is the user ID of the caller. |
