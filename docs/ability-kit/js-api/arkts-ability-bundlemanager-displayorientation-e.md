...
Enumerates the display orientations of the ability. It is applicable only to [PageAbility](docroot://application-models/pageability-overview.md) in the FA model.
