...
[candidate master process](../../../../application-models/ability-terminology.md#candidate-master-process) list. This
API uses a promise to return the result.
When the [master process](../../../../application-models/ability-terminology.md#master-process) is destroyed and a
...
[onNewProcessRequest](arkts-ability-abilitystage-c.md#onnewprocessrequest-1) callback.
...
| --- | --- | --- | --- |
| insertToHead | boolean | Yes | Whether to add the current process to the head of the candidate master process list.**true** to add the current process to the head of the list, **false** to add the current process to the tail of thelist. |
