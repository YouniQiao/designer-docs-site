...
| [getAlternateIcons](arkts-ability-getalternateicons-f.md#getalternateicons-1) | Get all alternate icon info configured by the application itself. |
...
| [getApplicationLabel](arkts-ability-getapplicationlabel-f.md#getapplicationlabel-1) | Obtains the label of a specified application. |
...
| [getInstalledBundleList](arkts-ability-getinstalledbundlelist-f.md#getinstalledbundlelist-1) | Obtains BundleInfo of all bundles available in the system. |
...
| [setAlternateIcon](arkts-ability-setalternateicon-f.md#setalternateicon-1) | Set the alternate icon for the current application. If you need to restore the app's default icon, please input an empty value for the icon name parameter. |
...
| [getAbilityIcon](arkts-ability-getabilityicon-f-sys.md#getabilityicon-1) | Obtains the icon of a specified ability. |
| [getAbilityIcon](arkts-ability-getabilityicon-f-sys.md#getabilityicon-2) | Obtains the icon of a specified ability. |
...
| [getAllBundleInstallInfo](arkts-ability-getallbundleinstallinfo-f-sys.md#getallbundleinstallinfo-1) | Obtains the install information of all apps. |
...
| [isApplicationDisableForbidden](arkts-ability-isapplicationdisableforbidden-f-sys.md#isapplicationdisableforbidden-1) | Check whether a specified application is forbidden to be disabled. If you need to check whether an application is forbidden to be disabled under the current user, ohos.permission.GET_BUNDLE_INFO_PRIVILEGED needs to be applied for. If you need to check whether an application is forbidden to be disabled under other users, ohos.permission.GET_BUNDLE_INFO_PRIVILEGED and ohos.permission.INTERACT_ACROSS_LOCAL_ACCOUNTS need to be applied for. |
...
| [setApplicationEnabled](arkts-ability-setapplicationenabled-f-sys.md#setapplicationenabled-2) | Set whether an application is enabled or disabled, with control over whether the process is killed when disabled. |
...
| [AlternateIconInfo](arkts-ability-alternateiconinfo-t.md) | Indicates the alternate icon configured by the application. |
