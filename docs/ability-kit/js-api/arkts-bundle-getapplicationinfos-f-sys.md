...
**Substitute:** ohos.bundle.bundleManager#getAllApplicationInfo
...
| callback | AsyncCallback&lt;Array&lt;ApplicationInfo>> | Yes | Callback used to return the result. If  getApplicationInfos is successful, err is undefined, and the list of app information as  the input parameter at program startup. Otherwise, err is an error object. |
