...
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;AbilityInfo> | Yes | 回调函数，返回true表示该Ability的配置正在更改，否则返回false。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;ApplicationInfo> | Yes | 回调函数，返回当前应用程序的信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | 回调函数，返回此应用程序的类型。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;AppVersionInfo> | Yes | 回调函数，返回应用版本信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | 回调函数，返回当前ability的Bundle名称。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | 回调函数，返回该应用程序的内部存储目录。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | 回调函数，返回ability调用方的Bundle名称。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;bundle.DisplayOrientation> | Yes | 回调函数，返回屏幕显示方向。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;ElementName> | Yes | 回调函数，返回当前ability的ohos.bundleManager.ElementName对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | 回调函数，返回应用程序的缓存目录的绝对路径。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | 回调函数，返回内部存储器上此应用程序的文件目录。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;HapModuleInfo> | Yes | 回调函数，返回应用的ModuleInfo对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | Promise对象，返回Ability或应用的分布式文件路径。若为首次调用，则将创建建目录。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | 回调函数，返回应用程序的本地根目录。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;ProcessInfo> | Yes | 回调函数，返回当前进程的信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | Yes | 回调函数，返回当前进程的名称。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;boolean> | Yes | 回调函数，返回true表示该Ability的配置正在更改，否则返回false。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当通知系统绘制此页面功能所需的时间成功，err为undefined，否则为错误对象。 |
...
| requestCode | number | Yes | 指示要传递给[PermissionRequestResult](arkts-permissionrequestresult-i.md#PermissionRequestResult)的请求代码。 |
| resultCallback | AsyncCallback&lt;PermissionRequestResult> | Yes | 回调函数，返回授权结果信息。 |
...
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当设置当前Ability的显示方向成功，err为undefined，否则为错误对象。 |
...
**Substitute:** @ohos.window:window.WindowStage.setShowOnLockScreen
...
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当设置每当显示锁屏时是否在锁屏顶部显示此功能并使该功能保持激活状态的操作成功，err为undefined，否则为错误对象。 |
...
**Substitute:** @ohos.window:window.setWakeUpScreen
...
| callback | AsyncCallback&lt;void> | Yes | 回调函数。当设置恢复此功能时是否唤醒屏幕成功，err为undefined，否则为错误对象。 |
...
| --- | --- | --- | --- |
| permission | string | Yes | 指定权限的名称。 |
| options | PermissionOptions | Yes | 权限选项。 |
| callback | AsyncCallback&lt;number> | Yes | 回调函数，返回权限验证结果，0有权限，-1无权限。 |
