...
| callback | AsyncCallback&lt;number> | Yes | function specified by framework to receive the result, developer should  call this function to return the result to framework. |
...
| callback | AsyncCallback&lt;PacMap> | Yes | function specified by framework to receive the result, developer  should call this function to return the result to framework. |
...
| callback | AsyncCallback&lt;string> | Yes | function specified by framework to receive the result, developer  should call this function to return the result to framework. |
...
| callback | AsyncCallback&lt;Array&lt;DataAbilityResult>> | Yes | specified by framework to receive the result,  developer should call this function to return  the result to framework. |
...
| mimeTypeFilter | string | Yes | Indicates the MIME type of the files to obtain. This parameter cannot be set to  {@code null}.  1. "&ast;/": Obtains all types supported by a Data ability.  2. "image/": Obtains files whose main type is image of any subtype.  3. "&ast;/jpg": Obtains files whose subtype is JPG of any main type. |
| callback | AsyncCallback&lt;Array&lt;string>> | Yes | function specified by framework to receive the result, developer  should call this function to return the result to framework. |
...
| callback | AsyncCallback&lt;ResultSet> | Yes | function specified by framework to receive the result, developer  should call this function to return the result to framework. |
