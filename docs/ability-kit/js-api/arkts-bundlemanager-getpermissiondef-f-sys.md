...
| callback | AsyncCallback&lt;PermissionDef> | Yes | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-asynccallback-i.md#AsyncCallback)，当获取成功时，err为  undefined，data为获取到的Array；否则为错误对象。 |
...
| Type | Description |
| --- | --- |
| Promise&lt;PermissionDef> | Promise对象，返回Array对象。 |
