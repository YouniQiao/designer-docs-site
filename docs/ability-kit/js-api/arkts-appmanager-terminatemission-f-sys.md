...
| --- | --- | --- | --- |
| missionId | int | Yes | 任务ID，可通过  [getMissionInfos]@ohos.app.ability.missionManager:missionManager.getMissionInfos(deviceId: string, numMax: int, callback: AsyncCallback>)  获取。 |
