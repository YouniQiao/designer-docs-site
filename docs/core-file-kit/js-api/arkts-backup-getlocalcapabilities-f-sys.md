...
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;FileData> | Yes | A callback method, the argument FileData will holding all the local capabilities.  The returned file is a temporal file that will be deleted automatically when closed. |
