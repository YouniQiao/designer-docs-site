...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fileMeta | FileMeta | Yes | Metadata of the file to be sent. Note that all the files should come  from the backup procedure or the getLocalCapabilities method. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fileMeta | FileMeta | Yes | Metadata of the file to be sent. Make sure that the backup framework holds  this file by calling getFileHandle. |
