...
| [getFreeSize](arkts-corefile-getfreesize-f.md#getfreesize-2) | Obtains the free size of the specified file system, in bytes. This API uses an asynchronous callback to return theresult. |
...
| [getTotalSize](arkts-corefile-gettotalsize-f.md#gettotalsize-2) | Obtains the total size of the specified file system, in bytes. This API uses an asynchronous callback to return theresult. |
