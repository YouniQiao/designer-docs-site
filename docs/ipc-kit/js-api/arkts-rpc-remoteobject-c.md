...
**Inheritance:** RemoteObjectextends: IRemoteObject.
...
**Substitute:** modifyLocalInterface(localInterface:
...
**Substitute:** onRemoteMessageRequest(code:
