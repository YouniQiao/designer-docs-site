...
**Substitute:** rpc.MessageSequence
...
**Substitute:** rpc.MessageSequence.closeFileDescriptor(fd:
...
**Substitute:** rpc.MessageSequence#containFileDescriptors()
...
**Substitute:** rpc.MessageSequence.create()
...
**Substitute:** rpc.MessageSequence.dupFileDescriptor(fd:
...
**Substitute:** rpc.MessageSequence#getCapacity()
...
**Substitute:** rpc.MessageSequence#getRawDataCapacity()
...
**Substitute:** rpc.MessageSequence#getReadableBytes()
...
**Substitute:** rpc.MessageSequence#getReadPosition()
...
**Substitute:** rpc.MessageSequence#getSize()
...
**Substitute:** rpc.MessageSequence#getWritableBytes()
...
**Substitute:** rpc.MessageSequence#getWritePosition()
...
**Substitute:** rpc.MessageSequence#readAshmem()
...
**Substitute:** rpc.MessageSequence#readBoolean()
...
**Substitute:** rpc.MessageSequence#readBooleanArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readBooleanArray()
...
**Substitute:** rpc.MessageSequence#readByte()
...
**Substitute:** rpc.MessageSequence#readByteArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readByteArray()
...
**Substitute:** rpc.MessageSequence#readChar()
...
**Substitute:** rpc.MessageSequence#readCharArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readCharArray()
...
**Substitute:** rpc.MessageSequence#readDouble()
...
**Substitute:** rpc.MessageSequence#readDoubleArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readDoubleArray()
...
**Substitute:** rpc.MessageSequence#readException()
...
**Substitute:** rpc.MessageSequence#readFileDescriptor()
...
**Substitute:** rpc.MessageSequence#readFloat()
...
**Substitute:** rpc.MessageSequence#readFloatArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readFloatArray()
...
**Substitute:** rpc.MessageSequence#readInt()
...
**Substitute:** rpc.MessageSequence#readIntArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readIntArray()
...
**Substitute:** rpc.MessageSequence#readInterfaceToken()
...
**Substitute:** rpc.MessageSequence#readLong()
...
**Substitute:** rpc.MessageSequence#readLongArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readLongArray()
...
**Substitute:** rpc.MessageSequence#readRawDataBuffer(size:
...
**Substitute:** rpc.MessageSequence#readRemoteObject()
...
**Substitute:** rpc.MessageSequence#readRemoteObjectArray(objects:
...
**Substitute:** rpc.MessageSequence#readParcelable(dataIn:
...
**Substitute:** rpc.MessageSequence#readParcelableArray(parcelableArray:
...
**Substitute:** rpc.MessageSequence#readShort()
...
**Substitute:** rpc.MessageSequence#readShortArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readShortArray()
...
**Substitute:** rpc.MessageSequence#readString()
...
**Substitute:** rpc.MessageSequence#readStringArray(dataIn:
...
**Substitute:** rpc.MessageSequence#readStringArray()
...
**Substitute:** rpc.MessageSequence#reclaim()
...
**Substitute:** rpc.MessageSequence#rewindRead(pos:
...
**Substitute:** rpc.MessageSequence#rewindWrite(pos:
...
**Substitute:** rpc.MessageSequence#setCapacity(size:
...
**Substitute:** rpc.MessageSequence#setSize(size:
...
**Substitute:** rpc.MessageSequence#writeAshmem(ashmem:
...
**Substitute:** rpc.MessageSequence#writeBoolean(val:
...
**Substitute:** rpc.MessageSequence#writeBooleanArray(booleanArray:
...
**Substitute:** rpc.MessageSequence#writeByte(val:
...
**Substitute:** rpc.MessageSequence#writeByteArray(byteArray:
...
**Substitute:** rpc.MessageSequence#writeChar(val:
...
**Substitute:** rpc.MessageSequence#writeCharArray(charArray:
...
**Substitute:** rpc.MessageSequence#writeDouble(val:
...
**Substitute:** rpc.MessageSequence#writeDoubleArray(doubleArray:
...
**Substitute:** rpc.MessageSequence#writeFileDescriptor(fd:
...
**Substitute:** rpc.MessageSequence#writeFloat(val:
...
**Substitute:** rpc.MessageSequence#writeFloatArray(floatArray:
...
**Substitute:** rpc.MessageSequence#writeInt(val:
...
**Substitute:** rpc.MessageSequence#writeIntArray(intArray:
...
**Substitute:** rpc.MessageSequence#writeInterfaceToken(token:
...
**Substitute:** rpc.MessageSequence#writeLong(val:
...
**Substitute:** rpc.MessageSequence#writeLongArray(longArray:
...
**Substitute:** rpc.MessageSequence#writeNoException()
...
**Substitute:** rpc.MessageSequence#writeRawDataBuffer(rawData:
...
**Substitute:** rpc.MessageSequence#writeRemoteObject(obj:
...
**Substitute:** rpc.MessageSequence#writeRemoteObjectArray(objectArray:
...
**Substitute:** rpc.MessageSequence#writeParcelable(val:
...
**Substitute:** rpc.MessageSequence#writeParcelableArray(parcelableArray:
...
**Substitute:** rpc.MessageSequence#writeShort(val:
...
**Substitute:** rpc.MessageSequence#writeShortArray(shortArray:
...
**Substitute:** rpc.MessageSequence#writeString(val:
...
**Substitute:** rpc.MessageSequence#writeStringArray(stringArray:
