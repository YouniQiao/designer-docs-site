...
- [@ohos.dlpPermission](arkts-dlppermission.md)
  ...
  - [decryptDlpFile(system api)](arkts-dataprotection-dlppermission-decryptdlpfile-f-sys.md)<!--DelEnd--><!--Del-->
  - [generateDLPFile(system api)](arkts-dataprotection-dlppermission-generatedlpfile-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [DLPProperty(system api)](arkts-dataprotection-dlppermission-dlpproperty-i-sys.md)<!--DelEnd--><!--Del-->
  - [DLPSandboxInfo(system api)](arkts-dataprotection-dlppermission-dlpsandboxinfo-i-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.dlpSetDlpFeature](arkts-dlpsetdlpfeature.md)<!--Del-->
  ...
  - [StatusInfoResult(system api)](arkts-dataprotection-dlpsetdlpfeature-statusinforesult-i-sys.md)<!--DelEnd--><!--Del-->
