...
| uint16_t wIndex | Index corresponding to **wIndex** in the USB protocol. It is usually used to pass the index or offset. Itsmeaning varies according to the request. |
| uint16_t wLength | Data length corresponding to **wLength** in the USB protocol. If data is transferred, this field indicates thenumber of transferred bytes. |
