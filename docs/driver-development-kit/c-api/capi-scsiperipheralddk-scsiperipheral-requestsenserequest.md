...
| Name | Description |
| -- | -- |
| uint8_t allocationLength | Allocation length** field used to specify the size of the buffer prepared by the request initiator (usuallythe host) for the response data. |
