...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-lib-es5-promise-i.md)<ContinuousTaskNotification> | Promise used to return the continuous task notification information, including the continuous task ID. |
