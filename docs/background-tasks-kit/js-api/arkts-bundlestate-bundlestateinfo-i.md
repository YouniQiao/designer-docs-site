...
| --- | --- | --- | --- |
| toMerge | BundleStateInfo | Yes | Indicates the {@link BundleActiveInfo} object to merge.  If the bundle names of the two {@link BundleActiveInfo} objects are different. |
