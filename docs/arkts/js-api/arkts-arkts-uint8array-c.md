...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| elements | Iterable&lt;number&gt; | Yes | An iterable collection of numbers used to construct an ArkTS Uint8Arrayobject. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | ArrayLike&lt;number&gt; \| ArrayBuffer | Yes | Object used to construct the ArkTS Uint8Array. When theparameter type is ArrayBuffer, the number of bytes occupied by the buffer must be an integer multiple of 4. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| buffer | ArrayBuffer | Yes | ArrayBuffer object used to construct the ArkTS Uint8Array. The number of bytesoccupied by the buffer must be an integer multiple of 4. |
...
| end | number | No | End index of the range (exclusive). If a negative number is passed in, it refers to theindex of `end + Uint8Array.length`. The default value is the length of the ArkTS Uint8Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Uint8Array&gt; | Yes | Assertion function used for the test. |
...
| start | number | No | Start index of the range. If a negative number is passed in, it refers to the indexof `start + Uint8Array.length`. The default value is **0**. |
| end | number | No | End index of the range (exclusive). If a negative number is passed in, it refers to theindex of `end + Uint8Array.length`. The default value is the length of the ArkTS Uint8Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayForEachCallback&lt;number, Uint8Array&gt; | Yes | Callback function to run for each element. |
...
| --- | --- | --- | --- |
| searchElement | number | Yes | Value to search for. |
| fromIndex | number | No | Index from which the search starts. The default value is **0**. If the index isgreater than or equal to the length of the ArkTS Uint8Array, **-1** is returned. If a negative number ispassed in, the search starts from the end of the ArkTS Uint8Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayMapCallback&lt;number, Uint8Array&gt; | Yes | A function thataccepts up to three arguments.The map method calls the callbackfn function one time for each element in the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Uint8Array&gt; | Yes | A function thataccepts up to four arguments.The reduce method calls the callbackfn function one time for each element in the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Uint8Array&gt; | Yes | Reduce function. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Uint8Array&gt; | Yes | A function that is called foreach element in the Uint8Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Uint8Array&gt; | Yes | A function that is called foreach element in the Uint8Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| begin | number | No | Start index of the range. If a negative number is passed in, it refers to the indexof `begin + Uint8Array.length`. The default value is **0**. |
| end | number | No | End index of the range (exclusive). If a negative number is passed in, it refers to theindex of `end + Uint8Array.length`. The default value is the length of the ArkTS Uint8Array. |
