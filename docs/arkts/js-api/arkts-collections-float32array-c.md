...
| --- | --- | --- | --- |
| index | number | Yes | 要返回的Array元素的索引（从零开始），取值为整数。  如果`index &lt; 0`，则会访问`index + Float32Array.length`位置的元素。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | ArrayLike&lt;number> \| ArrayBuffer | Yes | 用于构造ArkTS Float32Array的对象。当参数类型是ArrayBuffer时buffer所占的字节数须是4的整数倍。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Float32Array> | Yes | 用于测试的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Float32Array> | Yes | 用于元素过滤的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Float32Array> | Yes | 用于元素查找的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayForEachCallback&lt;number, Float32Array> | Yes | 用于对每个元素执行的回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike&lt;number> | Yes | 用于构造ArkTS Float32Array的ArrayLike对象。 |
...
| Type | Description |
| --- | --- |
| boolean | 检查结果。如果ArkTS Float32Array包含指定的元素，则返回true，否则返回false。 |
...
| --- | --- | --- | --- |
| searchElement | number | Yes | 待索引的值。 |
| fromIndex | number | No | 搜索的起始下标。默认值为0。如果下标大于等于ArkTS Float32Array的长度，则返回-1。如果提供的下标值是负数，则被当做距离数组尾部的偏移，从后到前搜索。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayMapCallback&lt;number, Float32Array> | Yes | 一个接受最多三个参数的函数。  map方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Type | Description |
| --- | --- |
| Float32Array | 新的ArkTS Float32Array实例。可能的原因：1.必填参数未指定；  2.参数类型不正确；3.参数校验失败。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Float32Array> | Yes | 一个接受最多四个参数的函数。  reduce方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Float32Array> | Yes | 一个接受最多四个参数的函数。  reduce方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Float32Array> | Yes | 对Float32Array中的每个元素调用的函数。 |
| initialValue | U | Yes | 作为回调函数首次调用第一个参数的值。  如果未提供初始值，则使用Float32Array的最后一个元素，  并且回调函数从倒数第二个元素开始调用。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Float32Array> | Yes | 对Float32Array中的每个元素调用的函数。 |
