...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | ArrayLike&lt;number> \| ArrayBuffer | Yes | 用于构造ArkTS Int16Array的对象。当参数类型是ArrayBuffer时，  buffer所占的字节数须是4的整数倍。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Int16Array> | Yes | 用于测试的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Int16Array> | Yes | 用于元素过滤的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Int16Array> | Yes | 用于元素查找的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayForEachCallback&lt;number, Int16Array> | Yes | 用于对每个元素执行的回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike&lt;number> | Yes | 用于构造ArkTS Int16Array的ArrayLike对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike&lt;T> | Yes | 用于构造ArkTS Int16Array的ArrayLike对象。 |
...
| --- | --- | --- | --- |
| searchElement | number | Yes | 待索引的值。 |
| fromIndex | number | No | 搜索的起始下标。默认值为0。如果下标大于等于ArkTS Int16Array的长度，  则返回-1。如果提供的下标值是负数，则被当做距离数组尾部的偏移，从后到前搜索。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayMapCallback&lt;number, Int16Array> | Yes | 回调函数。  map方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Type | Description |
| --- | --- |
| Int16Array | 新的ArkTS Int16Array实例。可能原因：1. 必填参数未指定；  2. 参数类型不正确；3. 参数校验失败。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Int16Array> | Yes | 归约函数。  reduce方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Int16Array> | Yes | 归约函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Int16Array> | Yes | 对Int16Array中的  每个元素调用的函数。 |
| initialValue | U | Yes | 作为首次调用回调函数的第一个参数使用的值。  如果未提供初始值，则使用Int16Array的最后一个元素作为初始值，  回调将从倒数第二个元素开始执行。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Int16Array> | Yes | 对Int16Array中的  每个元素调用的函数。 |
