...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| n | Value | Yes | {double \| string \| Decimal} 以弧度为单位的值。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| y | Value | Yes | {double \| string \| Decimal} 除法的被除数。 |
| x | Value | Yes | {double \| string \| Decimal} 除法的除数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| base | Value | Yes | {double \| string \| Decimal} 幂运算的底数的值。 |
| exponent | Value | Yes | {double \| string \| Decimal} 幂运算的幂的值。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| includeZeros | boolean \| int | Yes | 是否计算整数部分尾随零。true或1表示计算，false或0表示不计算。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| significantDigits | double | Yes | {number} 随机值保留的有效数字。取值范围为[0, 1e9]的整数。[since 12 - 17] |
...
| Type | Description |
| --- | --- |
| double | the Decimal type [since 12 - 17]  @returns { double } the Decimal type [since 18] |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| significantDigits | double | Yes | 转换时保留的有效数字。取值范围为[1, 1e9]的整数。 |
...
| --- | --- | --- | --- |
| significantDigits | double | Yes | 转换时保留的有效数字。取值范围为[1, 1e9]的整数。 |
| rounding | Rounding | Yes | 转换时使用的舍入模式。取值范围为0到8的整数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| decimalPlaces | double | Yes | 转换时保留的小数点后有效位数。取值范围为[0, 1e9]的整数。 |
...
向最近的邻值舍入。如果距离相等，则向靠近零的方向舍入 取值为整数。
...
向最近的邻值舍入。如果距离相等，则向偶数邻值舍入 取值为整数。
