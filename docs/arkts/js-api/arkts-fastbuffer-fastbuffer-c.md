...
| --- | --- | --- | --- |
| target | FastBuffer \| Uint8Array | Yes | 要比较的实例对象。 |
...
| Type | Description |
| --- | --- |
| -1 | 返回比较结果。 -1：当前排列在目标前； 0：当前与目标相同； 1：当前排列在目标后。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| target | FastBuffer \| Uint8Array | Yes | 要复制到的Buffer或Uint8Array实例。 |
| targetStart | number | No |  |
| sourceStart | number | No |  |
| sourceEnd | number | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| offset | number | Yes | 偏移量。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | bigint | Yes | 写入Buffer的数据。取值范围：-INT64_MAX = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | bigint | Yes | 写入Buffer的数据。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number | Yes | 写入Buffer的数据。取值范围：-DOUBLE_MAX = 0 and &lt;= buf.length - 8. Received value is: [offset] |
| offset | number | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number | Yes | 写入Buffer的数据。取值范围：-FLOAT_MAX = 0 and &lt;= buf.length - 4. Received value is: [offset] |
| offset | number | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number | Yes | 写入Buffer的数据。取值范围：-INT16_MAX = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number | Yes | 写入Buffer的数据。取值范围：-INT32_MAX = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number | Yes | 写入Buffer的数据。取值范围：-INT8_MAX = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | No |  |
...
| offset | number | Yes | 偏移量。默认值：0。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| byteLength | number | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number | Yes | 写入Buffer的数据。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number | Yes | 写入FastBuffer对象的数据。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | No |  |
