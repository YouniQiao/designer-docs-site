...
| --- | --- | --- | --- |
| index | number | Yes | 要返回的元素的索引（从零开始）。 如果传入负数，则从末尾倒数访问。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | ArrayLike&lt;number> \| ArrayBuffer | Yes | 用于构造ArkTS Int32Array的对象。当参数类型是ArrayBuffer时，  buffer所占的字节数须是4的整数倍。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Int32Array> | Yes | 用于测试的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Int32Array> | Yes | 用于元素过滤的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Int32Array> | Yes | 用于元素查找的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayForEachCallback&lt;number, Int32Array> | Yes | 用于对每个元素执行的回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike&lt;number> | Yes | 用于构造ArkTS Int32Array的ArrayLike对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike&lt;T> | Yes | 用于构造Int32Array的ArrayLike对象。 |
...
| Type | Description |
| --- | --- |
| boolean | 检查结果。如果包含指定元素则返回true；否则返回false。 |
...
| --- | --- | --- | --- |
| searchElement | number | Yes | 待索引的值。 |
| fromIndex | number | No | 搜索的起始下标。默认值为0。如果下标大于等于ArkTS Int32Array的长度，  则返回-1。如果传入负数，则从ArkTS Int32Array末尾开始搜索。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayMapCallback&lt;number, Int32Array> | Yes | 一个最多接受三个参数的函数。  map方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Type | Description |
| --- | --- |
| Int32Array | 新的ArkTS Int32Array实例。可能原因：1.必填参数未指定；  2.参数类型不正确；3.参数校验失败。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Int32Array> | Yes | 一个最多接受四个参数的函数。  reduce方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Int32Array> | Yes | 归约函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Int32Array> | Yes | 对Int32Array中每个元素调用的函数。 |
| initialValue | U | Yes | 作为回调函数首次调用的第一个参数的初始值。  如果未提供初始值，则使用Int32Array的最后一个元素作为初始值，  并且回调从倒数第二个元素开始执行。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Int32Array> | Yes | 对Int32Array中每个元素调用的函数。 |
