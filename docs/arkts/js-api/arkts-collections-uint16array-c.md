...
| --- | --- | --- | --- |
| index | number | Yes | 要返回的Array元素的索引（从零开始），取值为整数。 如果`index &lt; 0`，则会访问`index + Uint16Array.length`位置的元素。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | ArrayLike&lt;number> \| ArrayBuffer | Yes | 用于构造ArkTS Uint16Array的对象。当参数类型是ArrayBuffer时buffer所占的字节数须是4的整数倍。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Uint16Array> | Yes | 用于测试的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Uint16Array> | Yes | 用于元素过滤的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | TypedArrayPredicateFn&lt;number, Uint16Array> | Yes | 用于元素查找的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayForEachCallback&lt;number, Uint16Array> | Yes | 用于对每个元素执行的回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike&lt;number> | Yes | 用于构造ArkTS Uint16Array的ArrayLike对象。 |
...
| --- | --- | --- | --- |
| searchElement | number | Yes | 待索引的值。 |
| fromIndex | number | No | 搜索的起始下标。默认值为0。如果下标大于等于ArkTS Uint16Array的长度，则返回-1。  如果提供的下标值是负数，则被当做距离数组尾部的偏移，从后到前搜索。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayMapCallback&lt;number, Uint16Array> | Yes | 回调函数。map方法会对数组中的每个元素调用一次callbackFn函数。 |
...
| Type | Description |
| --- | --- |
| Uint16Array | 新的ArkTS Uint16Array实例。可能的异常原因：1.必填参数未指定；  2.参数类型不正确；3.参数校验失败。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Uint16Array> | Yes | 归约函数。reduce方法会对数组中的每个元素调用一次callbackFn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Uint16Array> | Yes | 归约函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;U, number, Uint16Array> | Yes | 对Uint16Array中每个元素调用的函数。 |
| initialValue | U | Yes | 作为首次调用callbackFn函数第一个参数的值。  若未提供初始值，则会使用Uint16Array的最后一个元素作为初始值，  并从倒数第二个元素开始调用callback。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback&lt;number, number, Uint16Array> | Yes | 对Uint16Array中每个元素调用的函数。 |
