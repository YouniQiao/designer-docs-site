...
| Name | Description |
| --- | --- |
| [getCameraManager](arkts-camera-camera-getcameramanager-f.md#getcameramanager-1) | Obtains a CameraManager instance. This API returns the result synchronously. |
...
| [FocusTrackingInfo](arkts-camera-camera-focustrackinginfo-i-sys.md) | Describes the focus tracking information, which is obtained by calling VideoSessionForSys.[on('focusTrackingInfoAvailable')](arkts-camera-camera-videosession-i-sys.md#on-8). |
...
| [LightStatus](arkts-camera-camera-lightstatus-e-sys.md) | Enumerates the camera light statuses, which are obtained by calling VideoSessionForSys.[on('lightStatusChange')](arkts-camera-camera-videosession-i-sys.md#on-10). |
