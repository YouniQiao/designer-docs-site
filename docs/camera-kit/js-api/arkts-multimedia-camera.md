...
| [CameraManager](arkts-camera-camera-cameramanager-i.md) | Implements camera management. Before calling any API in CameraManager, you must use [getCameraManager](arkts-camera-camera-getcameramanager-f.md#getcameramanager) to obtain a CameraManager instance. |
...
| [CameraManager](arkts-camera-camera-cameramanager-i-sys.md) | Implements camera management. Before calling any API in CameraManager, you must use [getCameraManager](arkts-camera-camera-getcameramanager-f.md#getcameramanager) to obtain a CameraManager instance. |
