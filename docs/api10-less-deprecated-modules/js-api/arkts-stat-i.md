...
文件具体信息，在调用Stat的方法前，需要先通过[stat()](arkts-fileio-stat-f.md#stat-1)方法（同步或异步）来构建一个Stat实例。
...
**Substitute:** @ohos.file.fs:Stat.isBlockDevice
...
**Substitute:** @ohos.file.fs:Stat.isCharacterDevice
...
**Substitute:** @ohos.file.fs:Stat.isDirectory
...
**Substitute:** @ohos.file.fs:Stat.isFIFO
...
**Substitute:** @ohos.file.fs:Stat.isFile
...
**Substitute:** @ohos.file.fs:Stat.isSocket
...
**Substitute:** @ohos.file.fs:Stat.isSymbolicLink
...
**Substitute:** @ohos.file.fs:Stat.mode
...
**Substitute:** @ohos.file.fs:Stat.uid
...
**Substitute:** @ohos.file.fs:Stat.atime
...
**Substitute:** @ohos.file.fs:Stat.gid
...
**Substitute:** @ohos.file.fs:Stat.size
...
**Substitute:** @ohos.file.fs:Stat.ctime
...
**Substitute:** ohos.file.fs.Stat.ino
...
**Substitute:** @ohos.file.fs:Stat.mtime
