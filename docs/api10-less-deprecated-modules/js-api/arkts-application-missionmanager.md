...
**Substitute:** ohos.app.ability.missionManager/missionManager
...
| <!--DelRow-->[getMissionInfo](arkts-missionmanager-getmissioninfo-f-sys.md#getMissionInfo-1) | 获取单个任务信息。使用callback异步回调。 |
| <!--DelRow-->[getMissionInfo](arkts-missionmanager-getmissioninfo-f-sys.md#getMissionInfo-2) | 获取单个任务信息。使用Promise异步回调。 |
...
| <!--DelRow-->[registerMissionListener](arkts-missionmanager-registermissionlistener-f-sys.md#registerMissionListener-1) | 注册系统任务状态监听器。 |
...
| <!--DelRow-->[unregisterMissionListener](arkts-missionmanager-unregistermissionlistener-f-sys.md#unregisterMissionListener-1) | 解注册任务状态监听器。使用callback异步回调。 |
| <!--DelRow-->[unregisterMissionListener](arkts-missionmanager-unregistermissionlistener-f-sys.md#unregisterMissionListener-2) | 解注册任务状态监听器。使用Promise异步回调。 |
