 ...
 * Filters the sidebar items by matching labels against the query.
 * Supports both English and Chinese locales for the placeholder.
 */
  ...
  return (
    <nav
      ...
      <div style={{padding: '0.5rem 0.75rem'}}>
        <input
          type="text"
          placeholder={isZh ? '搜索标题…' : 'Filter by title…'}
          value={query}
