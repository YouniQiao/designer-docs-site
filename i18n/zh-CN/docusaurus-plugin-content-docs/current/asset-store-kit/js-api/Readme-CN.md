...
- [@ohos.security.asset](arkts-security-asset.md)
  ...
  - [updateAsUser(系统接口)](arkts-asset-updateasuser-f-sys.md)<!--DelEnd--><!--Del-->
  - [addAsUser(系统接口)](arkts-asset-addasuser-f-sys.md)<!--DelEnd-->
  - [removeSync](arkts-asset-removesync-f.md)<!--Del-->
  - [queryAsUser(系统接口)](arkts-asset-queryasuser-f-sys.md)<!--DelEnd--><!--Del-->
  - [preQueryAsUser(系统接口)](arkts-asset-prequeryasuser-f-sys.md)<!--DelEnd-->
  ...
  - [removeAsUser(系统接口)](arkts-asset-removeasuser-f-sys.md)<!--DelEnd-->
  - [remove](arkts-asset-remove-f.md)
  - [batchRemove](arkts-asset-batchremove-f.md)<!--Del-->
  - [postQueryAsUser(系统接口)](arkts-asset-postqueryasuser-f-sys.md)<!--DelEnd-->
