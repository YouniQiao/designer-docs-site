...
| --- | --- | --- | --- |
| formIds | Array&lt;string> | 是 | Array of widget IDs. |
| callback | AsyncCallback&lt;void> | 是 | Callback used to return the result. If the widgets are set to be  recyclable, error is undefined; otherwise, an exception is thrown. |
