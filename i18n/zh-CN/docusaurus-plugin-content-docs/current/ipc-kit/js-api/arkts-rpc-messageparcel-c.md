...
**替代接口：** rpc.MessageSequence.closeFileDescriptor(fd:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fd | number | 是 | File descriptor to close. |
...
**替代接口：** rpc.MessageSequence#containFileDescriptors()
...
**替代接口：** rpc.MessageSequence.create()
...
**替代接口：** rpc.MessageSequence.dupFileDescriptor(fd:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fd | number | 是 | File descriptor to duplicate. |
...
**替代接口：** rpc.MessageSequence#getCapacity()
...
**替代接口：** rpc.MessageSequence#getRawDataCapacity()
...
**替代接口：** rpc.MessageSequence#getReadableBytes()
...
**替代接口：** rpc.MessageSequence#getReadPosition()
...
**替代接口：** rpc.MessageSequence#getSize()
...
**替代接口：** rpc.MessageSequence#getWritableBytes()
...
**替代接口：** rpc.MessageSequence#getWritePosition()
...
**替代接口：** rpc.MessageSequence#readAshmem()
...
**替代接口：** rpc.MessageSequence#readBoolean()
...
**替代接口：** rpc.MessageSequence#readBooleanArray(dataIn:
...
**替代接口：** rpc.MessageSequence#readBooleanArray()
...
**替代接口：** rpc.MessageSequence#readByte()
...
**替代接口：** rpc.MessageSequence#readByteArray(dataIn:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataIn | number[] | 是 | Byte array to read. |
...
**替代接口：** rpc.MessageSequence#readByteArray()
...
**替代接口：** rpc.MessageSequence#readChar()
...
**替代接口：** rpc.MessageSequence#readCharArray(dataIn:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataIn | number[] | 是 | Character array to read. |
...
**替代接口：** rpc.MessageSequence#readCharArray()
...
**替代接口：** rpc.MessageSequence#readDouble()
...
**替代接口：** rpc.MessageSequence#readDoubleArray(dataIn:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataIn | number[] | 是 | Double array to read. |
...
**替代接口：** rpc.MessageSequence#readDoubleArray()
...
**替代接口：** rpc.MessageSequence#readException()
...
**替代接口：** rpc.MessageSequence#readFileDescriptor()
...
**替代接口：** rpc.MessageSequence#readFloat()
...
**替代接口：** rpc.MessageSequence#readFloatArray(dataIn:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataIn | number[] | 是 | Double array to read. The system processes float data as that of the double type.  Therefore, the total number of bytes occupied by a float array must be calculated as the double type. |
...
**替代接口：** rpc.MessageSequence#readFloatArray()
...
**替代接口：** rpc.MessageSequence#readInt()
...
**替代接口：** rpc.MessageSequence#readIntArray(dataIn:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataIn | number[] | 是 | Integer array to read. |
...
**替代接口：** rpc.MessageSequence#readIntArray()
...
**替代接口：** rpc.MessageSequence#readInterfaceToken()
...
**替代接口：** rpc.MessageSequence#readLong()
...
**替代接口：** rpc.MessageSequence#readLongArray(dataIn:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataIn | number[] | 是 | Long array to read. |
...
**替代接口：** rpc.MessageSequence#readLongArray()
...
**替代接口：** rpc.MessageSequence#readRawDataBuffer(size:
...
**替代接口：** rpc.MessageSequence#readRemoteObject()
...
**替代接口：** rpc.MessageSequence#readRemoteObjectArray(objects:
...
**替代接口：** rpc.MessageSequence#readParcelable(dataIn:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataIn | Sequenceable | 是 | Object that reads member variables from the MessageParcel object. |
...
**替代接口：** rpc.MessageSequence#readParcelableArray(parcelableArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sequenceableArray | Sequenceable[] | 是 | Sequenceable array to read. |
...
**替代接口：** rpc.MessageSequence#readShort()
...
**替代接口：** rpc.MessageSequence#readShortArray(dataIn:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataIn | number[] | 是 | Short array to read. |
...
**替代接口：** rpc.MessageSequence#readShortArray()
...
**替代接口：** rpc.MessageSequence#readString()
...
**替代接口：** rpc.MessageSequence#readStringArray(dataIn:
...
**替代接口：** rpc.MessageSequence#readStringArray()
...
**替代接口：** rpc.MessageSequence#reclaim()
...
**替代接口：** rpc.MessageSequence#rewindRead(pos:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pos | number | 是 | Position from which data is to read. |
...
**替代接口：** rpc.MessageSequence#rewindWrite(pos:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pos | number | 是 | Position from which data is to write. |
...
**替代接口：** rpc.MessageSequence#setCapacity(size:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | number | 是 | Storage capacity to set, in bytes. |
...
**替代接口：** rpc.MessageSequence#setSize(size:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | number | 是 | Data size to set, in bytes. |
...
**替代接口：** rpc.MessageSequence#writeAshmem(ashmem:
...
**替代接口：** rpc.MessageSequence#writeBoolean(val:
...
**替代接口：** rpc.MessageSequence#writeBooleanArray(booleanArray:
...
**替代接口：** rpc.MessageSequence#writeByte(val:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| val | number | 是 | Byte value to write. |
...
**替代接口：** rpc.MessageSequence#writeByteArray(byteArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| byteArray | number[] | 是 | Byte array to write. |
...
**替代接口：** rpc.MessageSequence#writeChar(val:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| val | number | 是 | Char value to write. |
...
**替代接口：** rpc.MessageSequence#writeCharArray(charArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| charArray | number[] | 是 | Character array to write. |
...
**替代接口：** rpc.MessageSequence#writeDouble(val:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| val | number | 是 | Double value to write. |
...
**替代接口：** rpc.MessageSequence#writeDoubleArray(doubleArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| doubleArray | number[] | 是 | Double array to write. |
...
**替代接口：** rpc.MessageSequence#writeFileDescriptor(fd:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fd | number | 是 | File descriptor to write. |
...
**替代接口：** rpc.MessageSequence#writeFloat(val:
...
**替代接口：** rpc.MessageSequence#writeFloatArray(floatArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| floatArray | number[] | 是 | Double array to write. The system processes float data as that of the double  type. Therefore, the total number of bytes occupied by a float array must be calculated as the double type. |
...
**替代接口：** rpc.MessageSequence#writeInt(val:
...
**替代接口：** rpc.MessageSequence#writeIntArray(intArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| intArray | number[] | 是 | Integer array to write. |
...
**替代接口：** rpc.MessageSequence#writeInterfaceToken(token:
...
**替代接口：** rpc.MessageSequence#writeLong(val:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| val | number | 是 | Long int value to write. |
...
**替代接口：** rpc.MessageSequence#writeLongArray(longArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| longArray | number[] | 是 | Long array to write. |
...
**替代接口：** rpc.MessageSequence#writeNoException()
...
**替代接口：** rpc.MessageSequence#writeRawDataBuffer(rawData:
...
**替代接口：** rpc.MessageSequence#writeRemoteObject(obj:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| object | IRemoteObject | 是 | Remote object to serialize and write to the MessageParcel object. |
...
**替代接口：** rpc.MessageSequence#writeRemoteObjectArray(objectArray:
...
**替代接口：** rpc.MessageSequence#writeParcelable(val:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| val | Sequenceable | 是 | Sequenceable object to write. |
...
**替代接口：** rpc.MessageSequence#writeParcelableArray(parcelableArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sequenceableArray | Sequenceable[] | 是 | Sequenceable array to write. |
...
**替代接口：** rpc.MessageSequence#writeShort(val:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| val | number | 是 | Short integer to write. |
...
**替代接口：** rpc.MessageSequence#writeShortArray(shortArray:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shortArray | number[] | 是 | Short array to write. |
...
**替代接口：** rpc.MessageSequence#writeString(val:
...
**替代接口：** rpc.MessageSequence#writeStringArray(stringArray:
