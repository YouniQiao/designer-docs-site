...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackData | NotificationSwitchChangedCallbackData | 是 | 回调返回由[notificationManager.setNotificationSwitch]../@ohos.notificationManager:notificationManager.setNotificationSwitch接口设置的通知开关状态变化信息。 |
