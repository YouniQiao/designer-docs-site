...
**继承实现关系：** WebAttribute继承自：CommonMethod<WebAttribute>。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| flag | boolean | 是 | If it is true, the window can be opened automatically through JavaScript.  If it is false and user behavior, the window can be opened automatically through JavaScript.  Otherwise, the window cannot be opened. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| backToTop | boolean | 是 | {@code true} means enable the back-to-top feature,  when the status bar is touched. {@code false} otherwise. The default value is true.  True when passing in undefined and null. |
...
| options | SelectionMenuOptionsExt | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| block | boolean | 是 | {@code true} 不允许从网络加载资源; {@code false} 表示允许从网络加载资源。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | WebDarkMode | 是 | 设置Web的深色模式为关闭、开启或跟随系统。 传入null或undefined时为`WebDarkMode.Off`。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| databaseAccess | boolean | 是 | {@code true} means the Web access the database; {@code false} otherwise.  The default value is false. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | number | 是 | 设置网页的默认字体大小，单位px。 输入值的范围为[-2^31, 2^31-1]，实际渲染时超过72px的值按照72px进行渲染，低于1px的值按照1px进行渲染。 传  入null或undefined时为16。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| editMenu | EditMenuOptions | 是 | 自定义文本菜单选项。  菜单项数量、菜单内容尺寸和图标尺寸需与 ArkUI Menu 组件保持一致。  菜单中仅支持使用系统提供的 id 枚举值（TextMenuItemId），  包括剪切、复制、粘贴、全选、翻译、搜索以及网页中的部分 AI 菜单。  onMenuItemClick 函数中的 textRange 参数在网页场景下无意义，  传入值为 -1。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| follow | boolean | 是 | 设置Web组件是否开启字重跟随系统设置变化。 true表示字重跟随系统设置中的字体粗细变化，系统设置改变时字重跟随变化。false表示字重不再跟随系统设置中的字体粗细变  化，系统设置改变时维持当前字重不变。 传入undefined或null时为true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | boolean | 是 | {@code true} 表示显示；{@code false} 表示不显示。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enable | boolean | 是 | {@code true} 表示 Web 遵守  网页中 标签设置的缩放限制；{@code false} 表示不遵守。  默认值为 true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | GestureFocusMode | 是 | The gesture focus mode, which can be {@link GestureFocusMode}.  The default value is FocusMode.DEFAULT. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| horizontalScrollBar | boolean | 是 | 若需要绘制水平滚动条则为 true。  默认值为 true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageAccess | boolean | 是 | 设置是否允许自动加载图片资源。 true表示设置允许自动加载图片资源，false表示设置不允许自动加载图片资源。 传入undefined或null时为  false。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| percent | number | 是 | 网页初始缩放比例。  取值范围：(0, 1000]。  默认值：100。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| javaScriptProxy | JavaScriptProxy | 是 | The ArkTs object in javaScriptProxy will be registered into this Web  component,  and the methods within the methodList of the injected ArkTs object declared in javaScriptProxy can be accessed  by JavaScript. [since 12] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | WebLayoutMode | 是 | 设置web布局模式，跟随系统或自适应布局。 传入null或undefined时为`WebLayoutMode.NONE` |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | number | 是 | 设置网页字体大小最小值，单位px。 输入值的范围为[-2^31, 2^31-1]，实际渲染时超过72px的值按照72px进行渲染，低于1px的值按照1px进行渲染。 传  入null或undefined时为8。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| multiWindow | boolean | 是 | True if it needs to be triggered manually by the user else false.  The default value is false. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | NestedScrollOptions \| NestedScrollOptionsExt | 是 | 嵌套滚动  选项。[since 14] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnBeforeUnloadEvent, boolean> | 是 | The triggered function when the web page wants to confirm navigation from JavaScript  onbeforeunload. [since 8 - 11] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnConsoleEvent, boolean> | 是 | The triggered function when the web page receives a JavaScript console  message. [since 8 - 11] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnErrorReceiveEvent> | 是 | The triggered function when the web page receives a web resource loading  error. [since 8 - 11] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnFaviconReceivedEvent> | 是 | The triggered callback when the application receive a new favicon for the  current web page. [since 9 - 11] |
...
**替代接口：** ohos.web.WebAttribute#onShowFileSelector
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | () => void | 是 | Callback invoked when the request for obtaining geolocation information has been  canceled. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnGeolocationShowEvent> | 是 | Callback invoked when a request to obtain the geolocation  information is received. [since 12] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnHttpErrorReceiveEvent> | 是 | The triggered function when the web page receives a web resource loading HTTP  error. [since 8 - 11] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| onlineImageAccess | boolean | 是 | 设置是否允许从网络加载图片资源。 true表示设置允许从网络加载图片资源，false表示设置不允许从网络加载图片资源。 传入  undefined或null时为false。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | OnOverrideErrorPageCallback | 是 | The triggered function when the  web page's document resource error. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnPageVisibleEvent> | 是 | The triggered callback when previous page will no longer be drawn and next  page begin to draw. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnPermissionRequestEvent> | 是 | The triggered callback when the host application that web content from the specified origin is  attempting to access the resources. |
...
**替代接口：** ohos.web.WebAttribute#onRenderExited
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnScreenCaptureRequestEvent> | 是 | The triggered callback when the host application that web content from the specified origin is  requesting to capture screen. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnSearchResultReceiveEvent> | 是 | Function Triggered when the host application call searchAllAsync.  or searchNext api on WebController and the request is valid. |
...
**替代接口：** ohos.web.WebAttribute#onSslErrorEventReceive
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnTitleReceiveEvent> | 是 | The triggered function when the title of the main application document  changes. [since 8 - 11] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnTouchIconUrlReceivedEvent> | 是 | The triggered callback when the application receive an new url of an  apple-touch-icon. [since 9 - 11] |
...
**替代接口：** ohos.web.WebAttribute#onLoadIntercept
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;OnWindowNewExtEvent> | 是 | The triggered callback when web page requires the user  to create a window. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| optimizeParserBudget | boolean | 是 | 设置开启分段解析HTML优化。 true表示使用解析个数代替解析时间作为HTML分段解析的分段点，并减少每段解析的个数上限。false表示使用  解析时间作为HTML分段解析的分段点。 传入undefined或null时为false。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | OverScrollMode | 是 | 过度滚动模式，可参考 {@link OverScrollMode}。  默认值为 OverScrollMode.NEVER。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| overviewModeAccess | boolean | 是 | 设置是否使用概览模式加载网页。 true表示设置使用概览模式加载网页，false表示设置不使用概览模式加载网页。 传入undefined或  null时为false。 |
...
**替代接口：** ohos.web.WebAttribute#enableAutofill
...
**替代接口：** ohos.web.WebAttribute#editMenuOptions
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| expandedMenuOptions | Array&lt;ExpandedMenuItemOptions> | 是 | 自定义文本菜单配置项。  菜单项数量、菜单内容尺寸、startIcon 图标尺寸  均与 ArkUI Menu 组件保持一致。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| tableData | boolean | 是 | {@code true} 表示允许网页保存表格数据；{@code false} 表示不允许。 |
...
**替代接口：** WebAttribute.textZoomRatio
...
**替代接口：** ohos.web.webview.webview.WebviewController#setCustomUserAgent
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| verticalScrollBar | boolean | 是 | 若需要绘制垂直滚动条则为 true。  默认值为 true。 |
...
**替代接口：** WebAttribute.metaViewport
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| zoomAccess | boolean | 是 | {@code true} 表示网页支持手势缩放；{@code false} 表示不支持。  默认值为 true。 |
