...
**替代接口：** appAccount.AppAccountManager.createAccount(name:
...
**替代接口：** appAccount.AppAccountManager.createAccountImplicitly(owner:
...
**替代接口：** appAccount.AppAccountManager.auth(name:
...
**替代接口：** appAccount.AppAccountManager.checkDataSyncEnabled(name:
...
**替代接口：** appAccount.AppAccountManager.checkAuthTokenVisibility(name:
...
| --- | --- | --- | --- |
| name | string | 是 | 应用账号的名称。最大长度为512个字符。 |
| options | CreateAccountOptions | 否 |  |
...
**替代接口：** appAccount.AppAccountManager.removeAccount(name:
...
**替代接口：** appAccount.AppAccountManager.deleteAuthToken(name:
...
**替代接口：** appAccount.AppAccountManager.setAppAccess(name:
...
**替代接口：** appAccount.AppAccountManager.getCredential(name:
...
**替代接口：** appAccount.AppAccountManager.getCustomData(name:
...
**替代接口：** appAccount.AppAccountManager.getAllAccounts(callback:
...
**替代接口：** appAccount.AppAccountManager.getAllAccounts()
...
**替代接口：** appAccount.AppAccountManager.getAccountsByOwner(owner:
...
**替代接口：** appAccount.AppAccountManager.getAllAuthTokens(name:
...
**替代接口：** appAccount.AppAccountManager.getAuthCallback(sessionId:
...
**替代接口：** appAccount.AppAccountManager.queryAuthenticatorInfo(owner:
...
**替代接口：** appAccount.AppAccountManager.getAuthList(name:
...
**替代接口：** appAccount.AppAccountManager.getAuthToken(name:
...
| callback | Callback&lt;Array&lt;AppAccountInfo>> | 否 |  |
...
**替代接口：** appAccount.AppAccountManager.setCredential(name:
...
**替代接口：** appAccount.AppAccountManager.setCustomData(name:
...
**替代接口：** appAccount.AppAccountManager.setDataSyncEnabled(name:
...
**替代接口：** appAccount.AppAccountManager.setAuthToken(name:
...
**替代接口：** appAccount.AppAccountManager.setAuthTokenVisibility(
...
**替代接口：** appAccount.AppAccountManager.setAuthTokenVisibility(name:
