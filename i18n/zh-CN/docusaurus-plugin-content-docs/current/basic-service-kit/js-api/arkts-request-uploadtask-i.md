...
| callback | (uploadedSize: long, totalSize: long) => void | 否 |  |
...
| callback | Callback&lt;Array&lt;TaskState>> | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | UploadHeaderReceiveCallback | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | UploadProgressCallback | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;Array&lt;TaskState>> | 是 | The callback function for the upload complete event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;Array&lt;TaskState>> | 是 | The callback function for the upload fail event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | UploadHeaderReceiveCallback | 是 | The callback function for the HTTP Response Header event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | UploadProgressCallback | 是 | The callback function for the upload progress event. |
