...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;HttpResponse> | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;WaitingReason> | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | ProgressCallback | 是 | callback function with a `Progress` argument. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;Faults> | 是 | callback function with a `Faults` argument. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;HttpResponse> | 是 | callback function with an `HttpResponse` argument. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;WaitingReason> | 是 | callback function with an `WaitingReason` argument. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| speed | long | 是 | 设置任务每秒能传输的字节数上限，单位为字节（B），最小值为16384字节，同时该值不得低于  [MinSpeed]request.agent.MinSpeed设置的最低速度。 |
