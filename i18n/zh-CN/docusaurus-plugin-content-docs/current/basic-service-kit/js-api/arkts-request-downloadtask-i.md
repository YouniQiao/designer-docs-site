...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | 是 | 回调函数。当查询下载任务MimeType成功，err为undefined，data为获取到的下载任务的MimeType的对象；否则为错误对  象。 |
...
| callback | (receivedSize: long, totalSize: long) => void | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadCompleteCallback | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadFailCallback | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadPauseCallback | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadProgressCallback | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadRemoveCallback | 否 |  |
...
| callback | (err: int) => void | 是 | 下载失败的回调函数。错误原因见  [下载任务的错误码](docroot://reference/apis-basic-services-kit/js-apis-request.md#constants)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadCompleteCallback | 是 | The callback function for the download complete event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadFailCallback | 是 | The callback function for the download fail event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadPauseCallback | 是 | The callback function for the download pause event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadProgressCallback | 是 | The callback function for the download progress event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | DownloadRemoveCallback | 是 | The callback function for the download remove event. |
...
**替代接口：** request.DownloadTask.suspend(callback:
...
**替代接口：** request.DownloadTask.suspend()
...
**替代接口：** request.DownloadTask.getTaskInfo(callback:
...
**替代接口：** request.DownloadTask.getTaskInfo()
...
**替代接口：** request.DownloadTask.getTaskMimeType(callback:
...
**替代接口：** request.DownloadTask.getTaskMimeType()
...
**替代接口：** request.UploadTask.delete(callback:
...
**替代接口：** request.UploadTask.delete()
...
**替代接口：** request.DownloadTask.restore(callback:
...
**替代接口：** request.DownloadTask.restore()
