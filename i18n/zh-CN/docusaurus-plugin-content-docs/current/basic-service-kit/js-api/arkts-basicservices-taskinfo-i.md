...
任务值。 - 通过[request.agent.show](arkts-basicservices-show-f.md#show-2)、 [request.agent.touch](arkts-basicservices-touch-f.md#touch-2)进行查询 。
...
任务的url。 - 通过[request.agent.show](arkts-basicservices-show-f.md#show-2)、 [request.agent.touch](arkts-basicservices-touch-f.md#touch-2)进行查询 。
