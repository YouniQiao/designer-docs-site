...
**替代接口：** @ohos.systemDateTime:systemDateTime.getTimezone(callback:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;string> | 是 | 回调函数，返回系统时区。具体可见  [支持的系统时区](docroot://reference/apis-basic-services-kit/js-apis-system-time.md#支持的系统时区) 。 |
...
**替代接口：** @ohos.systemDateTime:systemDateTime.getTimezone()
