...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | Locale string to be converted, which consists of the language, script,  and country/region. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [Locale ID](docroot://internationalization/i18n-locale-culture.md#how-it-works), for  example, zh-Hans-CN. |
| localeList | string[] | 是 | List of locale IDs. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | Two-letter code of the language to be converted, for example, zh. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | Two-letter country/region code to be converted, for example, CN. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hour | int | 是 | Specified time, for example, 16. |
| locale | string | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | string | 是 | Path to mirror, for example, "/data/out/tmp". |
| delimiter | string | 否 |  |
...
**替代接口：** i18n.I18NUtil.getUnicodeWrappedFilePath(path:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| text | string | 是 | Text for which the direction needs to be set. |
| direction | 'RTL' \| 'LTR' | 是 | The value can be "RTL" or "LTR".  "RTL" indicates setting the input text direction from right to left.  "LTR" indicates setting the input text direction from left to right. |
