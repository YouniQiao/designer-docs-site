...
**替代接口：** resourceManager.ResourceManager.closeRawFd(path:
...
**替代接口：** resourceManager.ResourceManager.getBoolean(resId:
...
**替代接口：** resourceManager.ResourceManager.getColor(resId:
...
**替代接口：** resourceManager.ResourceManager.getColorSync(resId:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resId | long | 是 | Indicates the resource ID. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resName | string | 是 | Indicates the resource name. |
...
| args | Array&lt;string \| number> | 是 | 格式化字符串资源参数。  支持参数类型：`%d`、`%f`、`%s`、`%%`、`%数字$d`、`%数字$f`、`%数字$s`。  说明：`%%`转义为`%`; `%数字$d`中的数字表示使用args中的第几个参数。  举例：`%%d`格式化后为`%d`字符串; `%1$d`表示使用第一个参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resName | string | 是 | Resource name. |
| num | double | 是 | Double floating-point number used to obtain the corresponding string  representation for the current language's plural rules. |
| args | (string \| double)[] | 是 | String resource formatting parameters. |
...
**替代接口：** resourceManager.ResourceManager.getDoublePluralStringValueSync(resId:
...
| --- | --- | --- | --- |
| resId | long | 是 | 资源ID值。 |
| density | int | 否 | 资源获取需要的屏幕密度，0或缺省表示默认屏幕密度。 |
| type | int | 否 | 图标类型。默认值为0。  0：表示获取应用自身图标资源。  1：表示获取主题资源包中应用的分层图标资源。 |
...
**替代接口：** resourceManager.ResourceManager.getDrawableDescriptor(resId:
...
| --- | --- | --- | --- |
| resName | string | 是 | Resource name. |
| num | int | 是 | Integer number used to obtain the corresponding string representation for the  current language's plural rules. |
| args | (string \| double)[] | 是 | String resource formatting parameters. |
...
| --- | --- | --- | --- |
| resId | long | 是 | Indicates the resource ID. |
| num | int | 是 | an integer used to get the correct string for the current plural rules. |
| args | (string \| double)[] | 是 | Indicates the formatting string resource parameters. |
...
**替代接口：** resourceManager.ResourceManager.getIntPluralStringValueSync(resId:
...
**替代接口：** resourceManager.ResourceManager.getMediaContent(resId:
...
**替代接口：** resourceManager.ResourceManager.getMediaContentBase64(resId:
...
| --- | --- | --- | --- |
| resName | string | 是 | 资源名称。 |
| density | int | 是 | 资源获取需要的屏幕密度，0表示默认屏幕密度。 |
| callback | _AsyncCallback&lt;string> | 是 | 回调函数，返回资源名称的图片资源Base64编码。 |
...
**替代接口：** resourceManager.ResourceManager.getMediaContentBase64Sync(resId:
...
**替代接口：** resourceManager.ResourceManager.getMediaContentSync(resId:
...
**替代接口：** resourceManager.ResourceManager.getNumber(resId:
...
**替代接口：** resourceManager.ResourceManager.getPluralStringValue(resId:
...
**替代接口：** resourceManager.ResourceManager.getIntPluralStringByNameSync(resName:
...
**替代接口：** resourceManager.ResourceManager.getRawFileContent(path:
...
**替代接口：** resourceManager.ResourceManager.getRawFd(path:
...
**替代接口：** resourceManager.ResourceManager.getStringValue(resId:
...
**替代接口：** resourceManager.ResourceManager.getStringArrayValue(resId:
...
**替代接口：** resourceManager.ResourceManager.getStringArrayValueSync(resId:
...
| --- | --- | --- | --- |
| resName | string | 是 | Resource name. |
| args | (string \| double)[] | 是 | Parameters used to populate placeholders in the string. |
...
**替代接口：** resourceManager.ResourceManager.getStringSync(resId:
...
**替代接口：** resourceManager.ResourceManager.getSymbol(resId:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| configuration | Configuration | 是 | 指定差异化资源的配置。通过  [getOverrideConfiguration]resourceManager.ResourceManager.getOverrideConfiguration获取差异化配置后，根据需求修改配置项，  再作为参数传入。 |
