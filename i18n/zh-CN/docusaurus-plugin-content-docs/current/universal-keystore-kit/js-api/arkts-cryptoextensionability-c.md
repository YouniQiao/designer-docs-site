...
| params | HuksCryptoExtensionParam[] | 是 | Indicates  the needed properties for the import certificate operation. |
...
| --- | --- | --- | --- |
| initHandle | string | 是 | 资源句柄。 |
| params | huks.HuksOptions \| HuksCryptoExtensionParams | 是 | params indicates the  properties of the operation[since 26.0.0]. |
