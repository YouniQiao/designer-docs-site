...
| --- | --- | --- | --- |
| accountId | string | 是 | 已登录的云账号ID。 |
| appActions | Record&lt;string, ClearAction> | 是 | 要清除数据的应用信息及清除规则。 [since 10 - 10] |
...
| --- | --- | --- | --- |
| accountId | string | 是 | 已登录的云账号ID。 |
| appActions | Record&lt;string, ClearAction> | 是 | 要清除数据的应用信息及清除规则。 [since 11] |
...
| --- | --- | --- | --- |
| accountId | string | 是 | 已登录的云账号ID。 |
| switches | Record&lt;string, boolean> | 是 | 各应用的端云协同开关信息。true为打开该应用端云开关，false为关闭该应用端云开关。 [since 11] |
...
| progress | Callback&lt;Record&lt;string, Record&lt;string, SyncInfo>>> | 否 |  |
...
| progress | Callback&lt;Record&lt;string, Record&lt;string, SyncInfo>>> | 是 | 回调函数。返回应用包名以及对应数据库的同步信息结果集。外层Record的键为应用  包名，内层Record的键为数据库名。 |
