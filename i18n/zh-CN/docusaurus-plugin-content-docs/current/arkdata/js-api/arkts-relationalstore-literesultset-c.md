...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| columnName | string | 是 | Column name. If the result set contains duplicate column names, the return value  is not as expected. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| columnIndex | int | 是 | Index of the column in the result set, starting from 0. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| columnIdentifier | int \| string | 是 | Index or name of the column in the result set. The index starts from 0  . |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| maxCount | int | 是 | Number of rows to obtain. The value is a positive integer. |
| position | int | 否 |  |
