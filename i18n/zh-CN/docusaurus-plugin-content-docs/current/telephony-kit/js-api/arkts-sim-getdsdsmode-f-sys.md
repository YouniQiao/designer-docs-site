...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;DsdsMode> | 是 | Indicates the callback for  getting one of the following dsds mode states:   {@code DsdsMode#DSDS_MODE_V2}  {@code DsdsMode#DSDS_MODE_V3}  {@code DsdsMode#DSDS_MODE_V5_TDM}  {@code DsdsMode#DSDS_MODE_V5_DSDA} |
