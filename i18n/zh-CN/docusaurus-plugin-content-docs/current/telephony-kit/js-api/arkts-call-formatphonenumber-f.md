...
| options | NumberFormatOptions | 是 | Indicates the country code option. |
| callback | AsyncCallback&lt;string> | 是 | Indicates the callback to obtain a formatted phone number.  Returns an empty string if the input phone number is invalid. |
...
| --- | --- | --- | --- |
| phoneNumber | string | 是 | Indicates the phone number to format. |
| options | NumberFormatOptions | 否 | Indicates the country code option. |
