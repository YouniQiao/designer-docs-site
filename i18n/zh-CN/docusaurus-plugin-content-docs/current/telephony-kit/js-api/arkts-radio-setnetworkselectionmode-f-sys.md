...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | NetworkSelectionModeOptions | 是 | Indicates the network selection mode option. |
| callback | AsyncCallback&lt;void> | 是 | The callback of setNetworkSelectionMode. |
