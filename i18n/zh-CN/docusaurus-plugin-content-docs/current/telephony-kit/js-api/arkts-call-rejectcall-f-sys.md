...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callId | int | 是 | Indicates the identifier of the call to reject. |
| options | RejectMessageOptions | 是 | Indicates the text message to reject. |
| callback | AsyncCallback&lt;void> | 是 | The callback of rejectCall. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callId | int | 否 | Indicates the identifier of the call to reject. |
| options | RejectMessageOptions | 否 | Indicates the text message to reject. |
