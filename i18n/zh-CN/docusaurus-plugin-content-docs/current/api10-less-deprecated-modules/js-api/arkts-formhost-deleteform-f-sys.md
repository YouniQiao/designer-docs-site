...
**替代接口：** @ohos.app.form.formHost:formHost#deleteForm
...
| callback | AsyncCallback&lt;void> | 是 | Callback used to return the result. If the widget is deleted, error  is undefined; otherwise, error is an error object. |
