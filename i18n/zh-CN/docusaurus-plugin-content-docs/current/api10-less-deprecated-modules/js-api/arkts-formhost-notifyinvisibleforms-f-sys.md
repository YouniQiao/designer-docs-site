...
**替代接口：** @ohos.app.form.formHost:formHost#notifyInvisibleForms
...
| callback | AsyncCallback&lt;void> | 是 | Callback used to return the result. If a notification is sent to the  widget framework to make the widget invisible, error is undefined; otherwise, error is an error  object. |
