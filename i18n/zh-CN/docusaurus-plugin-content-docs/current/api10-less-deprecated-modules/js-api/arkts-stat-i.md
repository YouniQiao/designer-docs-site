...
**替代接口：** @ohos.file.fs:Stat.isBlockDevice
...
**替代接口：** @ohos.file.fs:Stat.isCharacterDevice
...
**替代接口：** @ohos.file.fs:Stat.isDirectory
...
**替代接口：** @ohos.file.fs:Stat.isSocket
...
**替代接口：** @ohos.file.fs:Stat.isSymbolicLink
