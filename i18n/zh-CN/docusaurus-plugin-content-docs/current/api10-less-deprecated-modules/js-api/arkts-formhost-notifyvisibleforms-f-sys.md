...
**替代接口：** @ohos.app.form.formHost:formHost#notifyVisibleForms
...
| callback | AsyncCallback&lt;void> | 是 | Callback used to return the result. If a notification is sent to the  widget framework to make the widget visible, error is undefined; otherwise, error is an error object. |
