...
**替代接口：** contact.deleteContact(context:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 联系人的唯一查询键key，一个联系人对应一个key，可以通过[queryKey]contact.queryKey(context: Context, id: number, callback: AsyncCallback): void获取。 |
