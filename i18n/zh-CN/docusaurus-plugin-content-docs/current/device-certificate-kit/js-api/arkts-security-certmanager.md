...
| [installUserTrustedCertificate](arkts-devicecertificate-installusertrustedcertificate-f.md#installusertrustedcertificate-1) | 安装用户CA证书。当入参certificate.certFormat为P7B时，输入的P7B证书文件中最多只能包含20本证书。使用Promise异步回调。 |
