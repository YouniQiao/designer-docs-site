...
| [401](../../apis-ads-kit/errorcode-ads.md#401-请求广告参数错误) | Parameter verification failed.<br>Possible causes: the URI is null or the URI format is wrong,<br> the certType's value is invalid or not supported. |
