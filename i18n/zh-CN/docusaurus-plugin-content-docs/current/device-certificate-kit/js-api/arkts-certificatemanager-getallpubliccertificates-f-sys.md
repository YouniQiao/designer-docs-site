...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;CMResult> | Promise对象，返回获取所有用户公共凭据的结果，返回值为  [CMResult](arkts-certificatemanager-cmresult-i.md#CMResult)对象中的credentialDetailList属性。  说明：用户公共凭据个数为0时，返回CMResult为undefined。 |
