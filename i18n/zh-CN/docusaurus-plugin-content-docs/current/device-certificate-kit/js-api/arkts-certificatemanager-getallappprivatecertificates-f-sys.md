...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;CMResult> | 是 | 回调函数。当获取所有私有凭据列表成功时，err为null，data为  [CMResult](arkts-certificatemanager-cmresult-i.md#CMResult)对象中的credentialList属性；否则为错误对象。 |
