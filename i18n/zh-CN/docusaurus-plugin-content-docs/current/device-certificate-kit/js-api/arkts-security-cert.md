...
| [createPkcs12](arkts-devicecertificate-createpkcs12-f.md#createpkcs12-1) | 表示创建Pkcs12数据。使用Promise方式返回结果。 |
| [createPkcs12Sync](arkts-devicecertificate-createpkcs12sync-f.md#createpkcs12sync-1) | 表示创建Pkcs12数据，同步返回结果。 |
| [createTrustAnchorsWithKeyStore](arkts-devicecertificate-createtrustanchorswithkeystore-f.md#createtrustanchorswithkeystore-1) | 表示从P12文件中读取ca证书来构造[TrustAnchor](arkts-devicecertificate-x509trustanchor-i.md#x509trustanchor)对象数组。使用Promise方式返回结果。 |
...
| [generateCsr](arkts-devicecertificate-generatecsr-f.md#generatecsr-1) | 表示使用指定的RSA私钥，传入主体、扩展、摘要算法、输出格式等配置参数去生成CSR。 |
| [parsePkcs12](arkts-devicecertificate-parsepkcs12-f.md#parsepkcs12-1) | 表示从P12文件中解析证书、私钥及其他证书合集，并返回结果。 |
| [parsePkcs12](arkts-devicecertificate-parsepkcs12-f.md#parsepkcs12-2) | 表示从Pkcs12文件中解析证书、私钥及其他证书合集。使用Promise方式返回结果。 |
...
| [CmsGeneratorOptions](arkts-devicecertificate-cmsgeneratoroptions-i.md) | 表示生成Cms签名结果的配置选项。 |
...
| [CmsParser](arkts-devicecertificate-cmsparser-i.md) | CmsParser对象用于对已签名跟封装的CMS（Cryptographic Message Syntax）格式的消息进行验签和解封装。 |
...
| [CmsVerificationConfig](arkts-devicecertificate-cmsverificationconfig-i.md) | CMS验证的配置。 |
...
| [CsrGenerationConfig](arkts-devicecertificate-csrgenerationconfig-i.md) | RSA私钥生成CSR时的配置参数，包含主体、扩展、摘要算法、输出格式等。 |
...
| [EncodingBlob](arkts-devicecertificate-encodingblob-i.md) | 带编码格式的证书二进制数组。 |
| [GeneralName](arkts-devicecertificate-generalname-i.md) | 用于表示证书主体信息对象。 |
| [PbesParams](arkts-devicecertificate-pbesparams-i.md) | 表示基于密码的加密算法参数，当前仅支持PBES2。 |
| [Pkcs12CreationConfig](arkts-devicecertificate-pkcs12creationconfig-i.md) | 表示创建P12文件的配置。 |
| [Pkcs12Data](arkts-devicecertificate-pkcs12data-i.md) | 表示返回P12文件的解析后的证书、私钥及其他证书合集。 |
| [Pkcs12ParsingConfig](arkts-devicecertificate-pkcs12parsingconfig-i.md) | 表示解析P12文件的配置。 |
...
| [X509CRL](arkts-devicecertificate-x509crl-i.md) | 被吊销证书列表对象。 |
| [X509CRLEntry](arkts-devicecertificate-x509crlentry-i.md) | 被吊销证书对象。 |
...
| [X509Crl](arkts-devicecertificate-x509crl-i.md) | X509证书吊销列表对象。 @link cert.X509CRL}替代。 |
| [X509CrlEntry](arkts-devicecertificate-x509crlentry-i.md) | 被吊销证书对象。 @link cert.X509CRLEntry}替代。 |
...
| [CmsFormat](arkts-devicecertificate-cmsformat-e.md) | 表示Cms签名格式的枚举。 |
...
| [CmsRecipientEncryptionAlgorithm](arkts-devicecertificate-cmsrecipientencryptionalgorithm-e.md) | CMS接收者对称算法的枚举。 |
| [CmsRsaSignaturePadding](arkts-devicecertificate-cmsrsasignaturepadding-e.md) | 表示RSA类型CMS签名填充方式的枚举。 |
| [EncodingBaseFormat](arkts-devicecertificate-encodingbaseformat-e.md) | 表示生成CSR的编码格式的枚举。 |
...
| [GeneralNameType](arkts-devicecertificate-generalnametype-e.md) | 表示证书主体用途的枚举。 |
...
| [Pkcs12MacDigestAlgorithm](arkts-devicecertificate-pkcs12macdigestalgorithm-e.md) | 表示PKCS12 MAC摘要算法枚举。 |
