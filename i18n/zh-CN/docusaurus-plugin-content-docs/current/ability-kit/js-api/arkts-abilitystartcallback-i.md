...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | AbilityResult | 是 | 当调用  [terminateSelfWithResult]./UIExtensionContext:UIExtensionContext.terminateSelfWithResult(parameter: AbilityResult, callback: AsyncCallback)  方法终止UIExtensionAbility时返回的结果。 |
