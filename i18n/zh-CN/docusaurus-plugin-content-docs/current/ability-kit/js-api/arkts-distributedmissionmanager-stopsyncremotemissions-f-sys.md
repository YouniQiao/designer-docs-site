...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | MissionDeviceInfo | 是 | Parameters required for synchronization. |
| callback | AsyncCallback&lt;void> | 是 | Callback used to return the result. If the synchronization is stopped, err  is undefined; otherwise, err is an error object. |
