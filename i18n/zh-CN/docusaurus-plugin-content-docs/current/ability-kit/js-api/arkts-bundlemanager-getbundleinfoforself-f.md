...
| --- | --- | --- | --- |
| bundleFlags | int | 是 | 指定返回的BundleInfo所包含的信息。 |
| callback | AsyncCallback&lt;BundleInfo> | 是 | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-asynccallback-i.md#AsyncCallback)，当获取成功时，err为  undefined，data为获取到的当前应用的BundleInfo；否则为错误对象。 |
