...
| [24010005](../errorcode-abilityToolAccessCtrl-sys.md#24010005-授权失败) | Grant permission failed. The application specified by the tokenID is notallowed to be granted with the specified permission, the specified permission cannot be granted by user, etc. |
