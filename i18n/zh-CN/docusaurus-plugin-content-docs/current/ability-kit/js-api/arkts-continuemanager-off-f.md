...
| callback | AsyncCallback&lt;ContinueResultInfo> | 否 | Callback used to return the result. If the callback is  unregistered, err is undefined, and ContinueResultInfo is the callback unregistration result. Otherwise,  err is an error object. |
