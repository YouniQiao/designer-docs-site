...
| callback | AsyncCallback&lt;Array&lt;LauncherAbilityInfo>> | 是 | [回调函数](../../apis-basic-service-kit/arkts-apis/arkts-asynccallback-i.md#AsyncCallback)。当函数调用成功，err为  undefined，data为指定用户下所有应用的[LauncherAbilityInfo]./bundleManager/LauncherAbilityInfo:LauncherAbilityInfo信息  。否则为错误对象。 |
