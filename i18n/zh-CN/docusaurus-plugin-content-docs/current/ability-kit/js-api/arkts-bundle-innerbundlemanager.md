...
| 名称 | 说明 |
| --- | --- |
| [innerBundleManager](arkts-ability-innerbundlemanager-sta-n.md) | 本模块提供launcher应用使用的接口。 @link @ohos.bundle.launcherBundleManager:launcherBundleManager} &gt; 及[bundleMonitor](arkts-bundle-bundlemonitor.md#bundlemonitor)替代。 &gt; &gt; 本模块为系统接口。 |
