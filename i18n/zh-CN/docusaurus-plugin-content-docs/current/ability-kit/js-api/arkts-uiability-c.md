...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| wantParam | Record&lt;string, Object> | 是 | 开发者通过该参数保存待迁移的数据。 [since 11] |
...
| wantParam | Record&lt;string, Object> | 是 | 用户自定义的应用状态数据，应用再启动时被保存在[onCreate](arkts-uiability-c.md#onCreate)的  Want.parameters中。 [since 11] |
...
| wantParam | Record&lt;string, Object> | 是 | 用户自定义的应用状态数据，应用再启动时被保存在[onCreate](arkts-uiability-c.md#onCreate)的  Want.parameters中。 |
...
| --- | --- | --- | --- |
| stateType | AbilityConstant.StateType | 是 | 触发应用保存状态的原因，当前仅支持`APP_RECOVERY`（即应用故障恢复场景）。 |
| wantParam | Record&lt;string, RecordData> | 是 | 用户自定义的应用状态数据，应用再启动时被保存在[onCreate](arkts-uiability-c.md#onCreate)的  Want.parameters中。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| wantParam | Record&lt;string, Object> | 是 | 待分享的数据。 [since 11] |
