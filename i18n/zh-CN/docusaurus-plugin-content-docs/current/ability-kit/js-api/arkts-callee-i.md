...
| callback | CalleeCallback | 是 | 一个[rpc.MessageSequence]./@ohos.rpc:rpc.MessageSequence类型入参的js通知同步回调函数, 回  调函数至少要返回一个空的[rpc.Parcelable]./@ohos.rpc:rpc.Parcelable数据对象, 其他视为函数执行错误。 |
