...
**继承实现关系：** UIServiceExtensionAbility继承自：ExtensionAbility。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | Want | 是 | 当前  [UIServiceExtensionAbility](arkts-uiserviceextensionability-c-sys.md#UIServiceExtensionAbility)相关的  [Want](arkts-want-c.md#Want)类型信息，包括Ability名称、Bundle名称等。 |
| proxy | UIServiceHostProxy | 是 | 一个[UIServiceHostProxy]./application/UIServiceHostProxy:UIServiceHostProxy  对象，用于客户端和服务端进行通信。 |
