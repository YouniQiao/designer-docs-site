...
| requestCode | number | 是 | 指示要传递给[PermissionRequestResult](arkts-permissionrequestresult-i.md#PermissionRequestResult)的请求代码。 |
...
**替代接口：** @ohos.window:window.WindowStage.setShowOnLockScreen
