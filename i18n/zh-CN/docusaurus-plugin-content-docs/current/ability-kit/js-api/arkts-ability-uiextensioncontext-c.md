...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;UIServiceProxy&gt; | Promise对象，连接UIServiceExtensionAbility成功时，返回[UIServiceProxy](./application/UIServiceProxy:UIServiceProxy)对象，借助该对象可以往UIServiceExtensionAbility发送数据。 |
