...
表示处理Want的方式。值为枚举类型[Flags](arkts-ability-flags-e.md#flags)，默认传数字。 例如取值为0x00000001（即wantConstant.Flags.FLAG_AUTH_READ_URI_PERMISSION）表示临时授予接收方读取该URI指向的数据的权限。
