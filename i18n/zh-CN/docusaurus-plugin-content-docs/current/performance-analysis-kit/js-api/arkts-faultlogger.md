...
推荐使用[@ohos.hiviewdfx.hiAppEvent](@ohos.hiviewdfx.hiAppEvent:hiAppEvent)订阅APP_CRASH及APP_FREEZE等故障事件。

> **说明：**
>
> 本模块接口从API version 18开始废弃使用, 该接口不再维护。后续版本推荐使用
> [@ohos.hiviewdfx.hiAppEvent](@ohos.hiviewdfx.hiAppEvent:hiAppEvent)订阅APP_CRASH，APP_FREEZE事件。
>
