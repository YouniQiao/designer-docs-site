...
**替代接口：** sensor.getRotationMatrix(rotationVector:
...
| callback | AsyncCallback&lt;Array&lt;number>> | 是 | Callback used to return the rotation matrix. |
...
**替代接口：** sensor.getRotationMatrix(gravity:
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gravity | Array&lt;number> | 是 | Gravity vector. |
| geomagnetic | Array&lt;number> | 是 | Geomagnetic vector. |
| callback | AsyncCallback&lt;RotationMatrixResponse> | 是 | Callback used to return the rotation matrix. |
