...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotationMatrix | Array&lt;double> | 是 | Rotation matrix. |
| callback | AsyncCallback&lt;Array&lt;double>> | 是 | Callback used to return the rotation angle around the z, x, and  y axes, in degrees. |
