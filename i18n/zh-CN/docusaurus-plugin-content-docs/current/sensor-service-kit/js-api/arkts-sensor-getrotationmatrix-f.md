...
| callback | AsyncCallback&lt;Array&lt;double>> | 是 | Callback used to return the rotation matrix. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gravity | Array&lt;double> | 是 | Gravity vector. |
| geomagnetic | Array&lt;double> | 是 | Geomagnetic vector. |
