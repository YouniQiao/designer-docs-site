...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| obj | RecordData | 是 | 用于与此list比较的对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | ListForEachCb&lt;T> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fromIndex | int | 是 | 起始位置的下标。 |
| toIndex | int | 是 | 结束位置的下标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | ListReplaceCb&lt;T> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| comparator | ListComparatorFn&lt;T> | 是 | 回调函数。 从API version 23起有兼容性变更。在API version 22及之前版本，类型为 `(firstValue: T, secondValue: T) => number`。 [since 23] |
