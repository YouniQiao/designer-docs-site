...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| target | Buffer \| Uint8Array | 是 | 用于与此Buffer进行比较的Buffer对象。 |
| targetStart | int | 否 |  |
| targetEnd | int | 否 |  |
| sourceStart | int | 否 |  |
| sourceEnd | int | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string \| Buffer \| Uint8Array \| int \| double \| long | 是 | 用于填充的值。[since 11] |
| offset | int | 否 |  |
| end | int | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string \| int \| double \| long \| Buffer \| Uint8Array | 是 | 要搜索的内容。[since 11] |
| byteOffset | int | 否 |  |
| encoding | BufferEncoding | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string \| int \| double \| long \| Buffer \| Uint8Array | 是 | 要查找的内容。[since 11] |
| byteOffset | int | 否 |  |
| encoding | BufferEncoding | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offset | int | 是 | 偏移量。默认值：0。取值范围：0 = [left range] and &lt;=  [right range]. Received value is: [param] |
| byteLength | int | 是 |  |
