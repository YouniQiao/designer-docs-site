...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | int | 是 | 添加成员数据的键名。需要小于等于int32_max即2147483647。 |
| value | T | 是 | 添加成员数据的值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | PlainArrayForEachCb&lt;T> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| index | int | 是 | 删除元素的起始下标。需要小于等于int32_max即2147483647。 |
| size | int | 是 | 期望删除元素个数。需要小于等于int32_max即2147483647。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| index | int | 是 | 指定替换数据下标。需要小于等于int32_max即2147483647。 |
| value | T | 是 | 替换键值对中的值。 |
