...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offset | number | 是 | 偏移量。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| byteLength | number | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | bigint | 是 | 写入Buffer的数据。取值范围：-INT64_MAX = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | bigint | 是 | 写入Buffer的数据。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 写入Buffer的数据。取值范围：-DOUBLE_MAX = 0 and &lt;= buf.length - 8. Received value is: [offset] |
| offset | number | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 写入Buffer的数据。取值范围：-FLOAT_MAX = 0 and &lt;= buf.length - 4. Received value is: [offset] |
| offset | number | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 写入Buffer的数据。取值范围：-INT16_MAX = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 写入Buffer的数据。取值范围：-INT32_MAX = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 写入Buffer的数据。取值范围：-INT8_MAX = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | 否 |  |
...
| offset | number | 是 | 偏移量。默认值：0。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| byteLength | number | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 写入Buffer的数据。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 写入FastBuffer对象的数据。取值范围：0 = [left range] and &lt;= [right range]. Received value is: [param] |
| offset | number | 否 |  |
