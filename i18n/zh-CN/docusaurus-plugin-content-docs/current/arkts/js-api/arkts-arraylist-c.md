...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | ArrayListForEachCb&lt;T> | 是 | 对每个元素执行的回调函数。 |
...
| --- | --- | --- | --- |
| element | T | 是 | 被插入的元素。 |
| index | int | 是 | 被插入的位置索引。需要小于等于int32_max即2147483647。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| index | int | 是 | 指定元素的下标值。需要小于等于int32_max即2147483647。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | ArrayListReplaceCb&lt;T> | 是 | 用于替换的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| comparator | ArrayListComparatorFn&lt;T> | 否 |  |
