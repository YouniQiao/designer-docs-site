...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | ReadableOptions | 是 | Readable构造函数中的选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | int | 是 | 待读取的字节数。取值范围：0 &lt;= size &lt;= Number.MAX_VALUE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| chunk | Uint8Array \| string \| undefined \| null | 是 | 待读取的数据。 从API version 22起有兼容性变更。在API version 21及之前版本，类型为 `Uint8Array \| string \| null`。 [since 23] |
| encoding | string | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | number | 否 | 待读取的字节数。默认值为undefined。 |
