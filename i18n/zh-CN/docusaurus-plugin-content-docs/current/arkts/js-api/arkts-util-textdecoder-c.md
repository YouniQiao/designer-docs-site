...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| encoding | string | 否 | 编码格式。默认格式为 'utf-8'。[since 9 - 10] |
| options | TextDecoderOptions | 否 | 解码相关的选项，包含 fatal 和 ignoreBOM。[since 9 - 10] |
...
**替代接口：** util.TextDecoder.decodeToString
...
| --- | --- | --- | --- |
| input | Uint8Array | 是 | 要解码的 Uint8Array 对象。 |
| options | DecodeToStringOptions | 否 |  |
...
| --- | --- | --- | --- |
| input | Uint8Array | 是 | 要解码的 Uint8Array 对象。 |
| options | DecodeWithStreamOptions | 否 | 解码相关的选项。[since 9 - 10] |
