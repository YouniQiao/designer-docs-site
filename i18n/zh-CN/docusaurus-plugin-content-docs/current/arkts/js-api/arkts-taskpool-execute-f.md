...
| args | A | 是 | 任务执行传入函数的入参，支持的参数类型请参考  [序列化支持类型](docroot://reference/apis-arkts/js-apis-taskpool.md#序列化支持类型)。默认值为undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| task | GenericsTask&lt;A, R> | 是 | 需要在任务池中执行的泛型任务。 |
| priority | Priority | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| group | TaskGroup | 是 | 需要在任务池中执行的任务组。 |
| priority | Priority | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| task | GenericsTask&lt;A, R> | 是 | 需要执行的泛型任务。 |
| configs | Configs | 是 | 任务的配置项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| group | TaskGroup | 是 | 需要执行的任务组。 |
| configs | Configs | 是 | 任务组中各任务的配置项。 |
