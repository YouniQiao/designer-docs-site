...
**替代接口：** util.LRUCache.afterRemoval
...
**替代接口：** util.LRUCache.createDefault
...
**替代接口：** util.LRUCache.getCapacity
...
**替代接口：** util.LRUCache.getCreateCount
...
**替代接口：** util.LRUCache.getMatchCount
...
**替代接口：** util.LRUCache.getMissCount
...
**替代接口：** util.LRUCache.getPutCount
...
**替代接口：** util.LRUCache.getRemovalCount
...
**替代接口：** util.LRUCache.updateCapacity
