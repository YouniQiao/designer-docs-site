...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | int | 是 | 需要被压制子进程的进程号，  [OH_Ability_StartNativeChildProcess](docroot://reference/apis-ability-kit/capi-native-child-process-h.md#oh_ability_startnativechildprocess)  接口创建子进程后的pid参数，即为子进程进程号。 |
