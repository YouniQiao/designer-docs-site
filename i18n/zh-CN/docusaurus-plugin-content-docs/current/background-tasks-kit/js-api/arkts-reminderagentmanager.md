...
| [ReminderRequestAlarm](arkts-backgroundtasks-reminderrequestalarm-i.md) | ReminderRequestAlarm extends ReminderRequest 闹钟实例对象，用于设置提醒的时间。 |
| [ReminderRequestCalendar](arkts-backgroundtasks-reminderrequestcalendar-i.md) | ReminderRequestCalendar extends ReminderRequest 日历实例对象，用于设置提醒的时间。 |
| [ReminderRequestTimer](arkts-backgroundtasks-reminderrequesttimer-i.md) | ReminderRequestTimer extends ReminderRequest 倒计时实例对象，用于设置提醒的时间。 |
...
| [ReminderRequestCalendar](arkts-backgroundtasks-reminderrequestcalendar-i-sys.md) | ReminderRequestCalendar extends ReminderRequest 日历实例对象，用于设置提醒的时间。 |
<!--DelEnd-->
