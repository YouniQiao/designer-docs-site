...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| toMerge | BundleStateInfo | 是 | Indicates the {@link BundleActiveInfo} object to merge.  If the bundle names of the two {@link BundleActiveInfo} objects are different. |
