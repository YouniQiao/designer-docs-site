...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| byInterval | IntervalType | 是 | Indicates the interval at which the usage statistics are queried.  The value can be {@link #BY_OPTIMIZED}, {@link #BY_DAILY},  {@link #BY_WEEKLY}, {@link #BY_MONTHLY}, or {@link #BY_ANNUALLY}. |
| begin | number | 是 | Indicates the start time of the query period, in milliseconds.  Unit:ms |
| end | number | 是 | Indicates the end time of the query period, in milliseconds.  Unit:ms |
