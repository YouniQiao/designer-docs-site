...
取消键鼠穿越准备，使用Callback异步回调。 > **说明：** > > 从API version 10开始不再维护。建议使用 > [cooperate.unprepareCooperate](arkts-distributedservice-unpreparecooperate-f-sys.md#unpreparecooperate-1)替代
...
取消键鼠穿越准备，使用Promise异步回调。 > **说明：** > > 从API version 10开始不再维护。建议使用[cooperate.unprepareCooperate](arkts-distributedservice-unpreparecooperate-f-sys.md#unpreparecooperate-2)替代
