...
| cooperateOptions | CooperateOptions | 否 | 穿越可选控制参数，用于控制穿出点具体位置等。不设置此参数时，本接口能力  与[cooperate.activateCooperate]cooperate.activateCooperate(targetNetworkId: string, inputDeviceId: int)  相同。 |
