...
启动键鼠穿越，使用Callback异步回调。 > **说明：** > > 从API version 10开始不再维护。建议使用 > [cooperate.activateCooperate](arkts-distributedservice-activatecooperate-f-sys.md#activatecooperate-1) > 替代
...
启动键鼠穿越，使用Promise异步回调。 > **说明：** > > 从API version 10开始不再维护。建议使用 > [cooperate.activateCooperate](arkts-distributedservice-activatecooperate-f-sys.md#activatecooperate-2)替代
