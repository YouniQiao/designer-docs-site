...
准备键鼠穿越，使用Promise异步方式返回结果。 > **说明：** > > 从API version 10开始不再维护。建议使用[cooperate.prepareCooperate](arkts-distributedservice-preparecooperate-f-sys.md#preparecooperate-2)替代
