...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager.bindTarget(deviceId:
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager.getDeviceName
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager.getLocalDeviceNetworkId
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager.getAvailableDeviceList(callback:
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager.getAvailableDeviceList()
...
| callback | Callback&lt;{ action: DeviceStateChangeAction, device: DeviceInfo }> | 否 | 指示要取消注册的设备状态回调，返回设备状态和设备信  息。 |
...
| callback | Callback&lt;{ subscribeId: number, device: DeviceInfo }> | 否 | 指示要取消注册的设备发现回调，返回设备状态和设备信息。 |
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.releaseDeviceManager
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager.replyUiAction
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager.stopDiscovering
...
**替代接口：** @ohos.distributedDeviceManager:distributedDeviceManager.DeviceManager.unbindTarget
