...
获取目标设备键鼠穿越开关的状态，使用Callback异步回调。 > **说明：** > > 从API version 10开始不再维护。建议使用 > [cooperate.getCooperateSwitchState](arkts-distributedservice-getcooperateswitchstate-f-sys.md#getcooperateswitchstate-1) > 替代
...
获取目标设备键鼠穿越开关的状态，使用Promise异步方式返回结果。 > **说明：** > > 从API version 10开始不再维护。建议使用 > [cooperate.getCooperateSwitchState](arkts-distributedservice-getcooperateswitchstate-f-sys.md#getcooperateswitchstate-2)替代
