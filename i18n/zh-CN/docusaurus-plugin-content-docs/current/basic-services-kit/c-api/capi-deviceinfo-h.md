...
| 类型 | 说明 |
| -- | -- |
| const char * | "phone"(或"default")<br>    <br>"wearable",<br>    <br>"liteWearable",<br>    <br>"tablet",<br>    <br>"tv",<br>    <br>"car",<br>    <br>"smartVision"。 |
...
| 类型 | 说明 |
| -- | -- |
| const char * | 操作系统发布类别包括"Release"、"Beta"和"Canary"。<br>     <br>具体的发布类型可能是"Release"，"Beta1"，或其他类似的。 |
