...
| [Print_PageSize](capi-print-print-pagesize.md) *supportedPageSizes | 支持的纸张尺寸数组。 |
| uint32_t supportedPageSizesCount | 支持的纸张尺寸数量。 |
...
| [Print_Resolution](capi-print-print-resolution.md) *supportedResolutions | 支持的打印机分辨率数组。 |
