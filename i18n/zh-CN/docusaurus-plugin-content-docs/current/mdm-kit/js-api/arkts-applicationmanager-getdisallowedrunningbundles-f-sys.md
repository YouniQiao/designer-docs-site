...
**替代接口：** applicationManager.getDisallowedRunningBundlesSync
...
| callback | AsyncCallback&lt;Array&lt;string>> | 是 | 回调函数，当获取应用运行禁止名单成功时，err为null，否则为错误对象。 说明： API version 20  及之前版本，返回值为应用[appId](docroot://quick-start/common-problem-of-application.md#什么是appid)列表。从API version 21版本开始，返回值为  应用[appId](docroot://quick-start/common-problem-of-application.md#什么是appid)或  [appIdentifier](docroot://quick-start/common-problem-of-application.md#什么是appidentifier)列表。 |
