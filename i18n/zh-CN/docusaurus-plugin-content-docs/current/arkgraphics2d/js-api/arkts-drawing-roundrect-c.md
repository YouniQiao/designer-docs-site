...
| xRadii | double | 是 | X轴上的圆角半径，该参数为浮点数，小于等于0时无效。 |
| yRadii | double | 是 | Y轴上的圆角半径，该参数为浮点数，小于等于0时无效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pos | CornerPos | 是 | Position of the rounded corner. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dx | double | 是 | 表示x轴方向上的偏移量。正数表示向x轴正方向平移，负数表示向x轴负方向平移，该参数为浮点数。 |
| dy | double | 是 | 表示y轴方向上的偏移量。正数表示向y轴正方向平移，负数表示向y轴负方向平移，该参数为浮点数。 |
...
| --- | --- | --- | --- |
| pos | CornerPos | 是 | 圆角位置。 |
| x | double | 是 | x轴方向的圆角半径，该参数为浮点数，小于等于0时无效。 |
| y | double | 是 | y轴方向的圆角半径，该参数为浮点数，小于等于0时无效。 |
