...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | common2D.Color \| int | 是 | 颜色，可以用16进制ARGB格式的无符号整数表示。 |
...
| sweepAngle | double | 是 | 弧的扫描角度，单位为度，该参数为浮点数。为正数时顺时针扫描，为负数时逆时针扫描。扫描角度可以超过360度，将绘制一个完整的椭圆。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | double | 是 | 圆心的x坐标，该参数为浮点数。 |
| y | double | 是 | 圆心的y坐标，该参数为浮点数。 |
| radius | double | 是 | 圆的半径，大于0的浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| alpha | int | 是 | ARGB格式颜色的透明度通道值，该参数是0到255之间的整数，传入范围内的浮点数会向下取整。 |
| red | int | 是 | ARGB格式颜色的红色通道值，该参数是0到255之间的整数，传入范围内的浮点数会向下取整。 |
| green | int | 是 | ARGB格式颜色的绿色通道值，该参数是0到255之间的整数，传入范围内的浮点数会向下取整。 |
| blue | int | 是 | ARGB格式颜色的蓝色通道值，该参数是0到255之间的整数，传入范围内的浮点数会向下取整。 |
| blendMode | BlendMode | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| glyphIds | Array&lt;int> | 是 | 指示字形ID的数组。 |
| glyphIdOffset | int | 是 | 指示在绘制字形Ids数组之前要跳过的元素的数量。  取值限定为整数。 |
| positions | Array&lt;common2D.Point> | 是 | 表示位置数组。 |
| positionOffset | int | 是 | 指示在绘制位置数组之前要跳过的元素的数量。  取值限定为整数。 |
| glyphCount | int | 是 | 指示要绘制的字形的数目。  取值限定为整数。 |
...
| left | double | 是 | 图片位置的左上角x轴坐标，该参数为浮点数。 |
| top | double | 是 | 图片位置的左上角y轴坐标，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x0 | double | 是 | 线段起点的X坐标，该参数为浮点数。 |
| y0 | double | 是 | 线段起点的Y坐标，该参数为浮点数。 |
| x1 | double | 是 | 线段终点的X坐标，该参数为浮点数。 |
| y1 | double | 是 | 线段终点的Y坐标，该参数为浮点数。 |
...
| vertices | Array&lt;double> | 是 | 顶点数组，指定网格的绘制位置，浮点数组，大小必须为((meshWidth+1)  (meshHeight+1) + vertOffset)  2。 |
| vertOffset | int | 是 | 绘图前要跳过的vert元素数，大于等于0的整数。 |
| colors | Array&lt;int> \| null | 是 | 颜色数组，在每个顶点指定一种颜色，整数数组，可为null，大小必须为(meshWidth+1)  (meshHeight+1) +  colorOffset。 [since 20] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | double | 是 | 点的x轴坐标，该参数为浮点数。 |
| y | double | 是 | 点的y轴坐标，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| left | double | 是 | 矩形的左上角x轴坐标，该参数为浮点数。 |
| top | double | 是 | 矩形的左上角y轴坐标，该参数为浮点数。 |
| right | double | 是 | 矩形的右下角x轴坐标，该参数为浮点数。 |
| bottom | double | 是 | 矩形的右下角y轴坐标，该参数为浮点数。 |
...
| lightRadius | double | 是 | 圆形灯半径，该参数为浮点数。 |
...
| font | Font | 是 | 字型对象。 |
| x | double | 是 | 所绘制出的字符基线（下图蓝线）的左端点（下图红点）的横坐标，该参数为浮点数。 |
| y | double | 是 | 所绘制出的字符基线（下图蓝线）的左端点（下图红点）的纵坐标，该参数为浮点数。 |
...
| font | Font | 是 | 字型对象。 |
| x | double | 是 | 所绘制字符基线左端点的横坐标，该参数为浮点数。 |
| y | double | 是 | 所绘制字符基线左端点的纵坐标，该参数为浮点数。 |
...
| x | double | 是 | 所绘制出的文字基线（下图蓝线）的左端点（下图红点）的横坐标，该参数为浮点数。 |
| y | double | 是 | 所绘制出的文字基线（下图蓝线）的左端点（下图红点）的纵坐标，该参数为浮点数。 |
...
| vertexCount | int | 是 | 顶点数组元素的数量，值为大于等于3的整数。 |
...
| colors | Array&lt;int> \| null | 是 | 描述顶点对应颜色的数组，用于在三角形中进行插值。其可以为空，表明颜色效果为用户所设置的默认色；若不为空其长度必须等于vertexCount。 |
| indexCount | int | 是 | 索引的数量。其值可以为0，且indices数组长度为0时可以画图；若不为0，则值必须为大于等于3的整数。 |
| indices | Array&lt;int> \| null | 是 | 描述顶点对应索引的数组。其可以为空，此时将忽略indexCount的合理传值（大于等于3的整数或等于0）；若不为空其长度必须等于indexCount  。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| count | int | 是 | 要恢复的画布状态深度，该参数为整数。小于等于1时，恢复为初始状态；大于已保存的画布状态数量时，不执行任何操作。 |
...
| sx | double | 是 | 旋转中心的横坐标，该参数为浮点数。 |
| sy | double | 是 | 旋转中心的纵坐标，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sx | double | 是 | x轴方向的缩放比例，该参数为浮点数。 |
| sy | double | 是 | y轴方向的缩放比例，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dx | double | 是 | x轴方向的移动距离，该参数为浮点数。 |
| dy | double | 是 | y轴方向的移动距离，该参数为浮点数。 |
