...
| 名称 | 说明 |
| --- | --- |
| [ColorSpaceManager](arkts-arkgraphics2d-colorspacemanager-i.md) | 当前色域对象实例。 下列API示例中都需先使用[create()](arkts-arkgraphics2d-create-f.md#create-1)获取到ColorSpaceManager实例，再通过此实例调用对 应方法。 |
