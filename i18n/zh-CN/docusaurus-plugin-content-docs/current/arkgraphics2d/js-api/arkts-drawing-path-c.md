...
| startAngle | double | 是 | 弧的起始角度，单位为度，0度为x轴正方向，该参数为浮点数。 |
| sweepAngle | double | 是 | 扫描角度，单位为度。正数表示顺时针方向，负数表示逆时针方向，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | double | 是 | 表示圆心的x轴坐标，该参数为浮点数。 |
| y | double | 是 | 表示圆心的y轴坐标，该参数为浮点数。 |
| radius | double | 是 | 表示圆形的半径，该参数为浮点数，小于等于0时不会有任何效果。 |
...
| start | int | 是 | 表示椭圆初始点的索引，0，1，2，3分别对应椭圆的上端点，右端点，下端点，左端点，该参数为不小于0的整数，大于等于4时会对4取余。 |
| pathDirection | PathDirection | 否 | 表示路径方向，默认为顺时针方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x1 | double | 是 | 矩形左上角的x坐标，该参数为浮点数。 |
| y1 | double | 是 | 矩形左上角的y坐标，该参数为浮点数。 |
| x2 | double | 是 | 矩形右下角的x坐标，该参数为浮点数。 |
| y2 | double | 是 | 矩形右下角的y坐标，该参数为浮点数。 |
| startDeg | double | 是 | 起始的角度。角度的起始方向（0°）为x轴正方向。 |
| sweepDeg | double | 是 | 扫描的度数，为正数时顺时针扫描，为负数时逆时针扫描。实际扫描的度数为该入参对360取模的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ctrlX | double | 是 | 控制点的x坐标，该参数为浮点数。 |
| ctrlY | double | 是 | 控制点的y坐标，该参数为浮点数。 |
| endX | double | 是 | 目标点的x坐标，该参数为浮点数。 |
| endY | double | 是 | 目标点的y坐标，该参数为浮点数。 |
| weight | double | 是 | 表示曲线权重，决定了曲线的形状。值越大，曲线越接近控制点。小于等于0时，效果与[lineTo]drawing.Path.lineTo相同；值为1时，效果与  [quadTo]drawing.Path.quadTo相同。该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | double | 是 | x轴上坐标点，该参数必须为浮点数。 |
| y | double | 是 | y轴上坐标点，该参数必须为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ctrlX1 | double | 是 | 第一个控制点的x坐标，该参数为浮点数。 |
| ctrlY1 | double | 是 | 第一个控制点的y坐标，该参数为浮点数。 |
| ctrlX2 | double | 是 | 第二个控制点的x坐标，该参数为浮点数。 |
| ctrlY2 | double | 是 | 第二个控制点的y坐标，该参数为浮点数。 |
| endX | double | 是 | 目标点的x坐标，该参数为浮点数。 |
| endY | double | 是 | 目标点的y坐标，该参数为浮点数。 |
...
| --- | --- | --- | --- |
| forceClosed | boolean | 是 | 表示是否按照闭合路径测量，true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。 |
| distance | double | 是 | 表示与路径起始点的距离，小于0时会被视作0，大于路径长度时会被视作路径长度。该参数为浮点数。 |
...
| --- | --- | --- | --- |
| forceClosed | boolean | 是 | 表示是否按照闭合路径测量，true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。 |
| start | double | 是 | 表示与路径起始点的距离，距离路径起始点start距离的位置即为截取路径片段的起始点，小于0时会被视作0，大于等于stop时会截取失败。该参数为浮点数。 |
| stop | double | 是 | 表示与路径起始点的距离，距离路径起始点stop距离的位置即为截取路径片段的终点，小于等于start时会截取失败，大于路径长度时会被视作路径长度。该参数为浮点数。 |
| startWithMoveTo | boolean | 是 | 表示是否在目标路径执行[moveTo]drawing.Path.moveTo移动到截取路径片段的起始点位置。true表示执行，false  表示不执行。 |
...
| weight | double | 是 | 表示插值权重，必须在[0.0, 1.0]范围内。该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | double | 是 | 目标点的x轴坐标，该参数为浮点数。 |
| y | double | 是 | 目标点的y轴坐标，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | double | 是 | 起始点的x轴坐标，该参数为浮点数。 |
| y | double | 是 | 起始点的y轴坐标，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ctrlX | double | 是 | 控制点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| ctrlY | double | 是 | 控制点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| endX | double | 是 | 目标点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| endY | double | 是 | 目标点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| weight | double | 是 | 表示曲线的权重，决定了曲线的形状，越大越接近控制点。若小于等于0则等同于使用[rLineTo]drawing.Path.rLineTo添加一条到结束点的线段  ，若为1则等同于[rQuadTo]drawing.Path.rQuadTo，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ctrlX1 | double | 是 | 第一个控制点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| ctrlY1 | double | 是 | 第一个控制点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| ctrlX2 | double | 是 | 第二个控制点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| ctrlY2 | double | 是 | 第二个控制点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| endX | double | 是 | 目标点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| endY | double | 是 | 目标点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dx | double | 是 | 目标点相对于当前路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy | double | 是 | 目标点相对于当前路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dx | double | 是 | 路径新起始点相对于当前路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy | double | 是 | 路径新起始点相对于当前路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dx1 | double | 是 | 控制点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy1 | double | 是 | 控制点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
| dx2 | double | 是 | 目标点相对于路径终点的x轴偏移量，正数往x轴正方向偏移，负数往x轴负方向偏移，该参数为浮点数。 |
| dy2 | double | 是 | 目标点相对于路径终点的y轴偏移量，正数往y轴正方向偏移，负数往y轴负方向偏移，该参数为浮点数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | double | 是 | 指定点的x轴坐标，该参数为浮点数。0表示坐标原点，负数表示位于坐标原点左侧，正数表示位于坐标原点右侧。 |
| y | double | 是 | 指定点的y轴坐标，该参数为浮点数。0表示坐标原点，负数表示位于坐标原点上侧，正数表示位于坐标原点下侧。 |
