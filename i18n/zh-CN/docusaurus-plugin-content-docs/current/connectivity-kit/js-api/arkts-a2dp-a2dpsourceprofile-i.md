...
| --- | --- | --- | --- |
| deviceId | string | 是 | Indicates device ID. For example, "11:22:33:AA:BB:FF". |
| duration | int | 是 | Restricted duration . Valid range is from 3000ms to 20000ms. |
...
| --- | --- | --- | --- |
| deviceId | string | 是 | Indicates device ID. For example, "11:22:33:AA:BB:FF". |
| callback | AsyncCallback&lt;boolean> | 是 | Callback used to listen for the pairing request event. |
...
| --- | --- | --- | --- |
| deviceId | string | 是 | Indicates device ID. For example, "11:22:33:AA:BB:FF". |
| codecInfo | CodecInfo | 是 | Indicates the CodecInfo. |
