...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| surfaceId | string | 是 | [XComponent]XComponentController#getXComponentSurfaceId 持有 Surface 的 ID。用于在  人脸录入过程中显示人脸预览画面，该ID需通过XComponentController的getXComponentSurfaceId方法获取。 |
