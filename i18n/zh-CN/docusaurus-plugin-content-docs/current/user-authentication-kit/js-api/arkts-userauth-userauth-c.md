...
**替代接口：** userAuth.AuthInstance.start
...
**替代接口：** userAuth.AuthInstance.cancel
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| contextID | Uint8Array | 是 | 上下文的标识，通过[auth]userAuth.UserAuth#auth接口获取。 |
...
**替代接口：** userAuth.getAvailableStatus
