...
胶囊类分段按钮选项。继承自[CapsuleSegmentButtonConstructionOptions](arkts-capsulesegmentbuttonconstructionoptions-i.md#CapsuleSegmentButtonConstructionOptions)。

**继承实现关系：** CapsuleSegmentButtonOptions继承自：CapsuleSegmentButtonConstructionOptions。
