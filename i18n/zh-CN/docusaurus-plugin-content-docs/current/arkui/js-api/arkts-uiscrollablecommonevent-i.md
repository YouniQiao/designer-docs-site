...
**继承实现关系：** UIScrollableCommonEvent继承自：UICommonEvent。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;void> \| undefined | 是 | callback function, triggered when the  scrolling reaches the end position. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;void> \| undefined | 是 | callback function, triggered when the  scrolling reaches the start position. |
