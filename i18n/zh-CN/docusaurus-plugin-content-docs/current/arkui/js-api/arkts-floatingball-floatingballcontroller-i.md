...
| callback | Callback&lt;FloatingBallState> | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;void> | 是 | Used to handle {'click'} command. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;FloatingBallState> | 是 | Used to handle {'stateChange'} command. |
