...
**继承实现关系：** DataPanelAttribute继承自：CommonMethod<DataPanelAttribute>。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | ContentModifier&lt;DataPanelConfiguration> | 是 | 在DataPanel组件上，定制内容区的方法。 modifier：内容修改器，开发者需要自定义  class实现ContentModifier接口。 |
