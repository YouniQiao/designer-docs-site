...
构造三阶贝塞尔曲线对象，曲线的值必须处于0-1之间。 > **说明：** > > 从API version 7开始支持，从API version 9开始废弃。建议使用[Curves.cubicBezierCurve](arkts-arkui-cubicbeziercurve-f.md#cubicbeziercurve-1)替代。
