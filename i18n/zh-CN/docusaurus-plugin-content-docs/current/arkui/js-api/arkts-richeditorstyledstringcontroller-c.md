...
**继承实现关系：** RichEditorStyledStringController继承自：RichEditorBaseController， 实现：StyledStringController。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| styledString | StyledString | 是 | 属性字符串。 说明： StyledString的子类  [MutableStyledString](arkts-mutablestyledstring-c.md#MutableStyledString)也可以作为入参值。 |
