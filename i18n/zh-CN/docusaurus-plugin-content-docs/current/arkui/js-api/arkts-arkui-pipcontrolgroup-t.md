...
画中画控制面板的可选控件组列表，应用可以配置是否显示可选控件。使用时必须和[PiPTemplateType](arkts-arkui-piptemplatetype-e.md#piptemplatetype)对应，否则 [create](arkts-arkui-create-f.md#create-1)接口抛出401错误码。
