...
| name | string | 是 | NavDestination页面名称。 |
| param | Object | 是 | 开发者设置的NavDestination页面详细参数。 |
| onPop | import('../api/@ohos.base').Callback&lt;PopInfo> | 是 | Callback回调，用于页面出栈时处理返回结果。仅  [pop]NavPathStack#pop(result: Object, animated?: boolean)、  [popToName](arkts-navpathstack-c.md#popToName)、  [popToIndex](arkts-navpathstack-c.md#popToIndex)中设置result参数后触发。 |
| animated | boolean | 否 |  |
...
| name | string | 是 | NavDestination页面名称。 |
| param | Object | 是 | 开发者设置的NavDestination页面详细参数。 |
| onPop | import('../api/@ohos.base').Callback&lt;PopInfo> | 是 | Callback回调，用于页面出栈时触发该回调处理返回结果。仅  [pop]NavPathStack#pop(result: Object, animated?: boolean)、  [popToName](arkts-navpathstack-c.md#popToName)、  [popToIndex](arkts-navpathstack-c.md#popToIndex)中设置result参数后触发。 |
| animated | boolean | 否 |  |
