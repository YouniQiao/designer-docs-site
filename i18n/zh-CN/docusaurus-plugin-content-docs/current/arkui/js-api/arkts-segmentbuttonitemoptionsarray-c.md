...
**继承实现关系：** SegmentButtonItemOptionsArray继承自：Array<SegmentButtonItemOptions>。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | SegmentButtonItemArray | 是 | 被添加的按钮信息数组。 默认值：0个被添加的按钮信息数组。 |
...
| items | SegmentButtonItemOptions[] | 是 | 从start开始要加入到数组中的元素。 默认值：不指定任何元素，将从数组中删除元素。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | SegmentButtonItemArray | 是 | 添加的按钮信息数组。 默认值：0个被添加的按钮信息数组。 |
