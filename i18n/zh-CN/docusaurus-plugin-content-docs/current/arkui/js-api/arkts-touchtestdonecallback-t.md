...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | BaseGestureEvent | 是 | [触摸测试](docroot://ui/arkts-interaction-basic-principles.md#触摸测试)结束后的基础手势事件的信息。  说明： 仅包含BaseGestureEvent的信息，不包含其子类拓展信息。 axisHorizontal和axisVertical的值为0。 |
