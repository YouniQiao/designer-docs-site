...
| surfaceRegion | Rect | 否 | 虚拟屏用于显示surface的矩形区域。默认值：虚拟屏幕的完整区域。 |
...
| [801](../../apis-ads-kit/errorcode-ads.md#801-请求广告返回错误码) | Capability not supported.function addVirtualScreenSurfacecan not work correctly due to limited device capabilities. |
