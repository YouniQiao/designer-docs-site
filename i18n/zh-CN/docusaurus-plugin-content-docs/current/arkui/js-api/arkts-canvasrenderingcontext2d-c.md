...
**继承实现关系：** CanvasRenderingContext2D继承自：CanvasRenderer。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| settings | RenderingContextSettings | 否 | 用来配置CanvasRenderingContext2D对象的参数，  见[RenderingContextSettings](#renderingcontextsettings)。  异常值undefined和null按[RenderingContextSettings](#renderingcontextsettings)的默认值处理。 |
...
| options | RenderingContextOptions | 否 |  |
