...
子窗口矩形区域，其中子窗口存在大小限制，具体参考 [resize()](arkts-arkui-window-i.md#resize-2)方法。不设置 且未调用[showWindow()](arkts-arkui-window-i.md#showwindow-1)显示前，则默认为{left: 0, top: 0, width: 0, height: 0}。具体参考[设置应用子窗口](../../../../windowmanager/application-window-stage.md#设置应用子窗口)开发指南。
