...
**继承实现关系：** PageTransitionExitInterface继承自：CommonTransition<PageTransitionExitInterface>。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | PageTransitionCallback | 是 | 出场动画的逐帧回调直到出场动画结束，progress从0变化到1。 [since 18] |
