...
| 名称 | 说明 |
| --- | --- |
| [AnimatedDrawableDescriptor](arkts-arkui-animateddrawabledescriptor-c.md) | 使用[Image](./@internal/component/ets/image)组件播放PixelMap数组或动图资源时传入 AnimatedDrawableDescriptor对象， 该对象继承自[DrawableDescriptor](arkts-arkui-drawabledescriptorloadedresult-i.md)。 |
