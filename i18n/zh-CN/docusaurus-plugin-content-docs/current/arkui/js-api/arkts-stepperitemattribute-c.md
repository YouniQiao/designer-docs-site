...
**继承实现关系：** StepperItemAttribute继承自：CommonMethod<StepperItemAttribute>。

**起始版本：** 8

**废弃版本：** 22

**替代接口：** Swiper#SwiperAttribute
...
**替代接口：** Swiper.SwiperController#showNext
...
**替代接口：** Swiper.SwiperController#showPrevious
