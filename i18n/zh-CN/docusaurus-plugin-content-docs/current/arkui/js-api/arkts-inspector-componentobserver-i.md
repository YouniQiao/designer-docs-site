...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | 'layout' | 是 | type of the listened event. [since 12] |
| callback | () => void | 否 | callback of the listened event. [since 12] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | 'draw' | 是 | type of the listened event. [since 12] |
| callback | () => void | 否 | callback of the listened event. [since 12] |
...
| --- | --- | --- | --- |
| type | 'layout' | 是 | type of the listened event. [since 12] |
| callback | () => void | 是 | callback of the listened event. [since 12] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;int[]> | 是 | 监听事件的回调函数，回调函数的参数为发生绘制送显节点的UniqueId。 |
