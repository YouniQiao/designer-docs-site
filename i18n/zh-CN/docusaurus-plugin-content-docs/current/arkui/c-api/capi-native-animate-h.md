...
| [ArkUI_CurveHandle OH_ArkUI_Curve_CreateSpringCurve(float velocity, float mass, float stiffness, float damping)](#oh_arkui_curve_createspringcurve) | 构造弹簧曲线对象，曲线形状由弹簧参数决定，动画时长受{@link animation}、[animateTo](capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#animateto)中的duration参数控制。 |
...
构造弹簧曲线对象，曲线形状由弹簧参数决定，动画时长受{@link animation}、[animateTo](capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#animateto)中的duration参数控制。
