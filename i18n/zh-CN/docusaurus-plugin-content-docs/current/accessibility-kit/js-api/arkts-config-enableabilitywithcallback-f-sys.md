...
| capability | Array&lt;accessibility.Capability> | 是 | Capabilities of the auxiliary extension ability. |
| connectCallback | ConnectCallback | 是 | Callback to be invoked when the state of an auxiliary extension  ability changes. |
